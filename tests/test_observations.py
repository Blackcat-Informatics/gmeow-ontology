...
slicetest harness. The OWL-RL ENTAILMENT tests were migrated to
``crates/logic/tests/ontology_entailments.rs``. See
...
lowerings and their byte-iso parity oracles.
"""
...
def test_kin_relationship_bridges_fire() -> None:
    ...
    roles. These bridges are asserted in the GENEALOGY module (not
