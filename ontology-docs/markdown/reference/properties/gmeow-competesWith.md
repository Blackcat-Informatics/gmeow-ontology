...
- **CURIE:** [`gmeow:competesWith`](gmeow-competesWith.md)
- **IRI:** <https://blackcatinformatics.ca/gmeow/competesWith>
- **Category:** property
- **Defined by:** [`gmeow:slices/inference`](../../slices/inference.md)
- **Box roles:** [RBox role](../boxes/rbox.md) ([What is this?](../../four-boxes/index.md))

Relates two rival [`gmeow:StandpointClaim`](../classes/gmeow-StandpointClaim.md) hypotheses that cannot both be accepted as the best explanation — the competition abductive (and analogical) selection resolves. Symmetric: competition is mutual. Irreflexivity (a claim never competes with itself) is enforced by SHACL, not OWL, keeping the DL profile clean (the deception discipline — doctrine in SHACL, not axioms).

## Structure

**Property shape:** object property; [`gmeow:StandpointClaim`](../classes/gmeow-StandpointClaim.md) -> [`gmeow:StandpointClaim`](../classes/gmeow-StandpointClaim.md)

## Practical Pattern

Use [`gmeow:competesWith`](gmeow-competesWith.md) from [`gmeow:StandpointClaim`](../classes/gmeow-StandpointClaim.md) to [`gmeow:StandpointClaim`](../classes/gmeow-StandpointClaim.md) when the relationship itself belongs in the native GMEOW graph.
