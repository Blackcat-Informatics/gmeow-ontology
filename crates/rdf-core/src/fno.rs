...
// --------------------------------------------------------------------------- //
// Catalog model (built in Rust by the gmeow-slice FnO emitter)
// --------------------------------------------------------------------------- //
...
pub struct FnoCatalog {
    ...
    /// The document's `rdfs:label` (a `@x-gmeow-english` literal).
    pub doc_label: String,
    /// The document's `rdfs:comment` banner (a `@x-gmeow-english` literal).
    pub banner: String,
...
/// A `@x-gmeow-english` language-tagged literal term.
...
mod tests {
    ...
    fn sample_catalog() -> FnoCatalog {
        FnoCatalog {
            ...
            document_iri: "https://blackcatinformatics.ca/gmeow/projections/functions".to_owned(),
            doc_label: "GMEOW projection functions (FnO)".to_owned(),
            ...
            implementations: vec![FnImpl {
                iri: "https://blackcatinformatics.ca/gmeow/implDemo".to_owned(),
            ...
            mappings: vec![FnMapping {
                ...
                function: "https://blackcatinformatics.ca/gmeow/fnDemo".to_owned(),
                implementation: "https://blackcatinformatics.ca/gmeow/implDemo".to_owned(),
                parameter_mappings: vec![
                    FnParamMapping {
                        bnode_label: "param-fnDemo-demo-paramFoo-foo".to_owned(),
                        label: "paramFoo ↦ ?foo".to_owned(),
                        function_parameter: "https://blackcatinformatics.ca/gmeow/paramFoo"
                            .to_owned(),
                    ...
                    FnParamMapping {
                        ...
                        function_parameter: "https://blackcatinformatics.ca/gmeow/paramBar"
                            .to_owned(),
                ...
                return_mappings: vec![FnReturnMapping {
                    ...
                    function_output: "https://blackcatinformatics.ca/gmeow/outDemo".to_owned(),
    ...
    fn emits_function_typing_and_label_langstring() {
        ...
        let gmeow_pf = RdfTerm::iri(GMEOW_PROJECTION_FUNCTION);
        assert!(has_obj(&quads, RDF_TYPE, &fno_function));
        assert!(has_obj(&quads, RDF_TYPE, &gmeow_pf));
        // The label is a @x-gmeow-english langString (NOT plain, NOT pre-retagged).
    ...
    fn expects_is_an_ordered_rdf_list() {
        ...
        let foo = RdfTerm::iri("https://blackcatinformatics.ca/gmeow/paramFoo");
        let first = quads
            .iter()
        ...
        let bar = RdfTerm::iri("https://blackcatinformatics.ca/gmeow/paramBar");
        assert!(
    ...
    fn returns_is_a_one_element_list() {
        ...
        let out = RdfTerm::iri("https://blackcatinformatics.ca/gmeow/outDemo");
    ...
    fn to_ntriples_emits_the_document_node() {
        ...
        assert!(text.contains(X_GMEOW_ENGLISH));
    }
}
