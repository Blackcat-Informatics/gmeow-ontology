...
/// authored `logic:` and `math:` prefixes. purrdf's builtins (xsd/rdf/rdfs/owl/sh)
/// are always available on top of these, so the profile only carries gmeow's own vocab.
