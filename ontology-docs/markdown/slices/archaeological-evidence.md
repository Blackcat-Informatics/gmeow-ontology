...
- **GMEOW terms:** [`gmeow:InformationObject`](../reference/classes/gmeow-InformationObject.md), [`gmeow:Inscription`](../reference/classes/gmeow-Inscription.md), [`gmeow:InscriptionReading`](../reference/classes/gmeow-InscriptionReading.md), [`gmeow:Language`](../reference/classes/gmeow-Language.md), [`gmeow:Person`](../reference/classes/gmeow-Person.md), [`gmeow:PhysicalObject`](../reference/classes/gmeow-PhysicalObject.md), [`gmeow:ScriptLanguageAttribution`](../reference/classes/gmeow-ScriptLanguageAttribution.md), [`gmeow:WritingSystem`](../reference/classes/gmeow-WritingSystem.md), [`gmeow:attributedLanguage`](../reference/properties/gmeow-attributedLanguage.md), [`gmeow:attributedScript`](../reference/properties/gmeow-attributedScript.md)
...
ex:smith a gmeow:Person ; gmeow:name "Dr. A. Smith"@en .
ex:jones a gmeow:Person ; gmeow:name "Dr. B. Jones"@en .
...
### [`gmeow:Inscription`](../reference/classes/gmeow-Inscription.md) · [`gmeow:inscriptionCarrier`](../reference/properties/gmeow-inscriptionCarrier.md) · [`gmeow:carrierInscription`](../reference/properties/gmeow-carrierInscription.md) · [`gmeow:carrierType`](../reference/properties/gmeow-carrierType.md)

The sign-bearing content or mark on a carrier — an [`InformationObject`](../reference/classes/gmeow-InformationObject.md)
informationally distinct from the [`PhysicalObject`](../reference/classes/gmeow-PhysicalObject.md) that bears it; multiple
inscriptions may coexist on one carrier and competing readings coexist without
privilege (P9). [`inscriptionCarrier`](../reference/properties/gmeow-inscriptionCarrier.md) (functional) names the one bearer; its inverse
[`carrierInscription`](../reference/properties/gmeow-carrierInscription.md) (non-functional) the marks a carrier bears; [`carrierType`](../reference/properties/gmeow-carrierType.md)
classifies the carrier from the [`PhysicalCarrierType`](../reference/classes/gmeow-PhysicalCarrierType.md) vocabulary.

### [`gmeow:InscriptionReading`](../reference/classes/gmeow-InscriptionReading.md) · [`gmeow:readingOf`](../reference/properties/gmeow-readingOf.md) · [`gmeow:readingResult`](../reference/properties/gmeow-readingResult.md)

A scholarly reading of an inscription — the [`Observation`](../reference/classes/gmeow-Observation.md) (and [`gufo:Relator`](../external/terms.md#gufo-relator)) that
produces a lexical form from a sign-bearing feature, a standpoint-scoped claim not
ground truth. [`readingOf`](../reference/properties/gmeow-readingOf.md) (functional, ⊑ [`observedFeature`](../reference/properties/gmeow-observedFeature.md)) names the source
inscription; [`readingResult`](../reference/properties/gmeow-readingResult.md) (non-functional, ⊑ [`observationResult`](../reference/properties/gmeow-observationResult.md)) the form(s)
produced, with competing readings coexisting (P9).

### [`gmeow:InscriptionTransliteration`](../reference/classes/gmeow-InscriptionTransliteration.md) · [`gmeow:transliterationOf`](../reference/properties/gmeow-transliterationOf.md) · [`gmeow:transliterationResult`](../reference/properties/gmeow-transliterationResult.md)

A transliteration of an inscription into another script — an [`Observation`](../reference/classes/gmeow-Observation.md) mapping
sign sequences between writing systems. [`transliterationOf`](../reference/properties/gmeow-transliterationOf.md) (functional) names the
source; [`transliterationResult`](../reference/properties/gmeow-transliterationResult.md) the form(s) produced, with competing schemes (e.g.
Hepburn vs Kunrei-shiki) coexisting without a single winner (P9).

### [`gmeow:InscriptionTranslation`](../reference/classes/gmeow-InscriptionTranslation.md) · [`gmeow:translationOf`](../reference/properties/gmeow-translationOf.md) · [`gmeow:translationResult`](../reference/properties/gmeow-translationResult.md)

A translation of an inscription into another language — an [`Observation`](../reference/classes/gmeow-Observation.md) producing a
form that represents the source's meaning. [`translationOf`](../reference/properties/gmeow-translationOf.md) (functional) names the
source; [`translationResult`](../reference/properties/gmeow-translationResult.md) the form(s), with competing translations coexisting
without privilege (P9).

### [`gmeow:ScriptLanguageAttribution`](../reference/classes/gmeow-ScriptLanguageAttribution.md) · [`gmeow:attributionTarget`](../reference/properties/gmeow-attributionTarget.md) · [`gmeow:attributedLanguage`](../reference/properties/gmeow-attributedLanguage.md) · [`gmeow:attributedScript`](../reference/properties/gmeow-attributedScript.md) · [`gmeow:attributedNotation`](../reference/properties/gmeow-attributedNotation.md)

A standpoint-scoped claim assigning a language, writing system, or notation to an
inscription — handling disputed, uncertain, and undeciphered cases. [`attributionTarget`](../reference/properties/gmeow-attributionTarget.md)
(functional) names the inscription; [`attributedLanguage`](../reference/properties/gmeow-attributedLanguage.md) and [`attributedScript`](../reference/properties/gmeow-attributedScript.md)
(non-functional) the assignments, with competing classifications coexisting (P9);
[`attributedNotation`](../reference/properties/gmeow-attributedNotation.md) carries an undeciphered or symbol-classified system (Linear A,
Rongorongo, proto-cuneiform) when no language or script is yet linked.

### [`gmeow:ArchaeologicalFindContext`](../reference/classes/gmeow-ArchaeologicalFindContext.md) · [`gmeow:findContextTarget`](../reference/properties/gmeow-findContextTarget.md) · [`gmeow:findContextPlace`](../reference/properties/gmeow-findContextPlace.md) · [`gmeow:findContextStratigraphy`](../reference/properties/gmeow-findContextStratigraphy.md) · [`gmeow:findContextDating`](../reference/properties/gmeow-findContextDating.md) · [`gmeow:findContextEvent`](../reference/properties/gmeow-findContextEvent.md)
...
campaigns are allowed (P9). [`findContextTarget`](../reference/properties/gmeow-findContextTarget.md) (functional) names the carrier;
[`findContextPlace`](../reference/properties/gmeow-findContextPlace.md) the find-spot; [`findContextStratigraphy`](../reference/properties/gmeow-findContextStratigraphy.md) the layer (opaque [`Entity`](../reference/classes/gmeow-Entity.md)
reference, general stratigraphy deferred to the archaeological-domain model);
[`findContextDating`](../reference/properties/gmeow-findContextDating.md) the [`TemporalMeasurement`](../reference/classes/gmeow-TemporalMeasurement.md)(s); [`findContextEvent`](../reference/properties/gmeow-findContextEvent.md) the excavation or
documentation event (deliberately not subsumed under [`observationResult`](../reference/properties/gmeow-observationResult.md), since
[`gufo:Event`](../external/terms.md#gufo-event) and [`gufo:Endurant`](http://purl.org/nemo/gufo#Endurant) are disjoint).

### [`gmeow:PhysicalCarrierType`](../reference/classes/gmeow-PhysicalCarrierType.md)
