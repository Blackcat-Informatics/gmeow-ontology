...
- **GMEOW terms:** [`gmeow:AccessibilityAssertion`](../reference/classes/gmeow-AccessibilityAssertion.md), [`gmeow:Person`](../reference/classes/gmeow-Person.md), [`gmeow:Place`](../reference/classes/gmeow-Place.md), [`gmeow:assertionFacet`](../reference/properties/gmeow-assertionFacet.md), [`gmeow:assertionPolarity`](../reference/properties/gmeow-assertionPolarity.md), [`gmeow:assertionSubject`](../reference/properties/gmeow-assertionSubject.md), [`gmeow:facetStepFree`](../reference/individuals/gmeow-facetStepFree.md), [`gmeow:facetVisual`](../reference/individuals/gmeow-facetVisual.md), [`gmeow:facetWheelchair`](../reference/individuals/gmeow-facetWheelchair.md), [`gmeow:hasAccessibilityFeature`](../reference/properties/gmeow-hasAccessibilityFeature.md)
...
[`routeKindAccessible`](../reference/individuals/gmeow-routeKindAccessible.md) (slice-dependency doctrine refactor keeps that value individual beside its value
