...
//!
//! This module reproduces both capabilities on top of the native gmeow-rdf
//! codecs ([`gmeow_rdf::parse_dataset`]), which are lenient on the GMEOW
//! ontology's private-use `@x-gmeow-*` language tags (long BCP-47 subtags) and
