<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/e8b98b3a501e70d2d060318cb0507ed04d1b3a97
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/e8b98b3a501e70d2d060318cb0507ed04d1b3a97>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/history/ddd9e8b7e5fd79c5f65389c9362f0725dceaaf23>` `<https://blackcatinformatics.ca/logic/isolationLevelAdequacy>` `"false"^^<http://www.w3.org/2001/XMLSchema#boolean>` *(in `<https://example.org/transaction/isolation-write-skew-serializable/world>`)*
