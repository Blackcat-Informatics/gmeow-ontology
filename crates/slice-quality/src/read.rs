...
//!   canonicalized authored source set it scored. [`RecordedCorpus::verify_fresh`]
//!   recomputes it and hard-fails on absence or mismatch, so a stale record is an error
//!   rather than a silently-accepted pass.
