...
- **GMEOW terms:** [`gmeow:ComplianceAssessment`](../reference/classes/gmeow-ComplianceAssessment.md), [`gmeow:Event`](../reference/classes/gmeow-Event.md), [`gmeow:EventType`](../reference/classes/gmeow-EventType.md), [`gmeow:Norm`](../reference/classes/gmeow-Norm.md), [`gmeow:NormativeSystem`](../reference/classes/gmeow-NormativeSystem.md), [`gmeow:Organization`](../reference/classes/gmeow-Organization.md), [`gmeow:Person`](../reference/classes/gmeow-Person.md), [`gmeow:assessedEvent`](../reference/properties/gmeow-assessedEvent.md), [`gmeow:assessedNorm`](../reference/properties/gmeow-assessedNorm.md), [`gmeow:complianceVerdict`](../reference/properties/gmeow-complianceVerdict.md)
...
| [`gmeow:Condition`](../reference/classes/gmeow-Condition.md) | Condition | A describable circumstance — the trigger of a conditional norm, the activation context of a persona, the antecedent of a causal link (risk design). The canonic... |
...
| [`gmeow:StyleGuide`](../reference/classes/gmeow-StyleGuide.md) | Style Guide | The voice payload of a persona or register — prose whose REGISTER IS THE CONTENT. The prose-voice doctrine (gap analysis): voice documents attach byte-perfect... |
...
| [`gmeow:anchorMeaning`](../reference/properties/gmeow-anchorMeaning.md) | anchor meaning | What scores in this range MEAN — the calibration prose. NOT functional and range-open (localizable-prose convention): localizable prose may carry one meaning p... |
...
| [`gmeow:assessmentTarget`](../reference/properties/gmeow-assessmentTarget.md) | assessment target | What is being scored — a work, an expression, a content segment, a chunk (⊑ observedFeature, the observation-spine bridge idiom). Range intentionally open. Fun... |
...
| [`gmeow:evaluatedCondition`](../reference/properties/gmeow-evaluatedCondition.md) | evaluated condition | The condition this evaluation reports on (⊑ observedFeature — the observation-spine bridge idiom). Functional: one evaluation, one condition; group members get... |
...
| [`gmeow:exemplarRationale`](../reference/properties/gmeow-exemplarRationale.md) | exemplar rationale | Why this is an exemplar — the judgement prose. NOT functional and range-open (localizable-prose convention): localizable, one rationale per language tag; whose... |
...
| [`gmeow:exemplarSubject`](../reference/properties/gmeow-exemplarSubject.md) | exemplar subject | The entity whose pattern the exemplar evidences — a frame-scoped character whose conduct across the cited work is the example (design context: 823 such links i... |
...
| [`gmeow:prescribedConduct`](../reference/properties/gmeow-prescribedConduct.md) | prescribed conduct | The conduct the norm is about — an event type, a goal (teleology design), a situation, or a rights action (via the rights graft). The range is intentionally op... |
...
### [`gmeow:Norm`](../reference/classes/gmeow-Norm.md) · [`gmeow:NormativeSystem`](../reference/classes/gmeow-NormativeSystem.md)

[`Norm`](../reference/classes/gmeow-Norm.md) is a [`gufo:Category`](../external/terms.md#gufo-category) at [`Entity`](../reference/classes/gmeow-Entity.md) level — a prescription existing by social
convention that records an issuer prescribes some conduct and asserts nothing about
the world. [`NormativeSystem`](../reference/classes/gmeow-NormativeSystem.md) is a body of norms with a shared identity (constitution,
legal code, code of conduct, principia, rubric set); member norms attach via [`partOf`](../reference/properties/gmeow-partOf.md),
and competing systems coexist without adjudication.

### [`gmeow:DeonticModality`](../reference/classes/gmeow-DeonticModality.md) · [`gmeow:deonticModality`](../reference/properties/gmeow-deonticModality.md)
...
schema change. [`deonticModality`](../reference/properties/gmeow-deonticModality.md) is the functional property fixing a norm's single force;
a modality-bearing norm must also carry an issuer.

### [`gmeow:normIssuer`](../reference/properties/gmeow-normIssuer.md) · [`gmeow:systemIssuer`](../reference/properties/gmeow-systemIssuer.md) · [`gmeow:normBearer`](../reference/properties/gmeow-normBearer.md) · [`gmeow:prescribedConduct`](../reference/properties/gmeow-prescribedConduct.md)

[`normIssuer`](../reference/properties/gmeow-normIssuer.md) names the agent or standpoint according to which a norm holds — the keystone
turning an ought into an ought-according-to; domain-free, non-functional (co-issued norms
carry several), documented as ⊑ [`accordingTo`](../reference/properties/gmeow-accordingTo.md). [`systemIssuer`](../reference/properties/gmeow-systemIssuer.md) ⊑ [`normIssuer`](../reference/properties/gmeow-normIssuer.md) issues a whole
[`NormativeSystem`](../reference/classes/gmeow-NormativeSystem.md). [`normBearer`](../reference/properties/gmeow-normBearer.md) names a bound agent (absent = everyone in the issuer's
scope). [`prescribedConduct`](../reference/properties/gmeow-prescribedConduct.md) points at the governed conduct — an event type, a [`Goal`](../reference/classes/gmeow-Goal.md)
(core teleology), a situation, or a rights action — with an intentionally open range.

### [`gmeow:AuthorityLevel`](../reference/classes/gmeow-AuthorityLevel.md) · [`gmeow:strongerThan`](../reference/properties/gmeow-strongerThan.md) · [`gmeow:hasAuthorityLevel`](../reference/properties/gmeow-hasAuthorityLevel.md)

The ordered authority-grade vocabulary (absolute ≻ high ≻ medium ≻ conditional), the
kernel [`GranularityLevel`](../reference/classes/gmeow-GranularityLevel.md) pattern. [`strongerThan`](../reference/properties/gmeow-strongerThan.md) is transitive on the levels only;
[`hasAuthorityLevel`](../reference/properties/gmeow-hasAuthorityLevel.md) records the grade an issuing system claims for a norm (non-functional —
sources may grade differently and coexist). What the order does to conflicts is solver work.

### [`gmeow:overrides`](../reference/properties/gmeow-overrides.md) · [`gmeow:PrecedenceTenure`](../reference/classes/gmeow-PrecedenceTenure.md) · [`gmeow:precedenceHigher`](../reference/properties/gmeow-precedenceHigher.md) · [`gmeow:precedenceLower`](../reference/properties/gmeow-precedenceLower.md) · [`gmeow:precedenceScope`](../reference/properties/gmeow-precedenceScope.md)

`overrides` is pairwise defeasible precedence — deliberately not transitive, SHACL-irreflexive;
chains and cycles are solver work over the recorded pairs. [`PrecedenceTenure`](../reference/classes/gmeow-PrecedenceTenure.md) is the reified,
time-scoped form ("Tier 2 overrode X until v3.5") carrying its [`precedenceHigher`](../reference/properties/gmeow-precedenceHigher.md) /
[`precedenceLower`](../reference/properties/gmeow-precedenceLower.md) norms (functional, distinct) and a mandatory [`precedenceScope`](../reference/properties/gmeow-precedenceScope.md) (a
[`NormativeSystem`](../reference/classes/gmeow-NormativeSystem.md) — precedence is always scoped), withdrawn by suppression only.

### [`gmeow:Condition`](../reference/classes/gmeow-Condition.md) · [`gmeow:conditionText`](../reference/properties/gmeow-conditionText.md) · [`gmeow:normCondition`](../reference/properties/gmeow-normCondition.md)

[`Condition`](../reference/classes/gmeow-Condition.md) is a describable circumstance whose canonical form is prose — the trigger of a
conditional norm, a persona's activation context, a causal antecedent. [`conditionText`](../reference/properties/gmeow-conditionText.md) is the
mandatory natural-language statement that formalizations approximate. [`normCondition`](../reference/properties/gmeow-normCondition.md) names the
condition(s) under which a norm applies (several are an implicit conjunction).

### [`gmeow:ConditionGroup`](../reference/classes/gmeow-ConditionGroup.md) · [`gmeow:GroupOperator`](../reference/classes/gmeow-GroupOperator.md) · [`gmeow:groupOperator`](../reference/properties/gmeow-groupOperator.md) · [`gmeow:groupMember`](../reference/properties/gmeow-groupMember.md)

A composite condition combining members with explicit logic. [`GroupOperator`](../reference/classes/gmeow-GroupOperator.md) is the closed
trichotomy — all (and), any (or), none (not); richer trees nest groups, never add operators.
[`groupOperator`](../reference/properties/gmeow-groupOperator.md) is the functional, mandatory operator; [`groupMember`](../reference/properties/gmeow-groupMember.md) attaches the members
(at least two by SHACL). A group is itself a [`Condition`](../reference/classes/gmeow-Condition.md).

### [`gmeow:ConditionExpression`](../reference/classes/gmeow-ConditionExpression.md) · [`gmeow:expressionText`](../reference/properties/gmeow-expressionText.md) · [`gmeow:ExpressionLanguage`](../reference/classes/gmeow-ExpressionLanguage.md) · [`gmeow:expressionLanguage`](../reference/properties/gmeow-expressionLanguage.md) · [`gmeow:formalizedAs`](../reference/properties/gmeow-formalizedAs.md)

A [`ConditionExpression`](../reference/classes/gmeow-ConditionExpression.md) is a machine formalization in a named language — stored, never executed
([Principle 12](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-12)): no CI step, test, or tool evaluates it against the graph. [`expressionText`](../reference/properties/gmeow-expressionText.md) carries
the verbatim source; [`ExpressionLanguage`](../reference/classes/gmeow-ExpressionLanguage.md) is the open language vocabulary (prose, SPARQL ASK, CEL,
Rego, Cedar, XACML, SHACL) declared via [`expressionLanguage`](../reference/properties/gmeow-expressionLanguage.md). [`formalizedAs`](../reference/properties/gmeow-formalizedAs.md) attaches a formalization
as a challengeable claim of equivalence to the prose.

### [`gmeow:ConditionParameter`](../reference/classes/gmeow-ConditionParameter.md) · [`gmeow:conditionParameter`](../reference/properties/gmeow-conditionParameter.md) · [`gmeow:parameterName`](../reference/properties/gmeow-parameterName.md) · [`gmeow:parameterValue`](../reference/properties/gmeow-parameterValue.md) · [`gmeow:parameterEntity`](../reference/properties/gmeow-parameterEntity.md)

A named binding that instantiates a condition template so one [`Condition`](../reference/classes/gmeow-Condition.md) serves many norms.
[`conditionParameter`](../reference/properties/gmeow-conditionParameter.md) attaches bindings; [`parameterName`](../reference/properties/gmeow-parameterName.md) is the mandatory key; a parameter carries
exactly one of [`parameterValue`](../reference/properties/gmeow-parameterValue.md) (literal) or [`parameterEntity`](../reference/properties/gmeow-parameterEntity.md) (IRI) by SHACL.

### [`gmeow:ConditionEvaluation`](../reference/classes/gmeow-ConditionEvaluation.md) · [`gmeow:evaluatedCondition`](../reference/properties/gmeow-evaluatedCondition.md) · [`gmeow:EvaluationVerdict`](../reference/classes/gmeow-EvaluationVerdict.md) · [`gmeow:evaluationVerdict`](../reference/properties/gmeow-evaluationVerdict.md)

Whether a condition held is a [`ConditionEvaluation`](../reference/classes/gmeow-ConditionEvaluation.md) ⊑ [`Observation`](../reference/classes/gmeow-Observation.md), vantage = the evaluator — never
a graph entailment; two evaluators disagreeing are two coexisting cells. [`evaluatedCondition`](../reference/properties/gmeow-evaluatedCondition.md)
(⊑ [`observedFeature`](../reference/properties/gmeow-observedFeature.md)) names the reported condition. [`EvaluationVerdict`](../reference/classes/gmeow-EvaluationVerdict.md) is the closed trichotomy
held / not-held / undetermined, carried by the functional [`evaluationVerdict`](../reference/properties/gmeow-evaluationVerdict.md).

### [`gmeow:violates`](../reference/properties/gmeow-violates.md) · [`gmeow:complies`](../reference/properties/gmeow-complies.md) · [`gmeow:ComplianceAssessment`](../reference/classes/gmeow-ComplianceAssessment.md) · [`gmeow:assessedEvent`](../reference/properties/gmeow-assessedEvent.md) · [`gmeow:assessedNorm`](../reference/properties/gmeow-assessedNorm.md) · [`gmeow:complianceVerdict`](../reference/properties/gmeow-complianceVerdict.md)

`violates` / `complies` are the flat shortcuts ([`Event`](../reference/classes/gmeow-Event.md) → [`Norm`](../reference/classes/gmeow-Norm.md)), indexed to whoever asserts them and
never entailed. Promote to [`ComplianceAssessment`](../reference/classes/gmeow-ComplianceAssessment.md) ⊑ [`Observation`](../reference/classes/gmeow-Observation.md) when the assessor, evidence, or
confidence must be first-class: [`assessedEvent`](../reference/properties/gmeow-assessedEvent.md) (⊑ [`observedFeature`](../reference/properties/gmeow-observedFeature.md)) and [`assessedNorm`](../reference/properties/gmeow-assessedNorm.md) name the
pair, [`complianceVerdict`](../reference/properties/gmeow-complianceVerdict.md) reuses the verdict vocabulary (held = compliant, not-held = violative).

### [`gmeow:Rubric`](../reference/classes/gmeow-Rubric.md) · [`gmeow:Criterion`](../reference/classes/gmeow-Criterion.md) · [`gmeow:hasCriterion`](../reference/properties/gmeow-hasCriterion.md)

A [`Rubric`](../reference/classes/gmeow-Rubric.md) ⊑ [`Norm`](../reference/classes/gmeow-Norm.md) is a norm for judging — a reified evaluation framework that names its issuer and
may be overridden; applying it is solver work that returns vantage-indexed [`Assessment`](../reference/classes/gmeow-Assessment.md) cells.
[`Criterion`](../reference/classes/gmeow-Criterion.md) is one evaluative axis with named poles; [`hasCriterion`](../reference/properties/gmeow-hasCriterion.md) ⊑ [`hasPart`](../reference/properties/gmeow-hasPart.md) attaches the axes
(rubrics are multi-axis by design).

### [`gmeow:CriterionPole`](../reference/classes/gmeow-CriterionPole.md) · [`gmeow:rewardPole`](../reference/properties/gmeow-rewardPole.md) · [`gmeow:penaltyPole`](../reference/properties/gmeow-penaltyPole.md) · [`gmeow:CriterionDomain`](../reference/classes/gmeow-CriterionDomain.md) · [`gmeow:criterionDomain`](../reference/properties/gmeow-criterionDomain.md)

[`CriterionPole`](../reference/classes/gmeow-CriterionPole.md) is a named extreme of a criterion — a small information object with its own label
and definition ("Power from the Bottom"), not a bare number. [`rewardPole`](../reference/properties/gmeow-rewardPole.md) and [`penaltyPole`](../reference/properties/gmeow-penaltyPole.md) are the
functional, mandatory, mutually distinct poles. [`CriterionDomain`](../reference/classes/gmeow-CriterionDomain.md) is the open subject-domain
vocabulary (relational, factual, aesthetic, safety, stylistic) carried by [`criterionDomain`](../reference/properties/gmeow-criterionDomain.md).

### [`gmeow:ScoreScale`](../reference/classes/gmeow-ScoreScale.md) · [`gmeow:usesScale`](../reference/properties/gmeow-usesScale.md) · [`gmeow:scaleMin`](../reference/properties/gmeow-scaleMin.md) · [`gmeow:scaleMax`](../reference/properties/gmeow-scaleMax.md) · [`gmeow:scaleStep`](../reference/properties/gmeow-scaleStep.md)

[`ScoreScale`](../reference/classes/gmeow-ScoreScale.md) is a numeric scale — minimum, maximum, optional step; scale arithmetic is solver work.
[`usesScale`](../reference/properties/gmeow-usesScale.md) attaches it at the rubric level (default) or criterion level (override). [`scaleMin`](../reference/properties/gmeow-scaleMin.md) /
[`scaleMax`](../reference/properties/gmeow-scaleMax.md) are mandatory bounds (min < max by SHACL); [`scaleStep`](../reference/properties/gmeow-scaleStep.md) is the optional discrete step
(absent = continuous).

### [`gmeow:ScoreAnchor`](../reference/classes/gmeow-ScoreAnchor.md) · [`gmeow:hasScoreAnchor`](../reference/properties/gmeow-hasScoreAnchor.md) · [`gmeow:anchorRangeMin`](../reference/properties/gmeow-anchorRangeMin.md) · [`gmeow:anchorRangeMax`](../reference/properties/gmeow-anchorRangeMax.md) · [`gmeow:anchorMeaning`](../reference/properties/gmeow-anchorMeaning.md) · [`gmeow:anchorExemplar`](../reference/properties/gmeow-anchorExemplar.md)

A [`ScoreAnchor`](../reference/classes/gmeow-ScoreAnchor.md) pins a score range to its meaning and exemplars — the rubric's calibration content,
with interpolation left to the solver. [`hasScoreAnchor`](../reference/properties/gmeow-hasScoreAnchor.md) attaches anchors to a criterion (high / medium /
low coexist). [`anchorRangeMin`](../reference/properties/gmeow-anchorRangeMin.md) / [`anchorRangeMax`](../reference/properties/gmeow-anchorRangeMax.md) bound the range; the mandatory [`anchorMeaning`](../reference/properties/gmeow-anchorMeaning.md) carries
the calibration prose (one per language tag); [`anchorExemplar`](../reference/properties/gmeow-anchorExemplar.md) pins exemplars to the range.

### [`gmeow:Exemplar`](../reference/classes/gmeow-Exemplar.md) · [`gmeow:ExemplarPolarity`](../reference/classes/gmeow-ExemplarPolarity.md) · [`gmeow:exemplarPolarity`](../reference/properties/gmeow-exemplarPolarity.md) · [`gmeow:exemplarSubject`](../reference/properties/gmeow-exemplarSubject.md) · [`gmeow:exemplarRedirect`](../reference/properties/gmeow-exemplarRedirect.md) · [`gmeow:exemplarRationale`](../reference/properties/gmeow-exemplarRationale.md)

[`Exemplar`](../reference/classes/gmeow-Exemplar.md) ⊑ [`CitationAct`](../reference/classes/gmeow-CitationAct.md) holds something up as an example — pinned by citation [`Selector`](../reference/classes/gmeow-Selector.md) AND/OR an
[`exemplarSubject`](../reference/properties/gmeow-exemplarSubject.md) (a character's conduct across a work; at least one by SHACL). [`ExemplarPolarity`](../reference/classes/gmeow-ExemplarPolarity.md) is
the closed trichotomy positive / negative / cautionary, carried by the functional, mandatory
[`exemplarPolarity`](../reference/properties/gmeow-exemplarPolarity.md); [`exemplarRedirect`](../reference/properties/gmeow-exemplarRedirect.md) sends a cautionary case to the criterion it actually evidences;
[`exemplarRationale`](../reference/properties/gmeow-exemplarRationale.md) is the localizable judgement prose.

### [`gmeow:Assessment`](../reference/classes/gmeow-Assessment.md) · [`gmeow:assessmentTarget`](../reference/properties/gmeow-assessmentTarget.md) · [`gmeow:assessmentCriterion`](../reference/properties/gmeow-assessmentCriterion.md) · [`gmeow:assessmentRubric`](../reference/properties/gmeow-assessmentRubric.md) · [`gmeow:assessmentScoreValue`](../reference/properties/gmeow-assessmentScoreValue.md)

[`Assessment`](../reference/classes/gmeow-Assessment.md) ⊑ [`Observation`](../reference/classes/gmeow-Observation.md) scores a target against a criterion or whole rubric — vantage = the judge;
an LLM judge is just a vantage and disagreeing models are coexisting cells. [`assessmentTarget`](../reference/properties/gmeow-assessmentTarget.md)
(⊑ [`observedFeature`](../reference/properties/gmeow-observedFeature.md)) names what is scored; [`assessmentCriterion`](../reference/properties/gmeow-assessmentCriterion.md) / [`assessmentRubric`](../reference/properties/gmeow-assessmentRubric.md) play the
[`observationMethod`](../reference/properties/gmeow-observationMethod.md) role without the subproperty axiom ([`claimModality`](../reference/properties/gmeow-claimModality.md) pattern); [`assessmentScoreValue`](../reference/properties/gmeow-assessmentScoreValue.md)
is the mandatory numeric twin of [`observationResult`](../reference/properties/gmeow-observationResult.md) — zeros are scores, never absences.

### [`gmeow:Persona`](../reference/classes/gmeow-Persona.md) · [`gmeow:personaBearer`](../reference/properties/gmeow-personaBearer.md) · [`gmeow:personaRegister`](../reference/properties/gmeow-personaRegister.md) · [`gmeow:activatedIn`](../reference/properties/gmeow-activatedIn.md) · [`gmeow:expressesNorm`](../reference/properties/gmeow-expressesNorm.md)

[`Persona`](../reference/classes/gmeow-Persona.md) is a reified expression policy of one agent (a relator, not a [`gufo:Role`](../external/terms.md#gufo-role)): PRIMARY and
PRIVATE are two co-equal personas, withdrawn by suppression, never ranked. [`personaBearer`](../reference/properties/gmeow-personaBearer.md) is the
functional, mandatory bearer; [`personaRegister`](../reference/properties/gmeow-personaRegister.md) draws ≥1 register from the names-core spine;
[`activatedIn`](../reference/properties/gmeow-activatedIn.md) names the activation [`Condition`](../reference/classes/gmeow-Condition.md) or situation; [`expressesNorm`](../reference/properties/gmeow-expressesNorm.md) makes the same-norms
invariant queryable rather than a shape (divergence is legal).

### [`gmeow:StyleGuide`](../reference/classes/gmeow-StyleGuide.md) · [`gmeow:styleGuideFor`](../reference/properties/gmeow-styleGuideFor.md) · [`gmeow:exemplifiedBy`](../reference/properties/gmeow-exemplifiedBy.md)

[`StyleGuide`](../reference/classes/gmeow-StyleGuide.md) is the voice payload of a persona or register — prose whose register IS the content.
[`styleGuideFor`](../reference/properties/gmeow-styleGuideFor.md) names what it voices (a [`Persona`](../reference/classes/gmeow-Persona.md) and/or [`Register`](../reference/classes/gmeow-Register.md)). [`exemplifiedBy`](../reference/properties/gmeow-exemplifiedBy.md) attaches
byte-perfect content-digested [`Document`](../reference/classes/gmeow-Document.md)s that carry [`aboutnessEnacts`](../reference/individuals/gmeow-aboutnessEnacts.md) — the document does not
