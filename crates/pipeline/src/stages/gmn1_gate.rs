...
/// generated fanout yet) the check is a no-op that the post-pipeline fanout activates. `major`
/// is the same lineage coordinate the codec/projection resolve, never a Rust constant.
fn conformance_pack_rel(major: &str) -> String {
    format!("generated/projections/lang/gmn1/v{major}/conformance-pack.ttl")
}
