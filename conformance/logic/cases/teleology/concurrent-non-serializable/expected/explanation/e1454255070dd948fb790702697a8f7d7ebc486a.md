<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/e1454255070dd948fb790702697a8f7d7ebc486a
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/e1454255070dd948fb790702697a8f7d7ebc486a>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/teleology>`:
  `<https://blackcatinformatics.ca/logic/finding/59a3b56205d81669fa1ef5cafc152035a85b9a41>` `<https://blackcatinformatics.ca/logic/anomalyCycle>` `"https://example.org/teleology/concurrent-non-serializable/legL -> https://example.org/teleology/concurrent-non-serializable/legR -> https://example.org/teleology/concurrent-non-serializable/legL"` *(in `<https://example.org/teleology/concurrent-non-serializable/world>`)*
