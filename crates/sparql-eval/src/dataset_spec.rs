...
use gmeow_rdf_core::{DatasetView, GraphMatch, QuadIds, RdfDataset, TermId, TermValue};
use gmeow_sparql_algebra::{QueryDataset, UsingClause};
...
fn resolve_graphs(graphs: &[gmeow_sparql_algebra::NamedNode], dataset: &RdfDataset) -> Vec<TermId> {
