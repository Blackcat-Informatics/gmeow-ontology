<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/ab259947455c4fcf089783a5010bccac49f2ebfa
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/ab259947455c4fcf089783a5010bccac49f2ebfa>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/outcome/fa50c597ea21ad7e001cf7c955f071fcb1bae479>` `<https://blackcatinformatics.ca/logic/transactionStart>` `<https://example.org/transaction/concurrent-non-serializable/s0>` *(in `<https://example.org/transaction/concurrent-non-serializable/world>`)*
