...
- The five-facet software model (five-facet software model): git-as-provenance, verifiable releases, this repo itself.
...
- **GMEOW terms:** [`gmeow:Agent`](../reference/classes/gmeow-Agent.md), [`gmeow:AuthorIdentity`](../reference/classes/gmeow-AuthorIdentity.md), [`gmeow:BuildActivity`](../reference/classes/gmeow-BuildActivity.md), [`gmeow:Commit`](../reference/classes/gmeow-Commit.md), [`gmeow:Distribution`](../reference/classes/gmeow-Distribution.md), [`gmeow:Person`](../reference/classes/gmeow-Person.md), [`gmeow:Repository`](../reference/classes/gmeow-Repository.md), [`gmeow:buildOutput`](../reference/properties/gmeow-buildOutput.md), [`gmeow:buildSource`](../reference/properties/gmeow-buildSource.md), [`gmeow:canonicalizedIdentity`](../reference/properties/gmeow-canonicalizedIdentity.md)
...
| [`gmeow:buildConfigUri`](../reference/properties/gmeow-buildConfigUri.md) | build config URI | The URI of the build configuration or workflow file that describes the build process — e.g. the URL of `ci/workflows/release.yml` or a Jenkinsfile. |
...
| [`gmeow:projectHomepage`](../reference/properties/gmeow-projectHomepage.md) | project homepage | The homepage of a project (project homepage and language) — the [doap:homepage](http://usefulinc.com/ns/doap#homepage) / [schema:url](https://schema.org/url) of a software project. Functional; range open (an IRI). |
...
The verifiable-release chain (verifiable-release chain): a build consumes [`gmeow:buildSource`](../reference/properties/gmeow-buildSource.md) (commit or
