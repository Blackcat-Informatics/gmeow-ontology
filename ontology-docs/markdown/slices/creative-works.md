...
This slice owns 153 terms and contributes 173 mapping or projection rows. Use it when its terms match the native fact you want to preserve; use the linkage tables to see how those facts leave GMEOW for consumer vocabularies.
...
- The foundational WEMI 4-tier spine ([`Work`](../reference/classes/gmeow-Work.md)/Expression/Manifestation/Item) plus the universal [`Contribution`](../reference/classes/gmeow-Contribution.md) and [`CreativeDerivation`](../reference/classes/gmeow-CreativeDerivation.md) relators, consumed by the documents, software-products, citations, narrative, and music slices; projects to FRBR/LRMoo/CIDOC/schema.org by reference ([Principle 5](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-5)).
...
#
# Worked example: the WEMI spine (WEMI spine, ). One abstract Work is realized by
...
| [`gmeow:roleInventor`](../reference/individuals/gmeow-roleInventor.md) | inventor | An agent who invented the subject of a patent (project homepage and language). Projects to [schema:inventor](https://schema.org/inventor) via the Contribution pattern. |
...
- **Rows:** 173
- **Projection profiles:** `bibframe`, `codemeta`, `dcterms`, `doap`, `foaf`, `lrmoo`, `mo`, `oai_dc`, `odrl`, `pon`, `schema-org`
- **External vocabularies:** `bibframe`, `codemeta`, `credit`, `dc`, `dcterms`, `discogs`, `doap`, `fabio`, `foaf`, `frbr`, `lrmoo`, `mbz`, `mo`, `odrl`, `pav`, `pon`, `prov`, `schema`, `wd`
...
| [`gmeow:MusicalWork`](../reference/classes/gmeow-MusicalWork.md) | equivalence | `-` | [skos:relatedMatch](http://www.w3.org/2004/02/skos/core#relatedMatch) | [wd:P434](https://www.wikidata.org/wiki/Property:P434) | `gmeow-music.sssom.tsv`; `gmeow:eqMuNot008`; confidence 0.8 |
| [`gmeow:Recording`](../reference/classes/gmeow-Recording.md) | equivalence | `-` | [skos:relatedMatch](http://www.w3.org/2004/02/skos/core#relatedMatch) | [wd:P436](https://www.wikidata.org/wiki/Property:P436) | `gmeow-music.sssom.tsv`; `gmeow:eqMuNot009`; confidence 0.8 |
...
replaces the former flat [`gufo:Kind`](../external/terms.md#gufo-kind) (pre-WEMI spine) so that surface-vocabulary
...
### [`gmeow:Work`](../reference/classes/gmeow-Work.md) · [`gmeow:Expression`](../reference/classes/gmeow-Expression.md) · [`gmeow:Manifestation`](../reference/classes/gmeow-Manifestation.md) · [`gmeow:Item`](../reference/classes/gmeow-Item.md)

The four-tier WEMI spine as native [`gufo:Kind`](../external/terms.md#gufo-kind) classes: a [`gmeow:Work`](../reference/classes/gmeow-Work.md) is abstract
intellectual content, a [`gmeow:Expression`](../reference/classes/gmeow-Expression.md) its realization in a language /
notation / arrangement frame, a [`gmeow:Manifestation`](../reference/classes/gmeow-Manifestation.md) an edition / format /
release, and a [`gmeow:Item`](../reference/classes/gmeow-Item.md) a single exemplar. [`gmeow:CreativeWork`](../reference/classes/gmeow-CreativeWork.md) is the umbrella
over all four.

### [`gmeow:realizes`](../reference/properties/gmeow-realizes.md) · [`gmeow:embodies`](../reference/properties/gmeow-embodies.md) · [`gmeow:exemplifies`](../reference/properties/gmeow-exemplifies.md) · [`gmeow:realizedThrough`](../reference/properties/gmeow-realizedThrough.md) · [`gmeow:embodiedIn`](../reference/properties/gmeow-embodiedIn.md) · [`gmeow:exemplifiedBy`](../reference/properties/gmeow-exemplifiedBy.md)

The tier-binding relations (FRBR R-relations by equivalence): [`gmeow:realizes`](../reference/properties/gmeow-realizes.md)
([`Expression`](../reference/classes/gmeow-Expression.md) → [`Work`](../reference/classes/gmeow-Work.md)), [`gmeow:embodies`](../reference/properties/gmeow-embodies.md) ([`Manifestation`](../reference/classes/gmeow-Manifestation.md) → [`Expression`](../reference/classes/gmeow-Expression.md)), and
[`gmeow:exemplifies`](../reference/properties/gmeow-exemplifies.md) ([`Item`](../reference/classes/gmeow-Item.md) → [`Manifestation`](../reference/classes/gmeow-Manifestation.md)), with [`gmeow:realizedThrough`](../reference/properties/gmeow-realizedThrough.md),
[`gmeow:embodiedIn`](../reference/properties/gmeow-embodiedIn.md), and [`gmeow:exemplifiedBy`](../reference/properties/gmeow-exemplifiedBy.md) their inverses descending the spine.

### [`gmeow:CreativeWorkType`](../reference/classes/gmeow-CreativeWorkType.md) · [`gmeow:RealizationMode`](../reference/classes/gmeow-RealizationMode.md) · [`gmeow:realizationMode`](../reference/properties/gmeow-realizationMode.md)

The work's kind and mode: [`gmeow:CreativeWorkType`](../reference/classes/gmeow-CreativeWorkType.md) is the open vocabulary of work
types (literary, musical, software, film, dataset…); [`gmeow:realizationMode`](../reference/properties/gmeow-realizationMode.md) over
[`gmeow:RealizationMode`](../reference/classes/gmeow-RealizationMode.md) records how an expression is realized (notated, performed,
oral, improvised, machine-generated…) — individuals, never subclasses (Principle
9).

### [`gmeow:Contribution`](../reference/classes/gmeow-Contribution.md) · [`gmeow:contributor`](../reference/properties/gmeow-contributor.md) · [`gmeow:contributionTarget`](../reference/properties/gmeow-contributionTarget.md) · [`gmeow:contributionRole`](../reference/properties/gmeow-contributionRole.md) · [`gmeow:ContributionRole`](../reference/classes/gmeow-ContributionRole.md) · [`gmeow:contributionDegree`](../reference/properties/gmeow-contributionDegree.md)

The contribution relator: [`gmeow:Contribution`](../reference/classes/gmeow-Contribution.md) binds [`gmeow:contributor`](../reference/properties/gmeow-contributor.md) ×
[`gmeow:contributionTarget`](../reference/properties/gmeow-contributionTarget.md) × [`gmeow:contributionRole`](../reference/properties/gmeow-contributionRole.md) (over the open
[`gmeow:ContributionRole`](../reference/classes/gmeow-ContributionRole.md) vocabulary) with provenance, period, and
[`gmeow:contributionDegree`](../reference/properties/gmeow-contributionDegree.md). The reified form behind the flat 80%-case shortcuts.

### [`gmeow:hasContributor`](../reference/properties/gmeow-hasContributor.md) · [`gmeow:hasAuthor`](../reference/properties/gmeow-hasAuthor.md) · [`gmeow:hasEditor`](../reference/properties/gmeow-hasEditor.md) · [`gmeow:hasTranslator`](../reference/properties/gmeow-hasTranslator.md) · [`gmeow:hasIllustrator`](../reference/properties/gmeow-hasIllustrator.md) · [`gmeow:hasComposer`](../reference/properties/gmeow-hasComposer.md) · [`gmeow:hasLyricist`](../reference/properties/gmeow-hasLyricist.md) · [`gmeow:hasArranger`](../reference/properties/gmeow-hasArranger.md) · [`gmeow:hasConductor`](../reference/properties/gmeow-hasConductor.md) · [`gmeow:hasPerformer`](../reference/properties/gmeow-hasPerformer.md) · [`gmeow:hasNarrator`](../reference/properties/gmeow-hasNarrator.md) · [`gmeow:hasProducer`](../reference/properties/gmeow-hasProducer.md)

The flat contribution shortcuts: [`gmeow:hasContributor`](../reference/properties/gmeow-hasContributor.md) and its role-specialized
siblings ([`gmeow:hasAuthor`](../reference/properties/gmeow-hasAuthor.md), [`gmeow:hasEditor`](../reference/properties/gmeow-hasEditor.md), [`gmeow:hasTranslator`](../reference/properties/gmeow-hasTranslator.md),
[`gmeow:hasIllustrator`](../reference/properties/gmeow-hasIllustrator.md), [`gmeow:hasComposer`](../reference/properties/gmeow-hasComposer.md), [`gmeow:hasLyricist`](../reference/properties/gmeow-hasLyricist.md),
[`gmeow:hasArranger`](../reference/properties/gmeow-hasArranger.md), [`gmeow:hasConductor`](../reference/properties/gmeow-hasConductor.md), [`gmeow:hasPerformer`](../reference/properties/gmeow-hasPerformer.md),
[`gmeow:hasNarrator`](../reference/properties/gmeow-hasNarrator.md), [`gmeow:hasProducer`](../reference/properties/gmeow-hasProducer.md)) cover the common case; promote to a
[`gmeow:Contribution`](../reference/classes/gmeow-Contribution.md) when period, confidence, or degree must be recorded.

### [`gmeow:CreativeDerivation`](../reference/classes/gmeow-CreativeDerivation.md) · [`gmeow:derivationSource`](../reference/properties/gmeow-derivationSource.md) · [`gmeow:derivationProduct`](../reference/properties/gmeow-derivationProduct.md) · [`gmeow:derivationType`](../reference/properties/gmeow-derivationType.md) · [`gmeow:DerivationType`](../reference/classes/gmeow-DerivationType.md)

The derivation relator: a [`gmeow:CreativeDerivation`](../reference/classes/gmeow-CreativeDerivation.md) binds a
[`gmeow:derivationSource`](../reference/properties/gmeow-derivationSource.md) work to its [`gmeow:derivationProduct`](../reference/properties/gmeow-derivationProduct.md), classified by
[`gmeow:derivationType`](../reference/properties/gmeow-derivationType.md) over the open [`gmeow:DerivationType`](../reference/classes/gmeow-DerivationType.md) vocabulary (arrangement,
cover, remix, sample, parody, transcription, translation…).

### [`gmeow:arrangementOf`](../reference/properties/gmeow-arrangementOf.md) · [`gmeow:coverOf`](../reference/properties/gmeow-coverOf.md) · [`gmeow:remixOf`](../reference/properties/gmeow-remixOf.md) · [`gmeow:samples`](../reference/properties/gmeow-samples.md) · [`gmeow:transcriptionOf`](../reference/properties/gmeow-transcriptionOf.md) · [`gmeow:quotesWork`](../reference/properties/gmeow-quotesWork.md)

The flat derivation shortcuts: [`gmeow:arrangementOf`](../reference/properties/gmeow-arrangementOf.md), [`gmeow:coverOf`](../reference/properties/gmeow-coverOf.md),
[`gmeow:remixOf`](../reference/properties/gmeow-remixOf.md), [`gmeow:samples`](../reference/properties/gmeow-samples.md), [`gmeow:transcriptionOf`](../reference/properties/gmeow-transcriptionOf.md), and [`gmeow:quotesWork`](../reference/properties/gmeow-quotesWork.md)
name the common work-to-work derivations directly, with the reified
[`gmeow:CreativeDerivation`](../reference/classes/gmeow-CreativeDerivation.md) available when provenance must be carried.

### [`gmeow:ManifestationFormat`](../reference/classes/gmeow-ManifestationFormat.md) · [`gmeow:hasManifestationFormat`](../reference/properties/gmeow-hasManifestationFormat.md) · [`gmeow:CarrierMedium`](../reference/classes/gmeow-CarrierMedium.md) · [`gmeow:hasCarrier`](../reference/properties/gmeow-hasCarrier.md) · [`gmeow:medium`](../reference/properties/gmeow-medium.md) · [`gmeow:Genre`](../reference/classes/gmeow-Genre.md) · [`gmeow:hasGenre`](../reference/properties/gmeow-hasGenre.md) · [`gmeow:audience`](../reference/properties/gmeow-audience.md)

The manifestation and classification facets: [`gmeow:hasManifestationFormat`](../reference/properties/gmeow-hasManifestationFormat.md) over
the open [`gmeow:ManifestationFormat`](../reference/classes/gmeow-ManifestationFormat.md) vocabulary, [`gmeow:hasCarrier`](../reference/properties/gmeow-hasCarrier.md) /
[`gmeow:medium`](../reference/properties/gmeow-medium.md) over [`gmeow:CarrierMedium`](../reference/classes/gmeow-CarrierMedium.md), and the descriptive [`gmeow:hasGenre`](../reference/properties/gmeow-hasGenre.md)
(over [`gmeow:Genre`](../reference/classes/gmeow-Genre.md)) and [`gmeow:audience`](../reference/properties/gmeow-audience.md) — all individuals, never subclasses.

### [`gmeow:MusicalWork`](../reference/classes/gmeow-MusicalWork.md) · [`gmeow:Recording`](../reference/classes/gmeow-Recording.md) · [`gmeow:ScoreEdition`](../reference/classes/gmeow-ScoreEdition.md) · [`gmeow:hasVersion`](../reference/properties/gmeow-hasVersion.md) · [`gmeow:requires`](../reference/properties/gmeow-requires.md) · [`gmeow:isRequiredBy`](../reference/properties/gmeow-isRequiredBy.md) · [`gmeow:conformsTo`](../reference/properties/gmeow-conformsTo.md)

The music-spine specializations and structural relations: [`gmeow:MusicalWork`](../reference/classes/gmeow-MusicalWork.md) (a
[`Work`](../reference/classes/gmeow-Work.md)), [`gmeow:Recording`](../reference/classes/gmeow-Recording.md) and [`gmeow:ScoreEdition`](../reference/classes/gmeow-ScoreEdition.md) (manifestation-tier
embodiments), plus [`gmeow:hasVersion`](../reference/properties/gmeow-hasVersion.md), the [`gmeow:requires`](../reference/properties/gmeow-requires.md)/[`gmeow:isRequiredBy`](../reference/properties/gmeow-isRequiredBy.md)
dependency pair, and [`gmeow:conformsTo`](../reference/properties/gmeow-conformsTo.md) for standard conformance.
