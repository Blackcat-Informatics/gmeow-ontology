...
- `test_resent_properties_are_multivalued_in_linkml_schema` — Regression guard: non-functional datatype properties must compile to multivalued slots (issue #134 review feedback).
