...
- **GMEOW terms:** [`gmeow:LanguageProficiency`](../reference/classes/gmeow-LanguageProficiency.md), [`gmeow:Person`](../reference/classes/gmeow-Person.md), [`gmeow:ProficiencyLevel`](../reference/classes/gmeow-ProficiencyLevel.md), [`gmeow:ProficiencyScale`](../reference/classes/gmeow-ProficiencyScale.md), [`gmeow:knowsLanguage`](../reference/properties/gmeow-knowsLanguage.md), [`gmeow:langEnglish`](../reference/individuals/gmeow-langEnglish.md), [`gmeow:langFrench`](../reference/individuals/gmeow-langFrench.md), [`gmeow:name`](../reference/properties/gmeow-name.md), [`gmeow:nativeLanguage`](../reference/properties/gmeow-nativeLanguage.md), [`gmeow:profModalityReading`](../reference/individuals/gmeow-profModalityReading.md)
...
[`gmeow:Language`](../reference/classes/gmeow-Language.md) / [`WritingSystem`](../reference/classes/gmeow-WritingSystem.md) / version-lineage spine and the
proficiency-level individuals live in adjacent slices and are not redeclared here.

### [`gmeow:LanguageVersion`](../reference/classes/gmeow-LanguageVersion.md) · [`gmeow:LanguageVariety`](../reference/classes/gmeow-LanguageVariety.md) · [`gmeow:versionLabel`](../reference/properties/gmeow-versionLabel.md)

A [`LanguageVersion`](../reference/classes/gmeow-LanguageVersion.md) is a dated, fully usable revision of a language (a `SubKind` of
[`Language`](../reference/classes/gmeow-Language.md)), bearing its own scripts, names, and status. A [`LanguageVariety`](../reference/classes/gmeow-LanguageVariety.md) is a
speech variety that IS a language — dialect/sociolect/register classifications are
standpointed claims, not OWL subclasses. [`versionLabel`](../reference/properties/gmeow-versionLabel.md) carries any versioned
artifact's designation as a literal.

### [`gmeow:languageOrigin`](../reference/properties/gmeow-languageOrigin.md) · [`gmeow:LanguageOrigin`](../reference/classes/gmeow-LanguageOrigin.md) · [`gmeow:languageModality`](../reference/properties/gmeow-languageModality.md) · [`gmeow:LanguageModality`](../reference/classes/gmeow-LanguageModality.md) · [`gmeow:languageStatus`](../reference/properties/gmeow-languageStatus.md) · [`gmeow:LanguageStatus`](../reference/classes/gmeow-LanguageStatus.md) · [`gmeow:designGoal`](../reference/properties/gmeow-designGoal.md)

The non-functional typing axis: [`languageOrigin`](../reference/properties/gmeow-languageOrigin.md) (natural, constructed, AI-generated,
formal, pidgin, creole, reconstructed, …), [`languageModality`](../reference/properties/gmeow-languageModality.md) (spoken, signed,
written, whistled, tactile, machine, multimodal), and [`languageStatus`](../reference/properties/gmeow-languageStatus.md) (living,
historical, extinct, dormant, revived, emerging, …) draw from open value
vocabularies; [`designGoal`](../reference/properties/gmeow-designGoal.md) is a literal stating an engineered language's purpose.

### [`gmeow:varietyKind`](../reference/properties/gmeow-varietyKind.md) · [`gmeow:LanguageVarietyKind`](../reference/classes/gmeow-LanguageVarietyKind.md) · [`gmeow:varietyOf`](../reference/properties/gmeow-varietyOf.md)

The variety classification axis: [`varietyKind`](../reference/properties/gmeow-varietyKind.md) (dialect, sociolect, register,
slang, standard, creole, pidgin, koine, lingua franca, …) and [`varietyOf`](../reference/properties/gmeow-varietyOf.md) (the
...
### [`gmeow:WritingSystemUsage`](../reference/classes/gmeow-WritingSystemUsage.md) · [`gmeow:usageLanguage`](../reference/properties/gmeow-usageLanguage.md) · [`gmeow:usageWritingSystem`](../reference/properties/gmeow-usageWritingSystem.md) · [`gmeow:scriptRole`](../reference/properties/gmeow-scriptRole.md) · [`gmeow:ScriptRole`](../reference/classes/gmeow-ScriptRole.md) · [`gmeow:scriptUsageInterval`](../reference/properties/gmeow-scriptUsageInterval.md)

The reified co-mingling relator binding {language} × {writing system} × {role} ×
{period}, mirroring names' [`NameUsage`](../reference/classes/gmeow-NameUsage.md). [`usageLanguage`](../reference/properties/gmeow-usageLanguage.md) and [`usageWritingSystem`](../reference/properties/gmeow-usageWritingSystem.md)
are its functional constituents; [`scriptRole`](../reference/properties/gmeow-scriptRole.md) is the functional [`ScriptRole`](../reference/classes/gmeow-ScriptRole.md) value
(primary, logographic content, syllabic grammar, loanword, transliteration,
liturgical, historical, decorative); [`scriptUsageInterval`](../reference/properties/gmeow-scriptUsageInterval.md) carries its period
(Turkish-in-Arabic until 1928).

### [`gmeow:usesWritingSystem`](../reference/properties/gmeow-usesWritingSystem.md) · [`gmeow:scriptCode`](../reference/properties/gmeow-scriptCode.md) · [`gmeow:writingSystemType`](../reference/properties/gmeow-writingSystemType.md) · [`gmeow:WritingSystemType`](../reference/classes/gmeow-WritingSystemType.md) · [`gmeow:textDirection`](../reference/properties/gmeow-textDirection.md) · [`gmeow:TextDirection`](../reference/classes/gmeow-TextDirection.md)

The direct writing-system properties: [`usesWritingSystem`](../reference/properties/gmeow-usesWritingSystem.md) is the non-functional,
co-equal language→script relation; [`scriptCode`](../reference/properties/gmeow-scriptCode.md) is the optional ISO 15924 code;
[`writingSystemType`](../reference/properties/gmeow-writingSystemType.md) and [`textDirection`](../reference/properties/gmeow-textDirection.md) draw open value vocabularies for structural
kind (alphabet, abjad, abugida, syllabary, logographic, …) and direction (ltr, rtl,
vertical, boustrophedon, non-linear, contextual).

### [`gmeow:LanguageProficiency`](../reference/classes/gmeow-LanguageProficiency.md) · [`gmeow:proficiencyAgent`](../reference/properties/gmeow-proficiencyAgent.md) · [`gmeow:proficiencyLanguage`](../reference/properties/gmeow-proficiencyLanguage.md) · [`gmeow:proficiencyModality`](../reference/properties/gmeow-proficiencyModality.md) · [`gmeow:proficiencyLevel`](../reference/properties/gmeow-proficiencyLevel.md) · [`gmeow:proficiencyScale`](../reference/properties/gmeow-proficiencyScale.md) · [`gmeow:proficiencyInterval`](../reference/properties/gmeow-proficiencyInterval.md) · [`gmeow:levelScale`](../reference/properties/gmeow-levelScale.md)

The reified, per-skill, leveled proficiency relator (the [`NameUsage`](../reference/classes/gmeow-NameUsage.md) idiom): mint
...
measuring scale; [`proficiencyInterval`](../reference/properties/gmeow-proficiencyInterval.md) carries its period; [`levelScale`](../reference/properties/gmeow-levelScale.md) ties a
level individual to its framework.

### [`gmeow:knowsLanguage`](../reference/properties/gmeow-knowsLanguage.md) · [`gmeow:nativeLanguage`](../reference/properties/gmeow-nativeLanguage.md)

The flat base relations: [`knowsLanguage`](../reference/properties/gmeow-knowsLanguage.md) states that an agent knows a language;
[`nativeLanguage`](../reference/properties/gmeow-nativeLanguage.md) is its mother-tongue specialisation. Both are non-functional; the
leveled per-skill detail rides [`LanguageProficiency`](../reference/classes/gmeow-LanguageProficiency.md).

### [`gmeow:LanguageState`](../reference/classes/gmeow-LanguageState.md) · [`gmeow:stateLanguage`](../reference/properties/gmeow-stateLanguage.md) · [`gmeow:stateStatusValue`](../reference/properties/gmeow-stateStatusValue.md) · [`gmeow:stateAuthority`](../reference/properties/gmeow-stateAuthority.md) · [`gmeow:stateInterval`](../reference/properties/gmeow-stateInterval.md)

The standpoint-scoped, analytic/historical status relator (the [`VersionMembership`](../reference/classes/gmeow-VersionMembership.md)
pattern, also an [`Observation`](../reference/classes/gmeow-Observation.md)): it binds {language} × {status} × {authority} ×
{interval}, so competing reconstructions of a language's vitality over a period
coexist. [`stateLanguage`](../reference/properties/gmeow-stateLanguage.md) ⊑ [`observedFeature`](../reference/properties/gmeow-observedFeature.md), [`stateAuthority`](../reference/properties/gmeow-stateAuthority.md) ⊑ vantage.

### [`gmeow:LanguageChangeEvent`](../reference/classes/gmeow-LanguageChangeEvent.md) · [`gmeow:changeType`](../reference/properties/gmeow-changeType.md) · [`gmeow:LanguageChangeType`](../reference/classes/gmeow-LanguageChangeType.md) · [`gmeow:affectedLanguage`](../reference/properties/gmeow-affectedLanguage.md)

The diachronic-arc event ([`Activity`](../reference/classes/gmeow-Activity.md) subclass): [`changeType`](../reference/properties/gmeow-changeType.md) draws the open
[`LanguageChangeType`](../reference/classes/gmeow-LanguageChangeType.md) vocabulary (sound shift, semantic drift, borrowing, spelling
reform, standardization, extinction, revival, split, merger, …) and
[`affectedLanguage`](../reference/properties/gmeow-affectedLanguage.md) links the one or more languages a change touches.

### [`gmeow:LanguageCreation`](../reference/classes/gmeow-LanguageCreation.md)

The activity of creating or generating a language — a conlanger's design work or an
AI model's generation run — linked to its product via [`wasGeneratedBy`](../reference/properties/gmeow-wasGeneratedBy.md) and ascribed
to its creator (a [`SoftwareAgent`](../reference/classes/gmeow-SoftwareAgent.md) for an AI language) via [`wasAttributedTo`](../reference/properties/gmeow-wasAttributedTo.md).
