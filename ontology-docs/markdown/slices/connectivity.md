...
- **GMEOW terms:** [`gmeow:Connection`](../reference/classes/gmeow-Connection.md), [`gmeow:Place`](../reference/classes/gmeow-Place.md), [`gmeow:Route`](../reference/classes/gmeow-Route.md), [`gmeow:connectionSource`](../reference/properties/gmeow-connectionSource.md), [`gmeow:connectionTarget`](../reference/properties/gmeow-connectionTarget.md), [`gmeow:name`](../reference/properties/gmeow-name.md), [`gmeow:routeEnd`](../reference/properties/gmeow-routeEnd.md), [`gmeow:routeKind`](../reference/properties/gmeow-routeKind.md), [`gmeow:routeKindTransit`](../reference/individuals/gmeow-routeKindTransit.md), [`gmeow:routeStart`](../reference/properties/gmeow-routeStart.md)
...
A seeded [`ReferenceFrame`](../reference/classes/gmeow-ReferenceFrame.md) (connectivity spine): virtual realm, one scalar axis, crisp determinacy,
