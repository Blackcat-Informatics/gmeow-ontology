...
- **GMEOW terms:** [`gmeow:EtymologicalDerivation`](../reference/classes/gmeow-EtymologicalDerivation.md), [`gmeow:Language`](../reference/classes/gmeow-Language.md), [`gmeow:LexicalForm`](../reference/classes/gmeow-LexicalForm.md), [`gmeow:LexicalItem`](../reference/classes/gmeow-LexicalItem.md), [`gmeow:bcp47Tag`](../reference/properties/gmeow-bcp47Tag.md), [`gmeow:derivationBorrowing`](../reference/individuals/gmeow-derivationBorrowing.md), [`gmeow:derivationKind`](../reference/properties/gmeow-derivationKind.md), [`gmeow:derivationSource`](../reference/properties/gmeow-derivationSource.md), [`gmeow:derivationTarget`](../reference/properties/gmeow-derivationTarget.md), [`gmeow:formOf`](../reference/properties/gmeow-formOf.md)
...
# --- The Greek source lexeme it derives from.
ex:greek a gmeow:Language ; rdfs:label "Ancient Greek"@en ; gmeow:bcp47Tag "grc" .
...
### [`gmeow:LexicalItem`](../reference/classes/gmeow-LexicalItem.md) · [`gmeow:lexicalItemLanguage`](../reference/properties/gmeow-lexicalItemLanguage.md) · [`gmeow:hasLexicalForm`](../reference/properties/gmeow-hasLexicalForm.md)

A [`LexicalItem`](../reference/classes/gmeow-LexicalItem.md) is the abstract lexical or constructional object — word, morpheme,
phrase, idiom, symbol, sign, or construction — carrying no surface form itself.
[`lexicalItemLanguage`](../reference/properties/gmeow-lexicalItemLanguage.md) functionally fixes its language (mint a distinct item per
language); [`hasLexicalForm`](../reference/properties/gmeow-hasLexicalForm.md) links its concrete forms.

### [`gmeow:LexicalForm`](../reference/classes/gmeow-LexicalForm.md) · [`gmeow:formOf`](../reference/properties/gmeow-formOf.md) · [`gmeow:formRepresentation`](../reference/properties/gmeow-formRepresentation.md) · [`gmeow:formType`](../reference/properties/gmeow-formType.md) · [`gmeow:LexicalFormType`](../reference/classes/gmeow-LexicalFormType.md) · [`gmeow:formTransliterationScheme`](../reference/properties/gmeow-formTransliterationScheme.md)

A [`LexicalForm`](../reference/classes/gmeow-LexicalForm.md) is a concrete manifestation of an item — [`formOf`](../reference/properties/gmeow-formOf.md) is the inverse of
[`hasLexicalForm`](../reference/properties/gmeow-hasLexicalForm.md). [`formRepresentation`](../reference/properties/gmeow-formRepresentation.md) is the functional surface string;
[`formType`](../reference/properties/gmeow-formType.md) draws the open [`LexicalFormType`](../reference/classes/gmeow-LexicalFormType.md) vocabulary (written, spoken, signed,
rendered, reconstructed, normalized, transliterated, translated); a transliterated
form names its [`formTransliterationScheme`](../reference/properties/gmeow-formTransliterationScheme.md). Many forms coexist, none privileged.

### [`gmeow:UsageAttestation`](../reference/classes/gmeow-UsageAttestation.md) · [`gmeow:attestedForm`](../reference/properties/gmeow-attestedForm.md) · [`gmeow:attestedInLanguage`](../reference/properties/gmeow-attestedInLanguage.md) · [`gmeow:attestedInSource`](../reference/properties/gmeow-attestedInSource.md) · [`gmeow:attestedInContext`](../reference/properties/gmeow-attestedInContext.md) · [`gmeow:attestedOnCarrier`](../reference/properties/gmeow-attestedOnCarrier.md) · [`gmeow:attestationInterval`](../reference/properties/gmeow-attestationInterval.md)

An [`Observation`](../reference/classes/gmeow-Observation.md) + Relator recording evidence — a form was seen in a source,
corpus, inscription, platform, or community — not truth ([Principle 12](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-12)). The
`attested*` properties bind the form, language, source, context, and physical
carrier; [`attestationInterval`](../reference/properties/gmeow-attestationInterval.md) carries the period. [`attestedForm`](../reference/properties/gmeow-attestedForm.md) ⊑ [`observedFeature`](../reference/properties/gmeow-observedFeature.md),
so it inherits the universal claim stack (vantage, confidence, validity).

### [`gmeow:EtymologicalDerivation`](../reference/classes/gmeow-EtymologicalDerivation.md) · [`gmeow:derivationSource`](../reference/properties/gmeow-derivationSource.md) · [`gmeow:derivationTarget`](../reference/properties/gmeow-derivationTarget.md) · [`gmeow:derivationKind`](../reference/properties/gmeow-derivationKind.md) · [`gmeow:DerivationKind`](../reference/classes/gmeow-DerivationKind.md) · [`gmeow:derivationEvidence`](../reference/properties/gmeow-derivationEvidence.md)

An [`Observation`](../reference/classes/gmeow-Observation.md) + Relator linking a source lexical item/form to a target, making
etymology a graph of provenance-rich, standpointed claims rather than a flat origin
string. [`derivationKind`](../reference/properties/gmeow-derivationKind.md) draws the open [`DerivationKind`](../reference/classes/gmeow-DerivationKind.md) vocabulary (borrowing,
...
reconstruction, unknown origin); [`derivationEvidence`](../reference/properties/gmeow-derivationEvidence.md) cites supporting attestations
