...
- Describing and dogfooding GTS transport artifacts: packages, segments, profiles, chain heads, opaque frames, codecs, and compaction lineage (GTS transport design, [`docs/GTS-SPEC.md`](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/docs/GTS-SPEC.md)).
...
| [`gmeow:GTSCompaction`](../reference/classes/gmeow-GTSCompaction.md) | GTS Compaction | An activity that rewrites a GTS document's frame layout — e.g. into delivery order for streaming (spec §3.2) or into a snapshot. Compaction re-authors only the... |
...
GMEOW describing its own transport (GTS transport design, [`docs/GTS-SPEC.md`](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/docs/GTS-SPEC.md)): a GTS file as a
...
### [`gmeow:GTSDocument`](../reference/classes/gmeow-GTSDocument.md) · [`gmeow:GTSSegment`](../reference/classes/gmeow-GTSSegment.md) · [`gmeow:gtsSegment`](../reference/properties/gmeow-gtsSegment.md) · [`gmeow:gtsSegmentOf`](../reference/properties/gmeow-gtsSegmentOf.md) · [`gmeow:gtsSegmentIndex`](../reference/properties/gmeow-gtsSegmentIndex.md)

A GTS file as a first-class entity and the segments that compose it. [`gtsSegment`](../reference/properties/gmeow-gtsSegment.md)
(with its inverse [`gtsSegmentOf`](../reference/properties/gmeow-gtsSegmentOf.md)) relates a document to its segments, and
[`gtsSegmentIndex`](../reference/properties/gmeow-gtsSegmentIndex.md) fixes their order — the document's composite identity is the
ordered list of its segments' chain heads.

### [`gmeow:gtsHeadId`](../reference/properties/gmeow-gtsHeadId.md) · [`gmeow:GTSProfile`](../reference/classes/gmeow-GTSProfile.md) · [`gmeow:gtsProfile`](../reference/properties/gmeow-gtsProfile.md)

The chain head ([`gtsHeadId`](../reference/properties/gmeow-gtsHeadId.md), ⊑ [`gmeow:versionFingerprint`](../reference/properties/gmeow-versionFingerprint.md)) that transitively
commits to a segment's history; and the transport profile ([`GTSProfile`](../reference/classes/gmeow-GTSProfile.md)) a
document declares, attached by [`gtsProfile`](../reference/properties/gmeow-gtsProfile.md) — evidence-profile documents, for
instance, warn on compaction.

### [`gmeow:GTSCompaction`](../reference/classes/gmeow-GTSCompaction.md)
...
cited through the compaction's [`wasDerivedFrom`](../reference/properties/gmeow-wasDerivedFrom.md) lineage.

### [`gmeow:TransformCodec`](../reference/classes/gmeow-TransformCodec.md) · [`gmeow:usesTransformCodec`](../reference/properties/gmeow-usesTransformCodec.md) · [`gmeow:CodecClass`](../reference/classes/gmeow-CodecClass.md) · [`gmeow:codecClass`](../reference/properties/gmeow-codecClass.md)

A transform codec applied to bytes in transit, attached by [`usesTransformCodec`](../reference/properties/gmeow-usesTransformCodec.md);
[`CodecClass`](../reference/classes/gmeow-CodecClass.md) is the open value vocabulary of codec families a codec belongs to
via [`codecClass`](../reference/properties/gmeow-codecClass.md).

### [`gmeow:OpaqueFrame`](../reference/classes/gmeow-OpaqueFrame.md) · [`gmeow:opaqueFrameIn`](../reference/properties/gmeow-opaqueFrameIn.md) · [`gmeow:sealedRecipient`](../reference/properties/gmeow-sealedRecipient.md) · [`gmeow:OpacityReason`](../reference/classes/gmeow-OpacityReason.md) · [`gmeow:opacityReason`](../reference/properties/gmeow-opacityReason.md)

A frame whose payload is sealed: [`opaqueFrameIn`](../reference/properties/gmeow-opaqueFrameIn.md) situates it within a document,
[`sealedRecipient`](../reference/properties/gmeow-sealedRecipient.md) names the vantages to which it is transparent, and
[`opacityReason`](../reference/properties/gmeow-opacityReason.md) (an [`OpacityReason`](../reference/classes/gmeow-OpacityReason.md) value) records why it is opaque — opacity
being vantage-relative epistemic state ([Principle 9](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-9)).
