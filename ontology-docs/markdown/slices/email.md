...
- **GMEOW terms:** [`gmeow:EmailAddress`](../reference/classes/gmeow-EmailAddress.md), [`gmeow:EmailMessage`](../reference/classes/gmeow-EmailMessage.md), [`gmeow:addressValue`](../reference/properties/gmeow-addressValue.md), [`gmeow:cc`](../reference/properties/gmeow-cc.md), [`gmeow:from`](../reference/properties/gmeow-from.md), [`gmeow:inReplyTo`](../reference/properties/gmeow-inReplyTo.md), [`gmeow:subject`](../reference/properties/gmeow-subject.md), [`gmeow:to`](../reference/properties/gmeow-to.md)
...
| JMAP BodyPart [`partId`](../reference/properties/gmeow-partId.md) | [`gmeow:partId`](../reference/properties/gmeow-partId.md) | [`rdfs:Literal`](http://www.w3.org/2000/01/rdf-schema#Literal) | Scoped to the message; not globally unique (already in the design) |
...
own [`skos:definition`](http://www.w3.org/2004/02/skos/core#definition) in `module.ttl`; the groupings below bind the prose above to
those declarations.

### [`gmeow:Message`](../reference/classes/gmeow-Message.md) · [`gmeow:EmailMessage`](../reference/classes/gmeow-EmailMessage.md) · [`gmeow:Thread`](../reference/classes/gmeow-Thread.md)

[`Message`](../reference/classes/gmeow-Message.md) is the parent [`InformationObject`](../reference/classes/gmeow-InformationObject.md) for any communication sent from one agent
to others; [`EmailMessage`](../reference/classes/gmeow-EmailMessage.md) is the RFC 5322 specialization carrying headers,
participants, body parts and mailbox residence. A [`Thread`](../reference/classes/gmeow-Thread.md) is a conversation — a set
of messages related by reply/reference chains.

### [`gmeow:partOfThread`](../reference/properties/gmeow-partOfThread.md) · [`gmeow:inReplyTo`](../reference/properties/gmeow-inReplyTo.md) · [`gmeow:rfcMessageId`](../reference/properties/gmeow-rfcMessageId.md)

The threading spine: [`partOfThread`](../reference/properties/gmeow-partOfThread.md) (a [`partOf`](../reference/properties/gmeow-partOf.md) specialization) places a message in
its conversation; [`inReplyTo`](../reference/properties/gmeow-inReplyTo.md) links a message to the one it directly answers (RFC
5322 In-Reply-To); [`rfcMessageId`](../reference/properties/gmeow-rfcMessageId.md) is the functional RFC 5322 Message-ID, the
message's canonical identity key.

### [`gmeow:from`](../reference/properties/gmeow-from.md) · [`gmeow:sender`](../reference/properties/gmeow-sender.md) · [`gmeow:replyTo`](../reference/properties/gmeow-replyTo.md) · [`gmeow:to`](../reference/properties/gmeow-to.md) · [`gmeow:cc`](../reference/properties/gmeow-cc.md) · [`gmeow:bcc`](../reference/properties/gmeow-bcc.md)

The flat 80%-case participant shortcuts, each [`EmailMessage`](../reference/classes/gmeow-EmailMessage.md) → [`EmailAddress`](../reference/classes/gmeow-EmailAddress.md): author
(From), transmitting agent (Sender), reply target (Reply-To), and the primary,
carbon-copy and blind-carbon-copy recipients. Promote to [`MessageParticipant`](../reference/classes/gmeow-MessageParticipant.md) when
raw syntax, ordering, or provenance must be preserved.

### [`gmeow:MessageParticipant`](../reference/classes/gmeow-MessageParticipant.md) · [`gmeow:MessageParticipantRole`](../reference/classes/gmeow-MessageParticipantRole.md)
...
occurrence and never a global claim about the address. [`MessageParticipantRole`](../reference/classes/gmeow-MessageParticipantRole.md) is
its open value vocabulary of header/envelope roles.

### [`gmeow:hasMessageParticipant`](../reference/properties/gmeow-hasMessageParticipant.md) · [`gmeow:participantMessage`](../reference/properties/gmeow-participantMessage.md) · [`gmeow:participantAddress`](../reference/properties/gmeow-participantAddress.md) · [`gmeow:participantRole`](../reference/properties/gmeow-participantRole.md) · [`gmeow:participantHeader`](../reference/properties/gmeow-participantHeader.md) · [`gmeow:participantOrdinal`](../reference/properties/gmeow-participantOrdinal.md) · [`gmeow:participantGroup`](../reference/properties/gmeow-participantGroup.md) · [`gmeow:rawAddressValue`](../reference/properties/gmeow-rawAddressValue.md) · [`gmeow:displayName`](../reference/properties/gmeow-displayName.md)

The relator's posts: the message it belongs to ([`participantMessage`](../reference/properties/gmeow-participantMessage.md), with inverse
[`hasMessageParticipant`](../reference/properties/gmeow-hasMessageParticipant.md)), the normalized address ([`participantAddress`](../reference/properties/gmeow-participantAddress.md)), the
header/envelope role ([`participantRole`](../reference/properties/gmeow-participantRole.md)), the source header ([`participantHeader`](../reference/properties/gmeow-participantHeader.md)),
the zero-based position ([`participantOrdinal`](../reference/properties/gmeow-participantOrdinal.md)), the RFC 5322 group name
([`participantGroup`](../reference/properties/gmeow-participantGroup.md)), the raw unparsed segment ([`rawAddressValue`](../reference/properties/gmeow-rawAddressValue.md)), and the display
name as rendered in this occurrence ([`displayName`](../reference/properties/gmeow-displayName.md)).

### [`gmeow:messageRoleFrom`](../reference/individuals/gmeow-messageRoleFrom.md) · [`gmeow:messageRoleSender`](../reference/individuals/gmeow-messageRoleSender.md) · [`gmeow:messageRoleReplyTo`](../reference/individuals/gmeow-messageRoleReplyTo.md) · [`gmeow:messageRoleTo`](../reference/individuals/gmeow-messageRoleTo.md) · [`gmeow:messageRoleCc`](../reference/individuals/gmeow-messageRoleCc.md) · [`gmeow:messageRoleBcc`](../reference/individuals/gmeow-messageRoleBcc.md)

The header-address role values mirroring the flat shortcuts — the role a
[`MessageParticipant`](../reference/classes/gmeow-MessageParticipant.md) plays as parsed from the From, Sender, Reply-To, To, Cc, or Bcc
header field.

### [`gmeow:messageRoleReturnPath`](../reference/individuals/gmeow-messageRoleReturnPath.md) · [`gmeow:messageRoleErrorsTo`](../reference/individuals/gmeow-messageRoleErrorsTo.md) · [`gmeow:messageRoleEnvelopeFrom`](../reference/individuals/gmeow-messageRoleEnvelopeFrom.md) · [`gmeow:messageRoleEnvelopeTo`](../reference/individuals/gmeow-messageRoleEnvelopeTo.md) · [`gmeow:messageRoleDeliveredTo`](../reference/individuals/gmeow-messageRoleDeliveredTo.md) · [`gmeow:messageRoleOriginalTo`](../reference/individuals/gmeow-messageRoleOriginalTo.md)

The envelope and bounce-routing role values, distinguishing the SMTP envelope
([`messageRoleEnvelopeFrom`](../reference/individuals/gmeow-messageRoleEnvelopeFrom.md)/[`messageRoleEnvelopeTo`](../reference/individuals/gmeow-messageRoleEnvelopeTo.md)) and delivery trace
([`messageRoleDeliveredTo`](../reference/individuals/gmeow-messageRoleDeliveredTo.md)/[`messageRoleOriginalTo`](../reference/individuals/gmeow-messageRoleOriginalTo.md)) from the header addresses, plus
return-path and errors-to for bounce handling.

### [`gmeow:messageRoleResentFrom`](../reference/individuals/gmeow-messageRoleResentFrom.md) · [`gmeow:messageRoleResentTo`](../reference/individuals/gmeow-messageRoleResentTo.md) · [`gmeow:messageRoleResentCc`](../reference/individuals/gmeow-messageRoleResentCc.md)

The resent-trace role values: a message resent by an intermediary produces a
`Resent-*` block whose address roles are modelled through [`MessageParticipant`](../reference/classes/gmeow-MessageParticipant.md) with
these values.

### [`gmeow:hasHeader`](../reference/properties/gmeow-hasHeader.md) · [`gmeow:MessageHeader`](../reference/classes/gmeow-MessageHeader.md) · [`gmeow:headerName`](../reference/properties/gmeow-headerName.md) · [`gmeow:headerValue`](../reference/properties/gmeow-headerValue.md)

Raw header preservation: [`hasHeader`](../reference/properties/gmeow-hasHeader.md) relates a message to each [`MessageHeader`](../reference/classes/gmeow-MessageHeader.md), a
single RFC 5322 field carrying its functional [`headerName`](../reference/properties/gmeow-headerName.md) and [`headerValue`](../reference/properties/gmeow-headerValue.md) — the
canonical source over which the convenience datatype properties project ([Principle 4](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-4)).

### [`gmeow:sentAt`](../reference/properties/gmeow-sentAt.md) · [`gmeow:receivedAt`](../reference/properties/gmeow-receivedAt.md) · [`gmeow:subject`](../reference/properties/gmeow-subject.md) · [`gmeow:preview`](../reference/properties/gmeow-preview.md) · [`gmeow:sizeEstimate`](../reference/properties/gmeow-sizeEstimate.md)

Core message metadata: the claimed send time (RFC 5322 Date), the provider receive
time (JMAP [`receivedAt`](../reference/properties/gmeow-receivedAt.md) / Gmail internalDate — observationally distinct), the Subject
literal, a short plain-text body preview, and the estimated size in octets.

### [`gmeow:threadSubject`](../reference/properties/gmeow-threadSubject.md) · [`gmeow:subjectPrefix`](../reference/properties/gmeow-subjectPrefix.md)

Thread-subject normalization: [`threadSubject`](../reference/properties/gmeow-threadSubject.md) is the base subject of a conversation
with reply/forward prefixes stripped, attached to the [`Thread`](../reference/classes/gmeow-Thread.md) for display and
grouping; [`subjectPrefix`](../reference/properties/gmeow-subjectPrefix.md) records the prefix(es) removed from an individual message,
non-functional because prefixes nest.

### [`gmeow:MessageKeyword`](../reference/classes/gmeow-MessageKeyword.md) · [`gmeow:hasKeyword`](../reference/properties/gmeow-hasKeyword.md) · [`gmeow:keywordSeen`](../reference/individuals/gmeow-keywordSeen.md) · [`gmeow:keywordFlagged`](../reference/individuals/gmeow-keywordFlagged.md) · [`gmeow:keywordAnswered`](../reference/individuals/gmeow-keywordAnswered.md) · [`gmeow:keywordDraft`](../reference/individuals/gmeow-keywordDraft.md) · [`gmeow:keywordForwarded`](../reference/individuals/gmeow-keywordForwarded.md) · [`gmeow:keywordJunk`](../reference/individuals/gmeow-keywordJunk.md)

The IMAP-flag / JMAP-keyword facet: [`hasKeyword`](../reference/properties/gmeow-hasKeyword.md) relates a message to a
[`MessageKeyword`](../reference/classes/gmeow-MessageKeyword.md) value drawn from the seeded set — seen, flagged, answered, draft,
forwarded, junk — an open value vocabulary rather than subclasses.

### [`gmeow:Mailbox`](../reference/classes/gmeow-Mailbox.md) · [`gmeow:residesIn`](../reference/properties/gmeow-residesIn.md) · [`gmeow:mailboxOfAccount`](../reference/properties/gmeow-mailboxOfAccount.md) · [`gmeow:mailboxRole`](../reference/properties/gmeow-mailboxRole.md) · [`gmeow:mailboxName`](../reference/properties/gmeow-mailboxName.md)

A [`Mailbox`](../reference/classes/gmeow-Mailbox.md) is a named container of messages within an account — folder, JMAP
mailbox, or Gmail label. [`residesIn`](../reference/properties/gmeow-residesIn.md) places a message in it (time-scoped via
[`MailboxResidence`](../reference/classes/gmeow-MailboxResidence.md)); [`mailboxOfAccount`](../reference/properties/gmeow-mailboxOfAccount.md) links the mailbox to its [`OnlineAccount`](../reference/classes/gmeow-OnlineAccount.md);
[`mailboxRole`](../reference/properties/gmeow-mailboxRole.md) carries the JMAP special-use role and [`mailboxName`](../reference/properties/gmeow-mailboxName.md) the display name.

### [`gmeow:MailboxResidence`](../reference/classes/gmeow-MailboxResidence.md) · [`gmeow:residentMessage`](../reference/properties/gmeow-residentMessage.md) · [`gmeow:residenceMailbox`](../reference/properties/gmeow-residenceMailbox.md)
...
[`residentMessage`](../reference/properties/gmeow-residentMessage.md) and [`residenceMailbox`](../reference/properties/gmeow-residenceMailbox.md) are its functional posts.

### [`gmeow:parentMailbox`](../reference/properties/gmeow-parentMailbox.md) · [`gmeow:childMailbox`](../reference/properties/gmeow-childMailbox.md)

The canonical folder-hierarchy spine, specializing [`partOf`](../reference/properties/gmeow-partOf.md)/[`hasPart`](../reference/properties/gmeow-hasPart.md):
[`parentMailbox`](../reference/properties/gmeow-parentMailbox.md) names the direct parent and its inverse [`childMailbox`](../reference/properties/gmeow-childMailbox.md) the children
of a mailbox in a folder tree.

### [`gmeow:mailboxSortOrder`](../reference/properties/gmeow-mailboxSortOrder.md) · [`gmeow:mailboxPath`](../reference/properties/gmeow-mailboxPath.md) · [`gmeow:mailboxTotalMessages`](../reference/properties/gmeow-mailboxTotalMessages.md) · [`gmeow:mailboxUnreadMessages`](../reference/properties/gmeow-mailboxUnreadMessages.md)

Provider-derived, projection-layer mailbox state ([Principle 12](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-12)), not asserted as
...
### [`gmeow:BodyPart`](../reference/classes/gmeow-BodyPart.md) · [`gmeow:hasBodyPart`](../reference/properties/gmeow-hasBodyPart.md) · [`gmeow:Attachment`](../reference/classes/gmeow-Attachment.md) · [`gmeow:hasAttachment`](../reference/properties/gmeow-hasAttachment.md) · [`gmeow:filename`](../reference/properties/gmeow-filename.md)

[`BodyPart`](../reference/classes/gmeow-BodyPart.md) is a MIME part with a media type and content, reached by [`hasBodyPart`](../reference/properties/gmeow-hasBodyPart.md) (a
[`hasPart`](../reference/properties/gmeow-hasPart.md) specialization). [`Attachment`](../reference/classes/gmeow-Attachment.md) is a non-inline body part presented as a
file (also possibly a [`Document`](../reference/classes/gmeow-Document.md) or [`MediaObject`](../reference/classes/gmeow-MediaObject.md) — not disjoint), reached by
[`hasAttachment`](../reference/properties/gmeow-hasAttachment.md) and carrying a `filename`.

### [`gmeow:MultipartBodyPart`](../reference/classes/gmeow-MultipartBodyPart.md) · [`gmeow:hasMultipartType`](../reference/properties/gmeow-hasMultipartType.md) · [`gmeow:MultipartType`](../reference/classes/gmeow-MultipartType.md)

A [`MultipartBodyPart`](../reference/classes/gmeow-MultipartBodyPart.md) is the structural container node that holds other parts via the
universal [`hasPart`](../reference/properties/gmeow-hasPart.md)/[`partOf`](../reference/properties/gmeow-partOf.md) spine; [`hasMultipartType`](../reference/properties/gmeow-hasMultipartType.md) records its subtype as a
[`MultipartType`](../reference/classes/gmeow-MultipartType.md) value.

### [`gmeow:multipartTypeAlternative`](../reference/individuals/gmeow-multipartTypeAlternative.md) · [`gmeow:multipartTypeMixed`](../reference/individuals/gmeow-multipartTypeMixed.md) · [`gmeow:multipartTypeRelated`](../reference/individuals/gmeow-multipartTypeRelated.md) · [`gmeow:multipartTypeSigned`](../reference/individuals/gmeow-multipartTypeSigned.md) · [`gmeow:multipartTypeEncrypted`](../reference/individuals/gmeow-multipartTypeEncrypted.md) · [`gmeow:multipartTypeReport`](../reference/individuals/gmeow-multipartTypeReport.md) · [`gmeow:multipartTypeDigest`](../reference/individuals/gmeow-multipartTypeDigest.md) · [`gmeow:multipartTypeParallel`](../reference/individuals/gmeow-multipartTypeParallel.md)
...
### [`gmeow:InlinePart`](../reference/classes/gmeow-InlinePart.md) · [`gmeow:hasInlinePart`](../reference/properties/gmeow-hasInlinePart.md)

An [`InlinePart`](../reference/classes/gmeow-InlinePart.md) is a body part displayed inline within the message body (an embedded
image, a rendered text/html part), reached by [`hasInlinePart`](../reference/properties/gmeow-hasInlinePart.md) (a [`hasBodyPart`](../reference/properties/gmeow-hasBodyPart.md)
specialization). Not declared disjoint from [`Attachment`](../reference/classes/gmeow-Attachment.md) — disposition is an
attributed fact, not a rigid boundary ([Principle 9](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-9)).

### [`gmeow:ContentDisposition`](../reference/classes/gmeow-ContentDisposition.md) · [`gmeow:hasContentDisposition`](../reference/properties/gmeow-hasContentDisposition.md) · [`gmeow:contentDispositionInline`](../reference/individuals/gmeow-contentDispositionInline.md) · [`gmeow:contentDispositionAttachment`](../reference/individuals/gmeow-contentDispositionAttachment.md)

The presentation-disposition facet (RFC 2183): [`hasContentDisposition`](../reference/properties/gmeow-hasContentDisposition.md) relates a body
part to its [`ContentDisposition`](../reference/classes/gmeow-ContentDisposition.md) value — inline (rendered in the body) or attachment
(presented as a separate file).

### [`gmeow:ContentTransferEncoding`](../reference/classes/gmeow-ContentTransferEncoding.md) · [`gmeow:hasContentTransferEncoding`](../reference/properties/gmeow-hasContentTransferEncoding.md) · [`gmeow:transferEncodingBase64`](../reference/individuals/gmeow-transferEncodingBase64.md) · [`gmeow:transferEncodingQuotedPrintable`](../reference/individuals/gmeow-transferEncodingQuotedPrintable.md) · [`gmeow:transferEncoding7bit`](../reference/individuals/gmeow-transferEncoding7bit.md) · [`gmeow:transferEncoding8bit`](../reference/individuals/gmeow-transferEncoding8bit.md) · [`gmeow:transferEncodingBinary`](../reference/individuals/gmeow-transferEncodingBinary.md)

The MIME content-transfer-encoding facet (RFC 2045): [`hasContentTransferEncoding`](../reference/properties/gmeow-hasContentTransferEncoding.md)
relates a body part to its encoding value — base64, quoted-printable, 7bit, 8bit, or
binary.

### [`gmeow:partId`](../reference/properties/gmeow-partId.md) · [`gmeow:contentId`](../reference/properties/gmeow-contentId.md) · [`gmeow:charset`](../reference/properties/gmeow-charset.md)

Per-part MIME metadata: the structural [`partId`](../reference/properties/gmeow-partId.md) (scoped to the message, e.g. `1.2`),
the [`contentId`](../reference/properties/gmeow-contentId.md) used for `cid:` references, and the `charset` of the part's content.

### [`gmeow:BodyValue`](../reference/classes/gmeow-BodyValue.md) · [`gmeow:blobId`](../reference/properties/gmeow-blobId.md) · [`gmeow:bodyStructure`](../reference/properties/gmeow-bodyStructure.md)

JMAP structural identifiers and decoded content (RFC 8620/8621): [`BodyValue`](../reference/classes/gmeow-BodyValue.md) is a
decoded body-content object derived from a [`BodyPart`](../reference/classes/gmeow-BodyPart.md) by [`wasDerivedFrom`](../reference/properties/gmeow-wasDerivedFrom.md); [`blobId`](../reference/properties/gmeow-blobId.md)
is an opaque provider-scoped byte identifier; [`bodyStructure`](../reference/properties/gmeow-bodyStructure.md) preserves the
serialized JMAP EmailBodyStructure for round-tripping — neither competes with the
canonical [`hasBodyPart`](../reference/properties/gmeow-hasBodyPart.md)/[`hasPart`](../reference/properties/gmeow-hasPart.md) MIME tree.

### [`gmeow:MailingList`](../reference/classes/gmeow-MailingList.md) · [`gmeow:hasMailingList`](../reference/properties/gmeow-hasMailingList.md) · [`gmeow:listId`](../reference/properties/gmeow-listId.md)

A [`MailingList`](../reference/classes/gmeow-MailingList.md) is a first-class distribution list identified by a List-Id;
[`hasMailingList`](../reference/properties/gmeow-hasMailingList.md) links a message to the list it travelled through (non-functional —
cross-posting), and [`listId`](../reference/properties/gmeow-listId.md) carries the RFC 2919 identifier literal on the message.

### [`gmeow:listSubscribe`](../reference/properties/gmeow-listSubscribe.md) · [`gmeow:listUnsubscribe`](../reference/properties/gmeow-listUnsubscribe.md) · [`gmeow:listPost`](../reference/properties/gmeow-listPost.md) · [`gmeow:listHelp`](../reference/properties/gmeow-listHelp.md) · [`gmeow:listArchive`](../reference/properties/gmeow-listArchive.md) · [`gmeow:listOwner`](../reference/properties/gmeow-listOwner.md)

The RFC 2369 command headers: subscription, unsubscription, posting, help, archive,
and owner targets. All non-functional; [`listPost`](../reference/properties/gmeow-listPost.md) is a datatype property because RFC
2369 permits the `NO` sentinel for announcement-only lists.

### [`gmeow:priority`](../reference/properties/gmeow-priority.md) · [`gmeow:importance`](../reference/properties/gmeow-importance.md) · [`gmeow:userAgent`](../reference/properties/gmeow-userAgent.md) · [`gmeow:autoSubmitted`](../reference/properties/gmeow-autoSubmitted.md) · [`gmeow:precedence`](../reference/properties/gmeow-precedence.md)

Raw-header-backed behavioral datatype facets, convenience projections over
[`MessageHeader`](../reference/classes/gmeow-MessageHeader.md) ([Principle 4](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-4)): the X-Priority, Importance, User-Agent/X-Mailer,
Auto-Submitted (RFC 3834), and Precedence header values, stored as literals because
their vocabularies are client-extensible.

### [`gmeow:sentBySoftware`](../reference/properties/gmeow-sentBySoftware.md) · [`gmeow:readReceiptRequested`](../reference/properties/gmeow-readReceiptRequested.md) · [`gmeow:dispositionNotificationTo`](../reference/properties/gmeow-dispositionNotificationTo.md)

[`sentBySoftware`](../reference/properties/gmeow-sentBySoftware.md) is the parsed [`SoftwareAgent`](../reference/classes/gmeow-SoftwareAgent.md) identified from User-Agent/X-Mailer
(the raw value staying on [`userAgent`](../reference/properties/gmeow-userAgent.md)). [`dispositionNotificationTo`](../reference/properties/gmeow-dispositionNotificationTo.md) is the canonical
read-receipt address (RFC 3798); [`readReceiptRequested`](../reference/properties/gmeow-readReceiptRequested.md) is the non-functional boolean
projection of that header's presence.

### [`gmeow:resentDate`](../reference/properties/gmeow-resentDate.md) · [`gmeow:resentMessageId`](../reference/properties/gmeow-resentMessageId.md)
...
headers remain on [`MessageHeader`](../reference/classes/gmeow-MessageHeader.md) ([Principle 4](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-4)).

### [`gmeow:MessageKind`](../reference/classes/gmeow-MessageKind.md) · [`gmeow:hasMessageKind`](../reference/properties/gmeow-hasMessageKind.md)

The behavioral / report kind of a message as an open value vocabulary —
overlapping categories (a bounce is also auto-generated), so [`hasMessageKind`](../reference/properties/gmeow-hasMessageKind.md) is
non-functional and no single category is forced to win ([Principle 9](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-9)).

### [`gmeow:messageKindDeliveryStatusNotification`](../reference/individuals/gmeow-messageKindDeliveryStatusNotification.md) · [`gmeow:messageKindBounce`](../reference/individuals/gmeow-messageKindBounce.md) · [`gmeow:messageKindFeedbackReport`](../reference/individuals/gmeow-messageKindFeedbackReport.md) · [`gmeow:messageKindReadReceipt`](../reference/individuals/gmeow-messageKindReadReceipt.md) · [`gmeow:messageKindAutoGenerated`](../reference/individuals/gmeow-messageKindAutoGenerated.md)
...
### [`gmeow:describesEvent`](../reference/properties/gmeow-describesEvent.md) · [`gmeow:eventDescribedBy`](../reference/properties/gmeow-eventDescribedBy.md) · [`gmeow:calendarAttachment`](../reference/properties/gmeow-calendarAttachment.md)

The email→event seam: [`describesEvent`](../reference/properties/gmeow-describesEvent.md) links a message to an [`Event`](../reference/classes/gmeow-Event.md) parsed from a
calendar attachment (with inverse [`eventDescribedBy`](../reference/properties/gmeow-eventDescribedBy.md)); [`calendarAttachment`](../reference/properties/gmeow-calendarAttachment.md) (a
[`hasAttachment`](../reference/properties/gmeow-hasAttachment.md) specialization) keeps the iCalendar-carrying attachment first-class.
The event spine is reused, never duplicated.

### [`gmeow:calendarUid`](../reference/properties/gmeow-calendarUid.md) · [`gmeow:CalendarMethod`](../reference/classes/gmeow-CalendarMethod.md) · [`gmeow:hasCalendarMethod`](../reference/properties/gmeow-hasCalendarMethod.md) · [`gmeow:messageKindCalendarInvitation`](../reference/individuals/gmeow-messageKindCalendarInvitation.md)

[`calendarUid`](../reference/properties/gmeow-calendarUid.md) records the iCalendar UID of the described event (non-functional);
[`hasCalendarMethod`](../reference/properties/gmeow-hasCalendarMethod.md) relates a message to its [`CalendarMethod`](../reference/classes/gmeow-CalendarMethod.md) value;
[`messageKindCalendarInvitation`](../reference/individuals/gmeow-messageKindCalendarInvitation.md) flags invitation-carrying messages as a [`MessageKind`](../reference/classes/gmeow-MessageKind.md).

### [`gmeow:calendarMethodRequest`](../reference/individuals/gmeow-calendarMethodRequest.md) · [`gmeow:calendarMethodReply`](../reference/individuals/gmeow-calendarMethodReply.md) · [`gmeow:calendarMethodCancel`](../reference/individuals/gmeow-calendarMethodCancel.md) · [`gmeow:calendarMethodPublish`](../reference/individuals/gmeow-calendarMethodPublish.md) · [`gmeow:calendarMethodCounter`](../reference/individuals/gmeow-calendarMethodCounter.md) · [`gmeow:calendarMethodDeclineCounter`](../reference/individuals/gmeow-calendarMethodDeclineCounter.md) · [`gmeow:calendarMethodAdd`](../reference/individuals/gmeow-calendarMethodAdd.md) · [`gmeow:calendarMethodRefresh`](../reference/individuals/gmeow-calendarMethodRefresh.md)

The iTIP METHOD values (RFC 5546): request, reply, cancel, publish, counter,
decline-counter, add, and refresh — the seeded [`CalendarMethod`](../reference/classes/gmeow-CalendarMethod.md) vocabulary.

### [`gmeow:EmailPatchDiff`](../reference/classes/gmeow-EmailPatchDiff.md) · [`gmeow:hasPatchDiff`](../reference/properties/gmeow-hasPatchDiff.md)

[`EmailPatchDiff`](../reference/classes/gmeow-EmailPatchDiff.md) is a [`BodyPart`](../reference/classes/gmeow-BodyPart.md) subclass carrying a patch/diff between a variant
message and its canonical counterpart, with [`mediaType`](../reference/properties/gmeow-mediaType.md), [`contentDigest`](../reference/properties/gmeow-contentDigest.md), and
[`wasDerivedFrom`](../reference/properties/gmeow-wasDerivedFrom.md) links; [`hasPatchDiff`](../reference/properties/gmeow-hasPatchDiff.md) (a [`hasBodyPart`](../reference/properties/gmeow-hasBodyPart.md) specialization) attaches it to
the variant message.

### [`gmeow:messageIdGenerated`](../reference/properties/gmeow-messageIdGenerated.md) · [`gmeow:messageIdCollision`](../reference/properties/gmeow-messageIdCollision.md) · [`gmeow:canonicalFingerprint`](../reference/properties/gmeow-canonicalFingerprint.md) · [`gmeow:bodyLineFingerprint`](../reference/properties/gmeow-bodyLineFingerprint.md) · [`gmeow:analysisScope`](../reference/properties/gmeow-analysisScope.md) · [`gmeow:analysisInputBodyLine`](../reference/properties/gmeow-analysisInputBodyLine.md)
...
### [`gmeow:DKIMSignature`](../reference/classes/gmeow-DKIMSignature.md) · [`gmeow:AuthenticationResult`](../reference/classes/gmeow-AuthenticationResult.md) · [`gmeow:hasAuthenticationResult`](../reference/properties/gmeow-hasAuthenticationResult.md)

[`DKIMSignature`](../reference/classes/gmeow-DKIMSignature.md) is a DKIM signature (RFC 6376) specializing the trust core's
[`CryptographicSignature`](../reference/classes/gmeow-CryptographicSignature.md). [`AuthenticationResult`](../reference/classes/gmeow-AuthenticationResult.md) is the outcome of an email
authentication check (RFC 8601), related to a message by [`hasAuthenticationResult`](../reference/properties/gmeow-hasAuthenticationResult.md).

### [`gmeow:authMethod`](../reference/properties/gmeow-authMethod.md) · [`gmeow:authResult`](../reference/properties/gmeow-authResult.md) · [`gmeow:authServer`](../reference/properties/gmeow-authServer.md)
...
### [`gmeow:RelayHop`](../reference/classes/gmeow-RelayHop.md) · [`gmeow:hasRelayHop`](../reference/properties/gmeow-hasRelayHop.md) · [`gmeow:hopOrdinal`](../reference/properties/gmeow-hopOrdinal.md) · [`gmeow:relayFrom`](../reference/properties/gmeow-relayFrom.md) · [`gmeow:relayBy`](../reference/properties/gmeow-relayBy.md) · [`gmeow:relayAt`](../reference/properties/gmeow-relayAt.md) · [`gmeow:relayProtocol`](../reference/properties/gmeow-relayProtocol.md)

A [`RelayHop`](../reference/classes/gmeow-RelayHop.md) is one hop in a message's delivery path recorded by a Received header,
attached by [`hasRelayHop`](../reference/properties/gmeow-hasRelayHop.md). Its fields: the ordinal position ([`hopOrdinal`](../reference/properties/gmeow-hopOrdinal.md), 1 nearest
the origin), the host received from ([`relayFrom`](../reference/properties/gmeow-relayFrom.md)), the relaying server ([`relayBy`](../reference/properties/gmeow-relayBy.md)),
the server timestamp ([`relayAt`](../reference/properties/gmeow-relayAt.md)), and the protocol ([`relayProtocol`](../reference/properties/gmeow-relayProtocol.md)).
