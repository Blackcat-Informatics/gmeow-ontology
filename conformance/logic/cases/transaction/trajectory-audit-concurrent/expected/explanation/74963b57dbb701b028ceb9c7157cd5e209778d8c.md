<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/74963b57dbb701b028ceb9c7157cd5e209778d8c
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/74963b57dbb701b028ceb9c7157cd5e209778d8c>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/txstate/9816f84140edb7669418c5c7f0ce84126754cecf>` `<https://blackcatinformatics.ca/logic/situationObtains>` `<https://example.org/transaction/trajectory-audit-concurrent/sitZ2>` *(in `<https://example.org/transaction/trajectory-audit-concurrent/world>`)*
