...
- High-fidelity depiction (regions, scene graphs) atop core [`MediaObject`](../reference/classes/gmeow-MediaObject.md); the gmeow-image CLI (CLI roll-up design).
...
- **GMEOW terms:** [`gmeow:DepictionUsage`](../reference/classes/gmeow-DepictionUsage.md), [`gmeow:ExifTag`](../reference/classes/gmeow-ExifTag.md), [`gmeow:Expression`](../reference/classes/gmeow-Expression.md), [`gmeow:ImageRegion`](../reference/classes/gmeow-ImageRegion.md), [`gmeow:MediaObject`](../reference/classes/gmeow-MediaObject.md), [`gmeow:Person`](../reference/classes/gmeow-Person.md), [`gmeow:RegionSelector`](../reference/classes/gmeow-RegionSelector.md), [`gmeow:Work`](../reference/classes/gmeow-Work.md), [`gmeow:depictionAuthority`](../reference/properties/gmeow-depictionAuthority.md), [`gmeow:depictionContext`](../reference/properties/gmeow-depictionContext.md)
...
ex:photographer a gmeow:Person ; gmeow:name "Sam Okonkwo"@en .
...
ex:photoExpression a gmeow:Expression ; gmeow:realizes ex:photoWork .
ex:photoWork a gmeow:Work ; gmeow:title "Team portrait, June 2026"@en .
...
| [`gmeow:DepictionUsage`](../reference/classes/gmeow-DepictionUsage.md) | Depiction Usage | A reified, context-dependent depiction of an entity by an image — an observation in the universal claim stack (observation-spine bridge): an entity (depictionS... |
...
[`MediaObject`](../reference/classes/gmeow-MediaObject.md), driven by the `gmeow-image` CLI (CLI roll-up design)**.
...
the rights facility; provenance reuses [`wasGeneratedBy`](../reference/properties/gmeow-wasGeneratedBy.md)/[`wasDerivedFrom`](../reference/properties/gmeow-wasDerivedFrom.md).
