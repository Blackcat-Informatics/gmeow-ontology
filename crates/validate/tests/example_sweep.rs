...
const NON_CONFORMANT: &[&str] = &[
    ...
    "slices/core/tags/examples/contested-tagging.ttl", // gmeow:taggingTagged/taggingTagger → Entity/Agent not typed standalone (photo is gmeow:CreativeWork, curators gmeow:Person); gmeow:hasTemporalFrame → shared gmeow:temporalFrameUTCGregorian frame individual untyped standalone
