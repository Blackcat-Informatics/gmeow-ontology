...
const NON_CONFORMANT: &[&str] = &[
    ...
    "slices/extensions/agentic/examples/agent-goal-holarchy.ttl", // gmeow:ToolCall-shape: gmeow:usedTool → SoftwareAgent + gmeow:calledByInvocation → ModelInvocation reference shared agent/invocation individuals untyped standalone; conforms in the merged bundle (gmeow validate passes)
    "slices/extensions/agentic/examples/agent-trajectory.ttl", // gmeow:ToolCall-shape: gmeow:usedTool → SoftwareAgent + gmeow:calledByInvocation → ModelInvocation reference shared agent/invocation individuals untyped standalone; conforms in the merged bundle (gmeow validate passes)
    "slices/extensions/agentic/examples/memory-triad-execute.ttl", // gmeow:ToolCall-shape: gmeow:usedTool → shared SoftwareAgent individual untyped standalone; conforms in the merged bundle (gmeow validate passes)
    "slices/extensions/agentic/examples/trajectory-audit.ttl", // gmeow:ToolCall-shape: gmeow:usedTool → shared SoftwareAgent individual untyped standalone; conforms in the merged bundle (gmeow validate passes)
