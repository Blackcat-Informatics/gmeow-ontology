...
- `test_blame_deflection_example_uses_doxastic_standpoint_claims` — Issue #561 re-grounding: every held/projected standpoint in the blame-deflection example is typed gmeow:DoxasticStandpointClaim.
