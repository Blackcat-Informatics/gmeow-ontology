...
/// # Bump policy
///
/// Bump `owl:versionInfo` in `ontology/gmeow.ttl` and `make regen` — never
...
fn render_about(version: &str) -> Vec<u8> {
    ...
    out.push_str("and run `make regen` — never hand-edit this file or set `version`\n");
...
/// standalone `make regen SYNC_OUTPUTS=docs` entry, which runs post-pipeline against
