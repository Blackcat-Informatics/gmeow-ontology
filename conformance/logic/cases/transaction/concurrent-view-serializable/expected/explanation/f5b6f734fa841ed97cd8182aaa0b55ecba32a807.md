<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/f5b6f734fa841ed97cd8182aaa0b55ecba32a807
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/f5b6f734fa841ed97cd8182aaa0b55ecba32a807>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/outcome/4554b13314f84c1a59536908a08bec2903958975>` `<https://blackcatinformatics.ca/logic/transactionStart>` `<https://example.org/transaction/concurrent-view-serializable/s0>` *(in `<https://example.org/transaction/concurrent-view-serializable/world>`)*
