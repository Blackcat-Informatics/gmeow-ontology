...
- **GMEOW terms:** [`gmeow:ControlFlow`](../reference/classes/gmeow-ControlFlow.md), [`gmeow:DataFlow`](../reference/classes/gmeow-DataFlow.md), [`gmeow:Dataset`](../reference/classes/gmeow-Dataset.md), [`gmeow:Execution`](../reference/classes/gmeow-Execution.md), [`gmeow:Procedure`](../reference/classes/gmeow-Procedure.md), [`gmeow:ProcedureStep`](../reference/classes/gmeow-ProcedureStep.md), [`gmeow:SoftwareAgent`](../reference/classes/gmeow-SoftwareAgent.md), [`gmeow:dataFlowEntity`](../reference/properties/gmeow-dataFlowEntity.md), [`gmeow:dataFlowSource`](../reference/properties/gmeow-dataFlowSource.md), [`gmeow:dataFlowTarget`](../reference/properties/gmeow-dataFlowTarget.md)
...
ex:scheduler a gmeow:SoftwareAgent ; gmeow:name "Airflow scheduler"@en .
```
...
### [`gmeow:Procedure`](../reference/classes/gmeow-Procedure.md) · [`gmeow:ProcedureStep`](../reference/classes/gmeow-ProcedureStep.md)

A [`Procedure`](../reference/classes/gmeow-Procedure.md) is a prescriptive specification — a template, recipe, protocol,
blueprint, or workflow definition — an [`InformationObject`](../reference/classes/gmeow-InformationObject.md), the plan side of the
de-conflation. A [`ProcedureStep`](../reference/classes/gmeow-ProcedureStep.md) is an atomic step within it, carrying inputs,
outputs, and parameters, and may itself reference a subprocess via
[`stepEnactsProcedure`](../reference/properties/gmeow-stepEnactsProcedure.md).

### [`gmeow:Execution`](../reference/classes/gmeow-Execution.md) · [`gmeow:executesProcedure`](../reference/properties/gmeow-executesProcedure.md) · [`gmeow:executesStep`](../reference/properties/gmeow-executesStep.md) · [`gmeow:executionParticipant`](../reference/properties/gmeow-executionParticipant.md)

An [`Execution`](../reference/classes/gmeow-Execution.md) (⊑ [`Event`](../reference/classes/gmeow-Event.md)) is the occurrence that enacts a procedure or step,
reusing the event/participation machinery. [`executesProcedure`](../reference/properties/gmeow-executesProcedure.md) and [`executesStep`](../reference/properties/gmeow-executesStep.md)
link it to the plan it realises; [`executionParticipant`](../reference/properties/gmeow-executionParticipant.md) is the flat 80%-case
agent/tool shortcut, promoted to a [`Participation`](../reference/classes/gmeow-Participation.md) when role or evidence matters.

### [`gmeow:ControlFlow`](../reference/classes/gmeow-ControlFlow.md) · [`gmeow:flowSource`](../reference/properties/gmeow-flowSource.md) · [`gmeow:flowTarget`](../reference/properties/gmeow-flowTarget.md) · [`gmeow:flowGuard`](../reference/properties/gmeow-flowGuard.md) · [`gmeow:flowOrder`](../reference/properties/gmeow-flowOrder.md)

A reified relator sequencing, branching, or looping between two [`ProcedureStep`](../reference/classes/gmeow-ProcedureStep.md)s.
[`flowSource`](../reference/properties/gmeow-flowSource.md)/[`flowTarget`](../reference/properties/gmeow-flowTarget.md) are its functional endpoints; [`flowGuard`](../reference/properties/gmeow-flowGuard.md) records the
guard [`BranchConditionType`](../reference/classes/gmeow-BranchConditionType.md) (evaluated solver-side); [`flowOrder`](../reference/properties/gmeow-flowOrder.md) is an optional
explicit ordering index.

### [`gmeow:DataFlow`](../reference/classes/gmeow-DataFlow.md) · [`gmeow:dataFlowSource`](../reference/properties/gmeow-dataFlowSource.md) · [`gmeow:dataFlowTarget`](../reference/properties/gmeow-dataFlowTarget.md) · [`gmeow:dataFlowEntity`](../reference/properties/gmeow-dataFlowEntity.md)
...
[`dataFlowEntity`](../reference/properties/gmeow-dataFlowEntity.md) naming what flows.

### [`gmeow:ProcedureType`](../reference/classes/gmeow-ProcedureType.md) · [`gmeow:procedureType`](../reference/properties/gmeow-procedureType.md) · [`gmeow:StepType`](../reference/classes/gmeow-StepType.md) · [`gmeow:procedureStepType`](../reference/properties/gmeow-procedureStepType.md) · [`gmeow:BranchConditionType`](../reference/classes/gmeow-BranchConditionType.md) · [`gmeow:ExecutionStatus`](../reference/classes/gmeow-ExecutionStatus.md) · [`gmeow:executionStatus`](../reference/properties/gmeow-executionStatus.md)

The open value vocabularies ([Principle 9](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-9)): procedure kind (recipe, lab protocol,
...
### [`gmeow:hasProcedureStep`](../reference/properties/gmeow-hasProcedureStep.md) · [`gmeow:procedureStepOf`](../reference/properties/gmeow-procedureStepOf.md) · [`gmeow:subProcedureOf`](../reference/properties/gmeow-subProcedureOf.md) · [`gmeow:hasSubProcedure`](../reference/properties/gmeow-hasSubProcedure.md) · [`gmeow:stepEnactsProcedure`](../reference/properties/gmeow-stepEnactsProcedure.md)

[`Procedure`](../reference/classes/gmeow-Procedure.md) composition: [`hasProcedureStep`](../reference/properties/gmeow-hasProcedureStep.md)/[`procedureStepOf`](../reference/properties/gmeow-procedureStepOf.md) is step mereology
(specialising [`hasPart`](../reference/properties/gmeow-hasPart.md)/[`partOf`](../reference/properties/gmeow-partOf.md)); [`subProcedureOf`](../reference/properties/gmeow-subProcedureOf.md)/[`hasSubProcedure`](../reference/properties/gmeow-hasSubProcedure.md) is the
transitive subprocess spine; [`stepEnactsProcedure`](../reference/properties/gmeow-stepEnactsProcedure.md) links a subprocess step to the
[`Procedure`](../reference/classes/gmeow-Procedure.md) defining its internals.

### [`gmeow:stepInput`](../reference/properties/gmeow-stepInput.md) · [`gmeow:stepOutput`](../reference/properties/gmeow-stepOutput.md) · [`gmeow:stepParameter`](../reference/properties/gmeow-stepParameter.md)

The step's resources: an `Input` consumed, an `Output` produced, and a
`Parameter` that governs behaviour without being consumed — all [`owl:Thing`](http://www.w3.org/2002/07/owl#Thing)-ranged
and non-functional.

### [`gmeow:inquiryPriority`](../reference/properties/gmeow-inquiryPriority.md) · [`gmeow:inquiryTheme`](../reference/properties/gmeow-inquiryTheme.md) · [`gmeow:inquirySource`](../reference/properties/gmeow-inquirySource.md) · [`gmeow:inquiryStatus`](../reference/properties/gmeow-inquiryStatus.md) · [`gmeow:resolvedByArtifact`](../reference/properties/gmeow-resolvedByArtifact.md)

The research-inquiry profile extensions on a [`Procedure`](../reference/classes/gmeow-Procedure.md) of type `researchPlan`: a
1–10 [`inquiryPriority`](../reference/properties/gmeow-inquiryPriority.md), a thematic [`inquiryTheme`](../reference/properties/gmeow-inquiryTheme.md), the prompting [`inquirySource`](../reference/properties/gmeow-inquirySource.md),
the [`inquiryStatus`](../reference/properties/gmeow-inquiryStatus.md) (an [`ExecutionStatus`](../reference/classes/gmeow-ExecutionStatus.md) value), and the [`resolvedByArtifact`](../reference/properties/gmeow-resolvedByArtifact.md)
