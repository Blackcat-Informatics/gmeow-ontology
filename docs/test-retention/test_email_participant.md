# Retention: `test_email_participant.py`
...
- `test_resent_properties_are_multivalued_in_linkml_schema` plus `test_resent_properties_are_multivalued_in_linkml_schema` (generated-schema slot check, not a module graph invariant)
