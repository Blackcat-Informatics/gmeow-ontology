...
the model above. Signature metadata ([`signedBy`](../reference/properties/gmeow-signedBy.md), [`signingKey`](../reference/properties/gmeow-signingKey.md),
[`signatureAlgorithm`](../reference/properties/gmeow-signatureAlgorithm.md), [`CryptographicSignature`](../reference/classes/gmeow-CryptographicSignature.md)) and the validity/identity
cross-cutters are reused from the trust and temporal modules, not redefined here.

### [`gmeow:Attestation`](../reference/classes/gmeow-Attestation.md) · [`gmeow:attester`](../reference/properties/gmeow-attester.md) · [`gmeow:attestedSubject`](../reference/properties/gmeow-attestedSubject.md) · [`gmeow:attestedClaim`](../reference/properties/gmeow-attestedClaim.md) · [`gmeow:hasAttestation`](../reference/properties/gmeow-hasAttestation.md)

The core relator: a reified envelope recording that an [`gmeow:attester`](../reference/properties/gmeow-attester.md) (one,
functional) vouches for a bare [`gmeow:attestedSubject`](../reference/properties/gmeow-attestedSubject.md) entity and/or an
[`gmeow:attestedClaim`](../reference/properties/gmeow-attestedClaim.md) observation, under a policy and with evidence. An entity
reaches its attestations through the inverse [`gmeow:hasAttestation`](../reference/properties/gmeow-hasAttestation.md); competing
attestations coexist ([Principle 9](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-9)) and an attestation proves who said what, never
that it is true.

### [`gmeow:attestationType`](../reference/properties/gmeow-attestationType.md) · [`gmeow:AttestationType`](../reference/classes/gmeow-AttestationType.md) · [`gmeow:attestationPolicy`](../reference/properties/gmeow-attestationPolicy.md) · [`gmeow:AttestationPolicy`](../reference/classes/gmeow-AttestationPolicy.md) · [`gmeow:issuedAt`](../reference/properties/gmeow-issuedAt.md)

The envelope's classification and provenance: [`gmeow:attestationType`](../reference/properties/gmeow-attestationType.md) names one or
more [`gmeow:AttestationType`](../reference/classes/gmeow-AttestationType.md) kinds (SLSA provenance, in-toto, VC, DSSE, C2PA,
nanopublication…); [`gmeow:attestationPolicy`](../reference/properties/gmeow-attestationPolicy.md) names the [`gmeow:AttestationPolicy`](../reference/classes/gmeow-AttestationPolicy.md)
rules the attester followed; [`gmeow:issuedAt`](../reference/properties/gmeow-issuedAt.md) stamps the single issue instant
(functional). Validity rides the temporal module's [`validFrom`](../reference/properties/gmeow-validFrom.md)/[`validUntil`](../reference/properties/gmeow-validUntil.md).

### [`gmeow:AttestationArtifact`](../reference/classes/gmeow-AttestationArtifact.md) · [`gmeow:attestationArtifact`](../reference/properties/gmeow-attestationArtifact.md) · [`gmeow:artifactMediaType`](../reference/properties/gmeow-artifactMediaType.md) · [`gmeow:hasSignature`](../reference/properties/gmeow-hasSignature.md) · [`gmeow:signatureOf`](../reference/properties/gmeow-signatureOf.md)

The concrete carrier: an [`gmeow:AttestationArtifact`](../reference/classes/gmeow-AttestationArtifact.md) is the serialized document
(in-toto JSON, DSSE envelope, VC, C2PA manifest) linked from the logical
attestation by [`gmeow:attestationArtifact`](../reference/properties/gmeow-attestationArtifact.md) and typed by [`gmeow:artifactMediaType`](../reference/properties/gmeow-artifactMediaType.md).
[`gmeow:hasSignature`](../reference/properties/gmeow-hasSignature.md) is the domain-free universal spine attaching a cryptographic
signature to anything signed, with [`gmeow:signatureOf`](../reference/properties/gmeow-signatureOf.md) its inverse — a valid
signature proves integrity and key control, never truth.

### [`gmeow:VerificationActivity`](../reference/classes/gmeow-VerificationActivity.md) · [`gmeow:VerificationResult`](../reference/classes/gmeow-VerificationResult.md) · [`gmeow:verificationActivity`](../reference/properties/gmeow-verificationActivity.md) · [`gmeow:verificationResult`](../reference/properties/gmeow-verificationResult.md) · [`gmeow:verifiedBy`](../reference/properties/gmeow-verifiedBy.md) · [`gmeow:hasVerificationStatus`](../reference/properties/gmeow-hasVerificationStatus.md) · [`gmeow:VerificationStatus`](../reference/classes/gmeow-VerificationStatus.md)

Verification as act and outcome: a [`gmeow:VerificationActivity`](../reference/classes/gmeow-VerificationActivity.md) is the checking
event, producing a [`gmeow:VerificationResult`](../reference/classes/gmeow-VerificationResult.md) ([`gmeow:verifiedBy`](../reference/properties/gmeow-verifiedBy.md) an agent,
carrying [`gmeow:hasVerificationStatus`](../reference/properties/gmeow-hasVerificationStatus.md) from the [`gmeow:VerificationStatus`](../reference/classes/gmeow-VerificationStatus.md)
...
### [`gmeow:TransparencyLogEntry`](../reference/classes/gmeow-TransparencyLogEntry.md) · [`gmeow:transparencyLogEntry`](../reference/properties/gmeow-transparencyLogEntry.md) · [`gmeow:logEntryIndex`](../reference/properties/gmeow-logEntryIndex.md) · [`gmeow:logEntryUrl`](../reference/properties/gmeow-logEntryUrl.md)

Transparency-log evidence: a [`gmeow:TransparencyLogEntry`](../reference/classes/gmeow-TransparencyLogEntry.md) (Rekor entry, SCITT
receipt, CT inclusion proof) linked via [`gmeow:transparencyLogEntry`](../reference/properties/gmeow-transparencyLogEntry.md), identified by
[`gmeow:logEntryIndex`](../reference/properties/gmeow-logEntryIndex.md) (functional, log-local) and retrievable at
[`gmeow:logEntryUrl`](../reference/properties/gmeow-logEntryUrl.md). Inclusion proves it was logged, not that it is correct
([Principle 1](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-1)).

### [`gmeow:LedgerTransaction`](../reference/classes/gmeow-LedgerTransaction.md) · [`gmeow:LedgerEvent`](../reference/classes/gmeow-LedgerEvent.md) · [`gmeow:Block`](../reference/classes/gmeow-Block.md) · [`gmeow:BlockchainNetwork`](../reference/classes/gmeow-BlockchainNetwork.md) · [`gmeow:SmartContract`](../reference/classes/gmeow-SmartContract.md) · [`gmeow:BlockchainAccount`](../reference/classes/gmeow-BlockchainAccount.md)

Ledger/blockchain evidence: a [`gmeow:LedgerTransaction`](../reference/classes/gmeow-LedgerTransaction.md) (information-object view of
a payload) and the on-chain [`gmeow:LedgerEvent`](../reference/classes/gmeow-LedgerEvent.md) it emits, located by [`gmeow:Block`](../reference/classes/gmeow-Block.md)
on a [`gmeow:BlockchainNetwork`](../reference/classes/gmeow-BlockchainNetwork.md), with [`gmeow:SmartContract`](../reference/classes/gmeow-SmartContract.md) and
[`gmeow:BlockchainAccount`](../reference/classes/gmeow-BlockchainAccount.md) as the deployed program and the address-controlled
signing identity. Ledger inclusion proves inclusion under chain rules, not
real-world truth.

### [`gmeow:transactionHash`](../reference/properties/gmeow-transactionHash.md) · [`gmeow:blockHash`](../reference/properties/gmeow-blockHash.md) · [`gmeow:blockNumber`](../reference/properties/gmeow-blockNumber.md) · [`gmeow:chainId`](../reference/properties/gmeow-chainId.md) · [`gmeow:contractAddress`](../reference/properties/gmeow-contractAddress.md) · [`gmeow:signatureRecoveryAddress`](../reference/properties/gmeow-signatureRecoveryAddress.md) · [`gmeow:logIndex`](../reference/properties/gmeow-logIndex.md) · [`gmeow:confirmationDepth`](../reference/properties/gmeow-confirmationDepth.md) · [`gmeow:finalityStatus`](../reference/properties/gmeow-finalityStatus.md) · [`gmeow:LedgerFinalityStatus`](../reference/classes/gmeow-LedgerFinalityStatus.md) · [`gmeow:ledgerInclusionProof`](../reference/properties/gmeow-ledgerInclusionProof.md) · [`gmeow:SignatureScheme`](../reference/classes/gmeow-SignatureScheme.md)

The ledger identity and finality facets: hashes and identifiers
([`gmeow:transactionHash`](../reference/properties/gmeow-transactionHash.md), [`gmeow:blockHash`](../reference/properties/gmeow-blockHash.md), [`gmeow:blockNumber`](../reference/properties/gmeow-blockNumber.md), [`gmeow:chainId`](../reference/properties/gmeow-chainId.md),
[`gmeow:contractAddress`](../reference/properties/gmeow-contractAddress.md), [`gmeow:signatureRecoveryAddress`](../reference/properties/gmeow-signatureRecoveryAddress.md), [`gmeow:logIndex`](../reference/properties/gmeow-logIndex.md)),
settlement state ([`gmeow:confirmationDepth`](../reference/properties/gmeow-confirmationDepth.md), [`gmeow:finalityStatus`](../reference/properties/gmeow-finalityStatus.md) over
[`gmeow:LedgerFinalityStatus`](../reference/classes/gmeow-LedgerFinalityStatus.md) — pending / confirmed / finalized / orphaned /
reorged), the domain-free [`gmeow:ledgerInclusionProof`](../reference/properties/gmeow-ledgerInclusionProof.md), and the
[`gmeow:SignatureScheme`](../reference/classes/gmeow-SignatureScheme.md) vocabulary of cryptographic algorithms. Finality checks run
in the solver layer ([Principle 12](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-12)).
