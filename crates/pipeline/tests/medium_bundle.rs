...
/// once, in memory, reusing only receipt-verified bounded contributions, and return
/// every stage product. Aggregate stages still execute and remain the subject of this gate.
