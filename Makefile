...
test: native-py ## Run the full test suite (incl. heavy ci_only export tests).
	uv run pytest -n auto --dist loadscope

test-fast: native-py ## Run the fast test suite (excludes ci_only, docker, and CI-only pyoxigraph).
