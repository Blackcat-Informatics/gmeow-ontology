...
| Source-backed export | Preserved: `make check-sync SYNC_MODE=update SYNC_OUTPUTS=docs` → `sync_docs` renders all nine distributions (four doc-render, four serialization, and the interactive-runtime console) |
