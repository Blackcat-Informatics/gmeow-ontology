...
//! CONSTRUCT-graph → N-Triples serialization over the `gmeow-rdf-core`
...
use gmeow_rdf_core::{emit_annotation, emit_quad, emit_reifier, RdfDataset};
...
mod tests {
    use super::*;
    use gmeow_rdf_core::{RdfDatasetBuilder, RdfQuad, RdfTerm};
