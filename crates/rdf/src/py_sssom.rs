...
/// Parse a GMEOW SSSOM TSV document, then validate it, returning one dict per
...
/// Parse a GMEOW SSSOM TSV document and render its [`sssom::to_rdf`] projection as
...
/// Parse then re-serialize a GMEOW SSSOM TSV document, returning the canonical
...
/// Register the native SSSOM surface on the `gmeow_rdf` module.
