...
| Area | Crates | Purpose |
| --- | --- | --- |
| Foundation values | `gmeow-ns`, `gmeow-errors`, `gmeow-license`, `gmeow-math` | Registered term namespaces, the diagnostics/error substrate, the vendoring-policy classifier, and exact-rational geometry. |
...
| Domain corpora and modeling | `gmeow-affect`, `gmeow-affect-ingest`, `gmeow-foundation-corpus`, `gmeow-lang-bridge`, `gmeow-lang-form`, `gmeow-music` | Affect-intensity geometry and attributed classifier ingestion, the narrative foundation corpus importer, the linguistic bridge and form AST, and the music-package toolchain. |
