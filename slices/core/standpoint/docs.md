...
| `gmeow:Standpoint` | class (`gufo:Kind`) | a named perspective/frame (often a bare `gmeow:Agent` instead) |
...
| `gmeow:StandpointTenure` | class (`gufo:Situation`) | reified standpoint-time (a position held over an interval) |
