 ...
 * @returns {string}
 */
export function gmn_codebook_digest() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.gmn_codebook_digest();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function gmn_validate(bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.gmn_validate(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function validate(data, format, gts, namespace, origin) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr2 = passArray8ToWasm0(gts, wasm.__wbindgen_malloc);
        ...
        const ret = wasm.validate(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
        var ptr6 = ret[0];
        var len6 = ret[1];
        if (ret[3]) {
            ptr6 = 0; len6 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gmeow_validate_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gmeow_validate_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
