/* @ts-self-types="./gmeow_mcp_core_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function deferred_segment() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.deferred_segment(retptr);
 ...
 * @returns {string}
 */
export function deferred_tools() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.deferred_tools(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {string}
 */
export function mcp(request_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gmeow_mcp_core_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gmeow_mcp_core_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
