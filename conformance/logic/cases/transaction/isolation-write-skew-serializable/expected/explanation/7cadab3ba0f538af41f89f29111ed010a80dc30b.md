<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/7cadab3ba0f538af41f89f29111ed010a80dc30b
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/7cadab3ba0f538af41f89f29111ed010a80dc30b>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/outcome/ddd9e8b7e5fd79c5f65389c9362f0725dceaaf23>` `<https://blackcatinformatics.ca/logic/transactionStart>` `<https://example.org/transaction/isolation-write-skew-serializable/s0>` *(in `<https://example.org/transaction/isolation-write-skew-serializable/world>`)*
