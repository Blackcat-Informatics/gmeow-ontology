...
pub mod gmeow {
    ...
    pub const BOX_RBOX: &str = "https://blackcatinformatics.ca/gmeow/boxRBox";

    pub const BOX_CBOX: &str = "https://blackcatinformatics.ca/gmeow/boxCBox";

    pub const BOX_CONFIG_BOX: &str = "https://blackcatinformatics.ca/gmeow/boxConfigBox";
}
