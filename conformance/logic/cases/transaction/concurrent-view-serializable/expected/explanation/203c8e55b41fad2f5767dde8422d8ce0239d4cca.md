<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/203c8e55b41fad2f5767dde8422d8ce0239d4cca
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/203c8e55b41fad2f5767dde8422d8ce0239d4cca>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/history/4554b13314f84c1a59536908a08bec2903958975>` `<https://blackcatinformatics.ca/logic/concurrentComposedFrom>` `<https://example.org/transaction/concurrent-view-serializable/legL>` *(in `<https://example.org/transaction/concurrent-view-serializable/world>`)*
