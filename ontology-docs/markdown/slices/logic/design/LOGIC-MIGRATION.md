...
spec, and the Rust core must pass the identical corpus ([Principle 7](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-7)). No rung is "done" until both
agree.
...
- **The [`owl:*`](http://www.w3.org/2002/07/owl#*) adapter.** Existing [`owl:*`](http://www.w3.org/2002/07/owl#*) axioms are normalized into the same typed IR as `logic:`
...
- **The [`gufo:`](http://purl.org/nemo/gufo#) adapter.** Existing [`gufo:`](http://purl.org/nemo/gufo#) stereotype authoring is accepted exactly parallel to the
 [`owl:*`](http://www.w3.org/2002/07/owl#*) adapter: a slice may declare a `logic:` foundational role, and the [gUFO](../../../external/ontologies.md#target-gufo) projection generator
...
- **equivalence** for matching `logic:`, [`owl:*`](http://www.w3.org/2002/07/owl#*), and [`gufo:`](http://purl.org/nemo/gufo#) source forms — the round-trip
...
- **oracle/engine agreement** — the Python oracle and the Rust core must pass one shared,
 language-neutral conformance corpus identically (the gate; [Principle 7](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-7));
...
3. **[`owl:*`](http://www.w3.org/2002/07/owl#*) and [`gufo:`](http://purl.org/nemo/gufo#) adapter source is retired per slice**, only after that slice's `logic:` form
