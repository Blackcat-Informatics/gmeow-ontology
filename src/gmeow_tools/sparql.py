...
reasoning authority (Principle 17). purrdf's SPARQL engine is W3C-conformance
tested and the native ``crosscheck-queries`` gate proves every committed query
answers on it, which is what licenses callers to trust this engine (CONSTITUTION
