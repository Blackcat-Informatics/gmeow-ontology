...
- Licensing and rights of every artifact across the ontology: GMEOW's own dual licence, the Images super-ontology, software (SPDX / SBOM exports via [`gmeow:spdxLicenseId`](../reference/properties/gmeow-spdxLicenseId.md)), and the mail corpus; the [`Employment`](../reference/classes/gmeow-Employment.md) / publication block; generated machine-readable projections (queries/projections/odrl.rq, cc.rq, schema-org.rq) for ODRL policies, CC REL licences, and the schema.org rights cluster; public-facing licence, copyright-notice, attribution, and trademark surfaces (schema.org JSON-LD, Wikidata); and the privacy / consent / redaction facility driving disclosure control over personal data.
...
| [`gmeow:RightsStatement`](../reference/classes/gmeow-RightsStatement.md) | Rights Statement | A reified, machine-readable statement of the rights situation of an entity — an observation in the universal claim stack (observation-spine bridge). Who may do... |
...
### [`gmeow:RightsStatement`](../reference/classes/gmeow-RightsStatement.md) · [`gmeow:statementAbout`](../reference/properties/gmeow-statementAbout.md) · [`gmeow:hasRightsStatement`](../reference/properties/gmeow-hasRightsStatement.md) · [`gmeow:rightsType`](../reference/properties/gmeow-rightsType.md) · [`gmeow:RightsType`](../reference/classes/gmeow-RightsType.md)

The machine-readable rights situation of an asset (the ODRL Policy idea): a
[`RightsStatement`](../reference/classes/gmeow-RightsStatement.md) [`statementAbout`](../reference/properties/gmeow-statementAbout.md) the asset it governs (the ODRL target),
attached flat by [`hasRightsStatement`](../reference/properties/gmeow-hasRightsStatement.md). [`rightsType`](../reference/properties/gmeow-rightsType.md) names the kind(s) of IP right
it concerns — [`RightsType`](../reference/classes/gmeow-RightsType.md) being an open value vocabulary (copyright, trademark,
patent, trade secret, moral rights, database right, …) linked to Wikidata/WIPO.

### [`gmeow:Copyright`](../reference/classes/gmeow-Copyright.md) · [`gmeow:hasCopyright`](../reference/properties/gmeow-hasCopyright.md) · [`gmeow:copyrightWork`](../reference/properties/gmeow-copyrightWork.md) · [`gmeow:copyrightHolder`](../reference/properties/gmeow-copyrightHolder.md) · [`gmeow:copyrightYear`](../reference/properties/gmeow-copyrightYear.md) · [`gmeow:copyrightNotice`](../reference/properties/gmeow-copyrightNotice.md) · [`gmeow:copyrightStatus`](../reference/properties/gmeow-copyrightStatus.md) · [`gmeow:CopyrightStatus`](../reference/classes/gmeow-CopyrightStatus.md)

The copyright relator and its posts — the protected [`copyrightWork`](../reference/properties/gmeow-copyrightWork.md), the
[`copyrightHolder`](../reference/properties/gmeow-copyrightHolder.md) (⊑ [`wasAttributedTo`](../reference/properties/gmeow-wasAttributedTo.md)), the [`copyrightYear`](../reference/properties/gmeow-copyrightYear.md), the free-text
[`copyrightNotice`](../reference/properties/gmeow-copyrightNotice.md), and the [`copyrightStatus`](../reference/properties/gmeow-copyrightStatus.md) (a [`CopyrightStatus`](../reference/classes/gmeow-CopyrightStatus.md) value:
in-copyright, public-domain, …) — attached flat by [`hasCopyright`](../reference/properties/gmeow-hasCopyright.md).

### [`gmeow:License`](../reference/classes/gmeow-License.md) · [`gmeow:LicenseFamily`](../reference/classes/gmeow-LicenseFamily.md) · [`gmeow:hasLicense`](../reference/properties/gmeow-hasLicense.md) · [`gmeow:licensedWork`](../reference/properties/gmeow-licensedWork.md) · [`gmeow:licensor`](../reference/properties/gmeow-licensor.md) · [`gmeow:licensee`](../reference/properties/gmeow-licensee.md) · [`gmeow:licenseFamily`](../reference/properties/gmeow-licenseFamily.md) · [`gmeow:licenseText`](../reference/properties/gmeow-licenseText.md) · [`gmeow:spdxLicenseId`](../reference/properties/gmeow-spdxLicenseId.md) · [`gmeow:spdxLicenseName`](../reference/properties/gmeow-spdxLicenseName.md) · [`gmeow:isOsiApproved`](../reference/properties/gmeow-isOsiApproved.md)

A licence as an [`Agreement`](../reference/classes/gmeow-Agreement.md) (`SubKind`): its [`licensedWork`](../reference/properties/gmeow-licensedWork.md), its `licensor` and
`licensee` parties (⊑ [`hasParty`](../reference/properties/gmeow-hasParty.md)), its [`licenseFamily`](../reference/properties/gmeow-licenseFamily.md) (a [`LicenseFamily`](../reference/classes/gmeow-LicenseFamily.md) value —
CC, copyleft, permissive, proprietary), and the SPDX handles
([`spdxLicenseId`](../reference/properties/gmeow-spdxLicenseId.md) / [`spdxLicenseName`](../reference/properties/gmeow-spdxLicenseName.md) / [`licenseText`](../reference/properties/gmeow-licenseText.md) / [`isOsiApproved`](../reference/properties/gmeow-isOsiApproved.md)). Attached
flat by [`hasLicense`](../reference/properties/gmeow-hasLicense.md).

### [`gmeow:Trademark`](../reference/classes/gmeow-Trademark.md) · [`gmeow:Mark`](../reference/classes/gmeow-Mark.md) · [`gmeow:hasTrademark`](../reference/properties/gmeow-hasTrademark.md) · [`gmeow:trademarkHolder`](../reference/properties/gmeow-trademarkHolder.md) · [`gmeow:trademarkMark`](../reference/properties/gmeow-trademarkMark.md) · [`gmeow:trademarkStatus`](../reference/properties/gmeow-trademarkStatus.md) · [`gmeow:TrademarkStatus`](../reference/classes/gmeow-TrademarkStatus.md) · [`gmeow:markText`](../reference/properties/gmeow-markText.md) · [`gmeow:registrationNumber`](../reference/properties/gmeow-registrationNumber.md)

The trademark right ([`Trademark`](../reference/classes/gmeow-Trademark.md), a relator) over the [`Mark`](../reference/classes/gmeow-Mark.md) it protects (an
[`InformationObject`](../reference/classes/gmeow-InformationObject.md), with [`markText`](../reference/properties/gmeow-markText.md) and [`registrationNumber`](../reference/properties/gmeow-registrationNumber.md)): [`trademarkHolder`](../reference/properties/gmeow-trademarkHolder.md)
the holder (⊑ [`wasAttributedTo`](../reference/properties/gmeow-wasAttributedTo.md)), [`trademarkMark`](../reference/properties/gmeow-trademarkMark.md) the protected mark, and
[`trademarkStatus`](../reference/properties/gmeow-trademarkStatus.md) (a [`TrademarkStatus`](../reference/classes/gmeow-TrademarkStatus.md) value) the registration state. Attached
flat by [`hasTrademark`](../reference/properties/gmeow-hasTrademark.md).

### [`gmeow:Rule`](../reference/classes/gmeow-Rule.md) · [`gmeow:Permission`](../reference/classes/gmeow-Permission.md) · [`gmeow:Prohibition`](../reference/classes/gmeow-Prohibition.md) · [`gmeow:Duty`](../reference/classes/gmeow-Duty.md) · [`gmeow:hasPermission`](../reference/properties/gmeow-hasPermission.md) · [`gmeow:hasProhibition`](../reference/properties/gmeow-hasProhibition.md) · [`gmeow:hasDuty`](../reference/properties/gmeow-hasDuty.md) · [`gmeow:ruleAction`](../reference/properties/gmeow-ruleAction.md) · [`gmeow:RightsAction`](../reference/classes/gmeow-RightsAction.md) · [`gmeow:ruleTarget`](../reference/properties/gmeow-ruleTarget.md) · [`gmeow:ruleAssignee`](../reference/properties/gmeow-ruleAssignee.md) · [`gmeow:ruleConstraint`](../reference/properties/gmeow-ruleConstraint.md) · [`gmeow:ruleConsequence`](../reference/properties/gmeow-ruleConsequence.md)

The ODRL deontic rule trio — [`Permission`](../reference/classes/gmeow-Permission.md), [`Prohibition`](../reference/classes/gmeow-Prohibition.md), [`Duty`](../reference/classes/gmeow-Duty.md) (relators
specialising [`Rule`](../reference/classes/gmeow-Rule.md)) — carried by [`hasPermission`](../reference/properties/gmeow-hasPermission.md) / [`hasProhibition`](../reference/properties/gmeow-hasProhibition.md) / [`hasDuty`](../reference/properties/gmeow-hasDuty.md).
Each rule names exactly one [`ruleAction`](../reference/properties/gmeow-ruleAction.md) (a [`RightsAction`](../reference/classes/gmeow-RightsAction.md) value: reproduce,
distribute, derive, …), its [`ruleTarget`](../reference/properties/gmeow-ruleTarget.md) asset, its [`ruleAssignee`](../reference/properties/gmeow-ruleAssignee.md), any
[`ruleConstraint`](../reference/properties/gmeow-ruleConstraint.md), and a duty's [`ruleConsequence`](../reference/properties/gmeow-ruleConsequence.md) remedy chain.

### [`gmeow:Constraint`](../reference/classes/gmeow-Constraint.md) · [`gmeow:AtomicConstraint`](../reference/classes/gmeow-AtomicConstraint.md) · [`gmeow:LeftOperand`](../reference/classes/gmeow-LeftOperand.md) · [`gmeow:ConstraintOperator`](../reference/classes/gmeow-ConstraintOperator.md) · [`gmeow:leftOperand`](../reference/properties/gmeow-leftOperand.md) · [`gmeow:constraintOperator`](../reference/properties/gmeow-constraintOperator.md) · [`gmeow:rightOperand`](../reference/properties/gmeow-rightOperand.md) · [`gmeow:rightOperandReference`](../reference/properties/gmeow-rightOperandReference.md)

The ODRL constraint algebra: an [`AtomicConstraint`](../reference/classes/gmeow-AtomicConstraint.md) is one comparison — a
[`leftOperand`](../reference/properties/gmeow-leftOperand.md) (the dimension tested, a [`LeftOperand`](../reference/classes/gmeow-LeftOperand.md) value: dateTime, spatial,
count, purpose, …), a [`constraintOperator`](../reference/properties/gmeow-constraintOperator.md) (a [`ConstraintOperator`](../reference/classes/gmeow-ConstraintOperator.md) value: eq, lt,
lteq, …), and a [`rightOperand`](../reference/properties/gmeow-rightOperand.md) literal or [`rightOperandReference`](../reference/properties/gmeow-rightOperandReference.md) resource. A
licence's temporal bound is an [`AtomicConstraint`](../reference/classes/gmeow-AtomicConstraint.md) over the dateTime operand.

### [`gmeow:LogicalConstraint`](../reference/classes/gmeow-LogicalConstraint.md) · [`gmeow:ConstraintLogic`](../reference/classes/gmeow-ConstraintLogic.md) · [`gmeow:constraintLogic`](../reference/properties/gmeow-constraintLogic.md) · [`gmeow:logicConstraintMember`](../reference/properties/gmeow-logicConstraintMember.md) · [`gmeow:ConflictStrategy`](../reference/classes/gmeow-ConflictStrategy.md) · [`gmeow:conflictStrategy`](../reference/properties/gmeow-conflictStrategy.md)

A [`LogicalConstraint`](../reference/classes/gmeow-LogicalConstraint.md) is a boolean combination of constraints under a
[`constraintLogic`](../reference/properties/gmeow-constraintLogic.md) operator (a [`ConstraintLogic`](../reference/classes/gmeow-ConstraintLogic.md) value: and / or / xone /
andSequence) over its [`logicConstraintMember`](../reference/properties/gmeow-logicConstraintMember.md) constraints. [`conflictStrategy`](../reference/properties/gmeow-conflictStrategy.md) (a
[`ConflictStrategy`](../reference/classes/gmeow-ConflictStrategy.md) value: perm / prohibit / invalid) resolves policy conflicts.

### [`gmeow:PrivacyNotice`](../reference/classes/gmeow-PrivacyNotice.md) · [`gmeow:hasPrivacyNotice`](../reference/properties/gmeow-hasPrivacyNotice.md) · [`gmeow:hasDataController`](../reference/properties/gmeow-hasDataController.md) · [`gmeow:hasDataSubject`](../reference/properties/gmeow-hasDataSubject.md)

The privacy layer: a [`PrivacyNotice`](../reference/classes/gmeow-PrivacyNotice.md) (the dpv/schema PrivacyPolicy counterpart)
attached domain-free by [`hasPrivacyNotice`](../reference/properties/gmeow-hasPrivacyNotice.md); [`hasDataController`](../reference/properties/gmeow-hasDataController.md) the agent
determining processing purposes and means; [`hasDataSubject`](../reference/properties/gmeow-hasDataSubject.md) the individual whose
personal data is governed.

### [`gmeow:attributionText`](../reference/properties/gmeow-attributionText.md) · [`gmeow:attributionUrl`](../reference/properties/gmeow-attributionUrl.md) · [`gmeow:acquireLicensePage`](../reference/properties/gmeow-acquireLicensePage.md) · [`gmeow:usageInfo`](../reference/properties/gmeow-usageInfo.md) · [`gmeow:conditionsOfAccess`](../reference/properties/gmeow-conditionsOfAccess.md) · [`gmeow:isAccessibleForFree`](../reference/properties/gmeow-isAccessibleForFree.md)

The schema.org / CC surface fields a rights statement carries: the credit line
([`attributionText`](../reference/properties/gmeow-attributionText.md) = [schema:creditText](https://schema.org/creditText) / [cc:attributionName](http://creativecommons.org/ns#attributionName)) and link
([`attributionUrl`](../reference/properties/gmeow-attributionUrl.md)), the licence-acquisition page ([`acquireLicensePage`](../reference/properties/gmeow-acquireLicensePage.md)),
free-text [`usageInfo`](../reference/properties/gmeow-usageInfo.md) and [`conditionsOfAccess`](../reference/properties/gmeow-conditionsOfAccess.md), and the
[`isAccessibleForFree`](../reference/properties/gmeow-isAccessibleForFree.md) flag.
