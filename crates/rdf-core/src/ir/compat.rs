...
impl RdfDataset {
    ...
    pub(crate) fn to_owned_quad(&self, frozen_index: usize, q: QuadIds) -> RdfQuad {
    ...
    pub(crate) fn to_owned_reifier(&self, reifier: TermId, triple: TermId) -> RdfReifier {
    ...
    /// [`RdfAnnotation`].
    pub(crate) fn to_owned_annotation(
        &self,
        reifier: TermId,
        p: TermId,
        o: TermId,
