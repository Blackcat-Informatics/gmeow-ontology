...
//! a frozen [`gmeow_rdf::RdfDataset`]'s iteration surface
...
//! [`NativeSparqlEngine`](gmeow_sparql_eval::NativeSparqlEngine) can run over it.

use std::sync::Arc;

use gmeow_rdf::ir::{RdfDataset, TermId};
