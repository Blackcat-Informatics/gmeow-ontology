...
- The flagship (P14): the gmeow PyPI client's Memory store, the MCP store/recall/revise triad, the hallucination-resistant KG pattern + gmeow audit ([`EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md) audit machinery), the claim-extraction eval suite, and [`Project`](../reference/classes/gmeow-Project.md) Lillith via extensions/graphrag.
...
| [`gmeow:PromptTemplate`](../reference/classes/gmeow-PromptTemplate.md) | Prompt Template | A reusable, versioned prompt with unfilled variables — the published artifact (EvidenceSpan audit machinery ships the claim-extraction template as data, not co... |
...
| [`gmeow:modelVersionTag`](../reference/properties/gmeow-modelVersionTag.md) | model version tag | The provider's wire-level version identifier for the described snapshot. Citation-grade version identity rides DOI/version identity machinery's DOI machinery. |
...
(P10: retained, surfaced by [`EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md) audit machinery's audit gates). The VERDICT about it is itself a
...
### [`gmeow:Chunk`](../reference/classes/gmeow-Chunk.md) · [`gmeow:chunkOf`](../reference/properties/gmeow-chunkOf.md) · [`gmeow:spanStart`](../reference/properties/gmeow-spanStart.md) · [`gmeow:spanEnd`](../reference/properties/gmeow-spanEnd.md)

The retrieval segment: a [`gmeow:Chunk`](../reference/classes/gmeow-Chunk.md) is a contiguous slice of a source
information object, located in it by [`gmeow:chunkOf`](../reference/properties/gmeow-chunkOf.md) (functional, ⊑ [`partOf`](../reference/properties/gmeow-partOf.md))
plus the integer offsets [`gmeow:spanStart`](../reference/properties/gmeow-spanStart.md)/[`gmeow:spanEnd`](../reference/properties/gmeow-spanEnd.md) (zero-based, half-open
code points). The one genuinely missing information-object kind in the
source → [`Chunk`](../reference/classes/gmeow-Chunk.md) → [`EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md) → claim spine.

### [`gmeow:spanOfChunk`](../reference/properties/gmeow-spanOfChunk.md) · [`gmeow:groundedIn`](../reference/properties/gmeow-groundedIn.md) · [`gmeow:supportPolarity`](../reference/properties/gmeow-supportPolarity.md) · [`gmeow:SupportPolarity`](../reference/classes/gmeow-SupportPolarity.md)

The evidence seam: [`gmeow:spanOfChunk`](../reference/properties/gmeow-spanOfChunk.md) pins an [`EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md) into the retrieved
chunk; [`gmeow:groundedIn`](../reference/properties/gmeow-groundedIn.md) (domain-free, per the unified observation stance) ties
any claim node to a supporting span, and a claim with none is a flagged
hallucination (P10, never deleted); [`gmeow:supportPolarity`](../reference/properties/gmeow-supportPolarity.md) records the NLI/AIS
stance from the closed three-value [`gmeow:SupportPolarity`](../reference/classes/gmeow-SupportPolarity.md) (supports / refutes /
neutral).

### [`gmeow:ModelInvocation`](../reference/classes/gmeow-ModelInvocation.md) · [`gmeow:usedModel`](../reference/properties/gmeow-usedModel.md) · [`gmeow:hasPrompt`](../reference/properties/gmeow-hasPrompt.md) · [`gmeow:samplingTemperature`](../reference/properties/gmeow-samplingTemperature.md) · [`gmeow:samplingTopP`](../reference/properties/gmeow-samplingTopP.md) · [`gmeow:samplingMaxTokens`](../reference/properties/gmeow-samplingMaxTokens.md)

The model-invocation activity, provenance anchor of every generated claim: one
call to a model agent ([`gmeow:usedModel`](../reference/properties/gmeow-usedModel.md)), carrying its prompts
([`gmeow:hasPrompt`](../reference/properties/gmeow-hasPrompt.md)) and sampling regime ([`gmeow:samplingTemperature`](../reference/properties/gmeow-samplingTemperature.md),
[`gmeow:samplingTopP`](../reference/properties/gmeow-samplingTopP.md), [`gmeow:samplingMaxTokens`](../reference/properties/gmeow-samplingMaxTokens.md)). Outputs hang off the existing
[`gmeow:wasGeneratedBy`](../reference/properties/gmeow-wasGeneratedBy.md); no forward output property is minted (P5).

### [`gmeow:Prompt`](../reference/classes/gmeow-Prompt.md) · [`gmeow:PromptTemplate`](../reference/classes/gmeow-PromptTemplate.md) · [`gmeow:filledFrom`](../reference/properties/gmeow-filledFrom.md) · [`gmeow:promptRole`](../reference/properties/gmeow-promptRole.md) · [`gmeow:PromptRole`](../reference/classes/gmeow-PromptRole.md)

The prompt artifact: a [`gmeow:Prompt`](../reference/classes/gmeow-Prompt.md) is the concrete instruction presented to a
model — content-addressed and role-tagged ([`gmeow:promptRole`](../reference/properties/gmeow-promptRole.md), drawn from the open
[`gmeow:PromptRole`](../reference/classes/gmeow-PromptRole.md) vocabulary of system/user/assistant/tool). A
[`gmeow:PromptTemplate`](../reference/classes/gmeow-PromptTemplate.md) is the reusable, versioned, variable-bearing source a
concrete prompt links back to via [`gmeow:filledFrom`](../reference/properties/gmeow-filledFrom.md).

### [`gmeow:ModelCard`](../reference/classes/gmeow-ModelCard.md) · [`gmeow:describesModel`](../reference/properties/gmeow-describesModel.md) · [`gmeow:modelProvider`](../reference/properties/gmeow-modelProvider.md) · [`gmeow:modelVersionTag`](../reference/properties/gmeow-modelVersionTag.md) · [`gmeow:modelContextWindow`](../reference/properties/gmeow-modelContextWindow.md) · [`gmeow:modelTrainingCutoff`](../reference/properties/gmeow-modelTrainingCutoff.md)

The model card: a structured document [`gmeow:describesModel`](../reference/properties/gmeow-describesModel.md) the [`SoftwareAgent`](../reference/classes/gmeow-SoftwareAgent.md),
carrying [`gmeow:modelProvider`](../reference/properties/gmeow-modelProvider.md), [`gmeow:modelVersionTag`](../reference/properties/gmeow-modelVersionTag.md),
[`gmeow:modelContextWindow`](../reference/properties/gmeow-modelContextWindow.md), and [`gmeow:modelTrainingCutoff`](../reference/properties/gmeow-modelTrainingCutoff.md). The card is about the
agent; capability claims stay attributed, contestable claim-layer observations.

### [`gmeow:Contradiction`](../reference/classes/gmeow-Contradiction.md) · [`gmeow:contradictsClaim`](../reference/properties/gmeow-contradictsClaim.md) · [`gmeow:detectedBy`](../reference/properties/gmeow-detectedBy.md) · [`gmeow:contradictionKind`](../reference/properties/gmeow-contradictionKind.md) · [`gmeow:ContradictionKind`](../reference/classes/gmeow-ContradictionKind.md)

The surfaced contradiction: a relator binding two or more claim nodes in conflict
([`gmeow:contradictsClaim`](../reference/properties/gmeow-contradictsClaim.md)), attributed to its detector ([`gmeow:detectedBy`](../reference/properties/gmeow-detectedBy.md)) and
kind-classified ([`gmeow:contradictionKind`](../reference/properties/gmeow-contradictionKind.md) over the open [`gmeow:ContradictionKind`](../reference/classes/gmeow-ContradictionKind.md)
— factual / temporal / numeric / framing). It surfaces conflict, never resolves it
by rank (P9).

### [`gmeow:MemoryItem`](../reference/classes/gmeow-MemoryItem.md) · [`gmeow:memoryOf`](../reference/properties/gmeow-memoryOf.md) · [`gmeow:memoryKind`](../reference/properties/gmeow-memoryKind.md) · [`gmeow:MemoryKind`](../reference/classes/gmeow-MemoryKind.md)

The memory role: a [`gufo:Role`](../external/terms.md#gufo-role) on the universal claim construct — any claim can be
remembered. [`gmeow:memoryOf`](../reference/properties/gmeow-memoryOf.md) names the remembering agent and [`gmeow:memoryKind`](../reference/properties/gmeow-memoryKind.md)
its cognitive register (open [`gmeow:MemoryKind`](../reference/classes/gmeow-MemoryKind.md) — episodic / semantic / working /
procedural). Revision is supersession + [`gmeow:displayable`](../reference/properties/gmeow-displayable.md) false (P10), never
deletion.
