...
/// The shipped structured-DL reasoner package's version equals this crate's version.
#[test]
fn js_package_version_equals_the_crate_version() {
    ...
    assert_eq!(
        ...
        "crates/reason-wasm/js/package.json version drifted from the crate version"
    );
}
