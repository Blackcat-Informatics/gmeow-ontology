...
pub struct ExampleConformance {
    ...
    /// shape IRI the matching finding must originate from, either directly or
    /// through a property shape with that unique owner. Every
    ...
    /// source identity. Namespace suffixes and ambiguous property ownership never
    /// satisfy a pin. Without a pin the cell checks its declared component code.
