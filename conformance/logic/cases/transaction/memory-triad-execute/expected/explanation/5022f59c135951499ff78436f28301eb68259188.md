<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/5022f59c135951499ff78436f28301eb68259188
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/5022f59c135951499ff78436f28301eb68259188>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://example.org/transaction/memory-triad-execute/claimInMemory>` `<https://blackcatinformatics.ca/logic/validUntilState>` `<https://blackcatinformatics.ca/logic/txstate/067dede280e6b13416a648a1d7ca1e076cd698aa>` *(in `<https://example.org/transaction/memory-triad-execute/world>`)*
