...
pages. [`Selector`](../reference/classes/gmeow-Selector.md) is a specialization of [`gmeow:EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md) and is reused
...
, slice manifests, and the norms extension's [`Exemplar`](../reference/classes/gmeow-Exemplar.md).
