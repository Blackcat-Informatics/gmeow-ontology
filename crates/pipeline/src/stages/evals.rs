...
fn render_leaderboard(cards: &[Scorecard]) -> String {
    let mut lines: Vec<String> = vec![
        "<!-- GENERATED by `gmeow regenerate` (evals) — DO NOT EDIT (#298). -->".to_string(),
        String::new(),
        ...
        "[#55 audit gates](../../docs/hallucination-resistant-kg.md), under the".to_string(),
...
fn render_scores_ttl(cards: &[Scorecard]) -> String {
    let mut lines: Vec<String> = vec![
        "# GENERATED by `gmeow regenerate` (evals) — DO NOT EDIT (#298).".to_string(),
        "# Evaluation is meta-claims (#54): each score is a vantage-indexed".to_string(),
