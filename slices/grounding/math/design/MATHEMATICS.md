...
| [`MATHEMATICS-EXTERNAL-CORPUS-CROSSWALK.md`](MATHEMATICS-EXTERNAL-CORPUS-CROSSWALK.md) | coverage audit | the anonymized, mechanically gated 95-topic comparison ledger: reuse, composition, extension, minting, or downstream profile, with the private source deliberately excluded from the public ontology |
