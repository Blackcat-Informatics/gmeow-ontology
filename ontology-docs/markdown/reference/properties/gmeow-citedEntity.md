...
- Use to bind the cited player of a [`gmeow:CitationAct`](../classes/gmeow-CitationAct.md) — the [`gmeow:CreativeWork`](../classes/gmeow-CreativeWork.md) (any WEMI tier) the citation points at.

### Avoid when

- Avoid pointing it at the cited work's real-world subject (cite the work, not its topic) and avoid attaching it to anything but a [`gmeow:CitationAct`](../classes/gmeow-CitationAct.md); for the flat case use [`gmeow:cites`](gmeow-cites.md).

### How to use

- Set [`gmeow:citedEntity`](gmeow-citedEntity.md) once per [`CitationAct`](../classes/gmeow-CitationAct.md) (functional) to the cited [`gmeow:CreativeWork`](../classes/gmeow-CreativeWork.md), pairing it with [`gmeow:citingEntity`](gmeow-citingEntity.md); pinpoint a locus within it via [`gmeow:viaSelector`](gmeow-viaSelector.md).

### Examples

- ex:citeAct [`gmeow:citedEntity`](gmeow-citedEntity.md) ex:parishRegister.
