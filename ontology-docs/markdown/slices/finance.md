...
- **GMEOW terms:** [`gmeow:Invoice`](../reference/classes/gmeow-Invoice.md), [`gmeow:JournalEntry`](../reference/classes/gmeow-JournalEntry.md), [`gmeow:LedgerAccount`](../reference/classes/gmeow-LedgerAccount.md), [`gmeow:MonetaryAmount`](../reference/classes/gmeow-MonetaryAmount.md), [`gmeow:Organization`](../reference/classes/gmeow-Organization.md), [`gmeow:Posting`](../reference/classes/gmeow-Posting.md), [`gmeow:currency`](../reference/properties/gmeow-currency.md), [`gmeow:invoiceAmount`](../reference/properties/gmeow-invoiceAmount.md), [`gmeow:invoiceIssuer`](../reference/properties/gmeow-invoiceIssuer.md), [`gmeow:invoiceRecipient`](../reference/properties/gmeow-invoiceRecipient.md)
...
ex:client a gmeow:Organization ; gmeow:name "Northwind Traders"@en .
...
- **Phase B**: [`FinancialTransaction`](../reference/classes/gmeow-FinancialTransaction.md), [`LedgerAccount`](../reference/classes/gmeow-LedgerAccount.md), [`JournalEntry`](../reference/classes/gmeow-JournalEntry.md),
 [`Posting`](../reference/classes/gmeow-Posting.md), double-entry SHACL, transaction/ledger/posting mappings.
- **Phase C**: [`Payment`](../reference/classes/gmeow-Payment.md), [`Invoice`](../reference/classes/gmeow-Invoice.md) (⊑ [`Document`](../reference/classes/gmeow-Document.md)), [`Order`](../reference/classes/gmeow-Order.md), [`Asset`](../reference/classes/gmeow-Asset.md),
...
- **Phase D**: [`CryptoWallet`](../reference/classes/gmeow-CryptoWallet.md), schema.org / OFX / ISO 20022 / ledger-CLI
 projections, crypto mappings.

## Terms

### [`gmeow:FinancialAccount`](../reference/classes/gmeow-FinancialAccount.md) · [`gmeow:accountHolder`](../reference/properties/gmeow-accountHolder.md) · [`gmeow:accountBalance`](../reference/properties/gmeow-accountBalance.md) · [`gmeow:accountCurrency`](../reference/properties/gmeow-accountCurrency.md) · [`gmeow:accountType`](../reference/properties/gmeow-accountType.md)

A financial account held by an agent with a financial institution — a bank,
credit, investment, or wallet account — modelled as an [`InformationObject`](../reference/classes/gmeow-InformationObject.md),
distinct from [`OnlineAccount`](../reference/classes/gmeow-OnlineAccount.md). [`accountHolder`](../reference/properties/gmeow-accountHolder.md) is non-functional (joint accounts
have co-equal holders); [`accountBalance`](../reference/properties/gmeow-accountBalance.md) is a [`MonetaryAmount`](../reference/classes/gmeow-MonetaryAmount.md); [`accountCurrency`](../reference/properties/gmeow-accountCurrency.md)
is non-functional (multi-currency accounts); [`accountType`](../reference/properties/gmeow-accountType.md) is one functional
[`FinancialAccountType`](../reference/classes/gmeow-FinancialAccountType.md) value.

### [`gmeow:accountNumber`](../reference/properties/gmeow-accountNumber.md) · [`gmeow:iban`](../reference/properties/gmeow-iban.md) · [`gmeow:bic`](../reference/properties/gmeow-bic.md)

The account's institution-level identifiers: a free-form [`accountNumber`](../reference/properties/gmeow-accountNumber.md), the
ISO 13616 `iban`, and the ISO 9362 SWIFT `bic` of the holding institution.

### [`gmeow:FinancialAccountType`](../reference/classes/gmeow-FinancialAccountType.md)

The kind of a financial account as an open value vocabulary (bank, credit,
investment, wallet) — a value pointed at by [`accountType`](../reference/properties/gmeow-accountType.md), never a subclass.

### [`gmeow:FinancialTransaction`](../reference/classes/gmeow-FinancialTransaction.md) · [`gmeow:transactionAmount`](../reference/properties/gmeow-transactionAmount.md) · [`gmeow:transactionType`](../reference/properties/gmeow-transactionType.md) · [`gmeow:transactionStatus`](../reference/properties/gmeow-transactionStatus.md)

A money-movement event (REA pattern) reusing the [`Event`](../reference/classes/gmeow-Event.md)/[`Participation`](../reference/classes/gmeow-Participation.md)
substrate: payer, payee, and intermediary are [`ParticipantRole`](../reference/classes/gmeow-ParticipantRole.md) values, never
subproperties. [`transactionAmount`](../reference/properties/gmeow-transactionAmount.md) is one functional [`MonetaryAmount`](../reference/classes/gmeow-MonetaryAmount.md); type and
status are non-functional open value vocabularies.

### [`gmeow:TransactionType`](../reference/classes/gmeow-TransactionType.md) · [`gmeow:TransactionStatus`](../reference/classes/gmeow-TransactionStatus.md)
...
### [`gmeow:LedgerAccount`](../reference/classes/gmeow-LedgerAccount.md) · [`gmeow:ledgerAccountType`](../reference/properties/gmeow-ledgerAccountType.md) · [`gmeow:ledgerAccountHolder`](../reference/properties/gmeow-ledgerAccountHolder.md) · [`gmeow:ledgerAccountCurrency`](../reference/properties/gmeow-ledgerAccountCurrency.md)

A double-entry book-keeping account (asset, liability, equity, revenue, expense)
— an [`InformationObject`](../reference/classes/gmeow-InformationObject.md) distinct from the bank-level [`FinancialAccount`](../reference/classes/gmeow-FinancialAccount.md).
[`ledgerAccountType`](../reference/properties/gmeow-ledgerAccountType.md) is functional; holder and currency are non-functional.

### [`gmeow:LedgerAccountType`](../reference/classes/gmeow-LedgerAccountType.md) · [`gmeow:PostingDirection`](../reference/classes/gmeow-PostingDirection.md)
...
### [`gmeow:JournalEntry`](../reference/classes/gmeow-JournalEntry.md) · [`gmeow:journalEntryPostings`](../reference/properties/gmeow-journalEntryPostings.md) · [`gmeow:Posting`](../reference/classes/gmeow-Posting.md) · [`gmeow:postingJournalEntry`](../reference/properties/gmeow-postingJournalEntry.md) · [`gmeow:postingAccount`](../reference/properties/gmeow-postingAccount.md) · [`gmeow:postingAmount`](../reference/properties/gmeow-postingAmount.md) · [`gmeow:postingDirection`](../reference/properties/gmeow-postingDirection.md)

A balanced double-entry event ([`JournalEntry`](../reference/classes/gmeow-JournalEntry.md) ⊑ [`Event`](../reference/classes/gmeow-Event.md)) composed of two or more
[`Posting`](../reference/classes/gmeow-Posting.md) relators. Each [`Posting`](../reference/classes/gmeow-Posting.md) carries exactly one journal entry, ledger
account, [`MonetaryAmount`](../reference/classes/gmeow-MonetaryAmount.md), and direction; balance (Σ debits = Σ credits) is
SHACL-enforced, never OWL.

### [`gmeow:Payment`](../reference/classes/gmeow-Payment.md) · [`gmeow:paymentMethod`](../reference/properties/gmeow-paymentMethod.md) · [`gmeow:PaymentMethod`](../reference/classes/gmeow-PaymentMethod.md)

A payment event — a thin subclass of [`FinancialTransaction`](../reference/classes/gmeow-FinancialTransaction.md) distinguished by the
[`paymentMethod`](../reference/properties/gmeow-paymentMethod.md) facet, drawn from the open [`PaymentMethod`](../reference/classes/gmeow-PaymentMethod.md) value vocabulary
(cash, cheque, credit card, bank transfer, cryptocurrency). Non-functional: split
payments carry several methods.

### [`gmeow:Invoice`](../reference/classes/gmeow-Invoice.md) · [`gmeow:invoiceAmount`](../reference/properties/gmeow-invoiceAmount.md) · [`gmeow:invoiceIssuer`](../reference/properties/gmeow-invoiceIssuer.md) · [`gmeow:invoiceRecipient`](../reference/properties/gmeow-invoiceRecipient.md) · [`gmeow:invoiceDueDate`](../reference/properties/gmeow-invoiceDueDate.md) · [`gmeow:invoiceStatus`](../reference/properties/gmeow-invoiceStatus.md) · [`gmeow:InvoiceStatus`](../reference/classes/gmeow-InvoiceStatus.md)

A billing document ([`Invoice`](../reference/classes/gmeow-Invoice.md) ⊑ [`Document`](../reference/classes/gmeow-Document.md)) with a functional total [`invoiceAmount`](../reference/properties/gmeow-invoiceAmount.md),
non-functional issuer and recipient, a DL-clean [`xsd:dateTime`](http://www.w3.org/2001/XMLSchema#dateTime) due date, and an
open [`InvoiceStatus`](../reference/classes/gmeow-InvoiceStatus.md) value (draft, sent, paid, overdue, cancelled).

### [`gmeow:Order`](../reference/classes/gmeow-Order.md) · [`gmeow:orderAmount`](../reference/properties/gmeow-orderAmount.md) · [`gmeow:orderBuyer`](../reference/properties/gmeow-orderBuyer.md) · [`gmeow:orderSeller`](../reference/properties/gmeow-orderSeller.md) · [`gmeow:orderStatus`](../reference/properties/gmeow-orderStatus.md) · [`gmeow:OrderStatus`](../reference/classes/gmeow-OrderStatus.md)

A purchase or sales order ([`Order`](../reference/classes/gmeow-Order.md) ⊑ [`Agreement`](../reference/classes/gmeow-Agreement.md)) between buyer and seller with a
functional total [`orderAmount`](../reference/properties/gmeow-orderAmount.md) and an open [`OrderStatus`](../reference/classes/gmeow-OrderStatus.md) value (pending,
confirmed, shipped, delivered, cancelled).

### [`gmeow:Asset`](../reference/classes/gmeow-Asset.md) · [`gmeow:assetType`](../reference/properties/gmeow-assetType.md) · [`gmeow:assetIdentifier`](../reference/properties/gmeow-assetIdentifier.md) · [`gmeow:AssetType`](../reference/classes/gmeow-AssetType.md)

A financial asset — stock, bond, cryptocurrency, real estate, commodity — the
thing that is held, distinct from the [`Holding`](../reference/classes/gmeow-Holding.md) relator. [`assetType`](../reference/properties/gmeow-assetType.md) is a
functional [`AssetType`](../reference/classes/gmeow-AssetType.md) value; [`assetIdentifier`](../reference/properties/gmeow-assetIdentifier.md) carries FIGI/ISIN/ticker.

### [`gmeow:Holding`](../reference/classes/gmeow-Holding.md) · [`gmeow:holdingAgent`](../reference/properties/gmeow-holdingAgent.md) · [`gmeow:holdingAsset`](../reference/properties/gmeow-holdingAsset.md) · [`gmeow:holdingQuantity`](../reference/properties/gmeow-holdingQuantity.md) · [`gmeow:holdingCostBasis`](../reference/properties/gmeow-holdingCostBasis.md) · [`gmeow:holdingPeriod`](../reference/properties/gmeow-holdingPeriod.md)

A reify-on-demand relator connecting agent × asset × quantity × cost-basis ×
optional period — promoted from a flat [`accountBalance`](../reference/properties/gmeow-accountBalance.md) when cost-basis, period,
or provenance must be recorded.

### [`gmeow:CryptoWallet`](../reference/classes/gmeow-CryptoWallet.md) · [`gmeow:walletAddress`](../reference/properties/gmeow-walletAddress.md) · [`gmeow:walletScheme`](../reference/properties/gmeow-walletScheme.md) · [`gmeow:walletKey`](../reference/properties/gmeow-walletKey.md) · [`gmeow:WalletScheme`](../reference/classes/gmeow-WalletScheme.md)

A digital wallet holding cryptocurrency ([`CryptoWallet`](../reference/classes/gmeow-CryptoWallet.md) ⊑ [`FinancialAccount`](../reference/classes/gmeow-FinancialAccount.md)) with
one or more public [`walletAddress`](../reference/properties/gmeow-walletAddress.md)es, a functional [`walletScheme`](../reference/properties/gmeow-walletScheme.md) (Bitcoin,
Ethereum, Solana, Monero — the open [`WalletScheme`](../reference/classes/gmeow-WalletScheme.md) vocabulary), and [`walletKey`](../reference/properties/gmeow-walletKey.md)
linkage to the controlling [`CryptographicKey`](../reference/classes/gmeow-CryptographicKey.md)(s).
