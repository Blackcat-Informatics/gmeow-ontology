...
- The agent-memory flagship (an agent recording its own goals across sessions — [Principle 14](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-14)) and the lbox principia importer (a 21-goal hierarchy with counter-goals and tier tenure). The norms extension ranges [`prescribedConduct`](../reference/properties/gmeow-prescribedConduct.md) over [`Goal`](../reference/classes/gmeow-Goal.md).
...
- **GMEOW terms:** [`gmeow:Commitment`](../reference/classes/gmeow-Commitment.md), [`gmeow:Event`](../reference/classes/gmeow-Event.md), [`gmeow:Goal`](../reference/classes/gmeow-Goal.md), [`gmeow:Group`](../reference/classes/gmeow-Group.md), [`gmeow:Intention`](../reference/classes/gmeow-Intention.md), [`gmeow:Organization`](../reference/classes/gmeow-Organization.md), [`gmeow:Person`](../reference/classes/gmeow-Person.md), [`gmeow:commitmentBeneficiary`](../reference/properties/gmeow-commitmentBeneficiary.md), [`gmeow:committedAgent`](../reference/properties/gmeow-committedAgent.md), [`gmeow:eventTemporalFrame`](../reference/properties/gmeow-eventTemporalFrame.md)
...
trichotomy surfaced as GMEOW core (the teleology design). Core by [Principle 16](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-16)
...
target list is fixed in the alignment ledger: [PROV](../external/ontologies.md#target-prov) `Plan`/`hadPlan`, [P-Plan](../external/ontologies.md#target-pplan), [FIBO FND-GAO](../external/ontologies.md#target-fibo-fnd-pas-ps),
...
### [`gmeow:Goal`](../reference/classes/gmeow-Goal.md)

The propositional content every intentional moment aims at — a [`SocialObject`](../reference/classes/gmeow-SocialObject.md)
describing a state of affairs, satisfied by situations through [`satisfiedBy`](../reference/properties/gmeow-satisfiedBy.md)
(vantage-indexed, no global verdict). The single target of [`intentionGoal`](../reference/properties/gmeow-intentionGoal.md).

### [`gmeow:Desire`](../reference/classes/gmeow-Desire.md) · [`gmeow:Intention`](../reference/classes/gmeow-Intention.md) · [`gmeow:Commitment`](../reference/classes/gmeow-Commitment.md)

The commitment-graded trichotomy: wanted ([`Desire`](../reference/classes/gmeow-Desire.md)), internally committed
([`Intention`](../reference/classes/gmeow-Intention.md)) — both [`gufo:IntrinsicMode`](../external/terms.md#gufo-intrinsicmode) bound to one agent via
[`intentBearer`](../reference/properties/gmeow-intentBearer.md) — and socially committed ([`Commitment`](../reference/classes/gmeow-Commitment.md), a [`gufo:Relator`](../external/terms.md#gufo-relator)
binding a [`committedAgent`](../reference/properties/gmeow-committedAgent.md) to distinct [`commitmentBeneficiary`](../reference/properties/gmeow-commitmentBeneficiary.md) parties).

### [`gmeow:IntentionalMoment`](../reference/classes/gmeow-IntentionalMoment.md) · [`gmeow:IntentionalMode`](../reference/classes/gmeow-IntentionalMode.md)

The named umbrella over the trichotomy (UFO-C's intentional moment), giving
[`intentionGoal`](../reference/properties/gmeow-intentionGoal.md) and [`motivates`](../reference/properties/gmeow-motivates.md) a generator-visible domain instead of an
anonymous union; [`IntentionalMode`](../reference/classes/gmeow-IntentionalMode.md) is its value-vocabulary axis.

### [`gmeow:intentionGoal`](../reference/properties/gmeow-intentionGoal.md) · [`gmeow:intentBearer`](../reference/properties/gmeow-intentBearer.md) · [`gmeow:satisfiedBy`](../reference/properties/gmeow-satisfiedBy.md) · [`gmeow:counterGoal`](../reference/properties/gmeow-counterGoal.md)

The structural spine: [`intentionGoal`](../reference/properties/gmeow-intentionGoal.md) ties a moment to its one [`Goal`](../reference/classes/gmeow-Goal.md),
[`intentBearer`](../reference/properties/gmeow-intentBearer.md) to its one agent, [`satisfiedBy`](../reference/properties/gmeow-satisfiedBy.md) records vantage-indexed
satisfaction, and [`counterGoal`](../reference/properties/gmeow-counterGoal.md) names the constitutive shadow (symmetric,
irreflexive) that partly defines the goal.

### [`gmeow:committedAgent`](../reference/properties/gmeow-committedAgent.md) · [`gmeow:commitmentBeneficiary`](../reference/properties/gmeow-commitmentBeneficiary.md)

The two [`Commitment`](../reference/classes/gmeow-Commitment.md) relator roles — the agent who is bound, and the distinct
parties the commitment is owed to.

### [`gmeow:motivates`](../reference/properties/gmeow-motivates.md)

The attributed motive edge, ridden by [`accordingTo`](../reference/properties/gmeow-accordingTo.md) on the statement so avowed
and observer-attributed motives coexist ([Principle 9](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-9)) without a winner slot.

### [`gmeow:hasGoal`](../reference/properties/gmeow-hasGoal.md)

The flat-first shortcut ([Principle 4](https://github.com/Blackcat-Informatics/gmeow-ontology/blob/main/CONSTITUTION.md#principle-4)) for the 80% case — an agent simply has a
goal — promoted to [`Desire`](../reference/classes/gmeow-Desire.md)/[`Intention`](../reference/classes/gmeow-Intention.md)/[`Commitment`](../reference/classes/gmeow-Commitment.md) when grade matters, then
to [`IntentionTenure`](../reference/classes/gmeow-IntentionTenure.md) when adoption over time is the fact of interest.

### [`gmeow:IntentionTenure`](../reference/classes/gmeow-IntentionTenure.md) · [`gmeow:tenureAgent`](../reference/properties/gmeow-tenureAgent.md) · [`gmeow:tenureIntention`](../reference/properties/gmeow-tenureIntention.md)

The reify-on-demand half ([`pairsWith`](../reference/properties/gmeow-pairsWith.md) [`hasGoal`](../reference/properties/gmeow-hasGoal.md)): the [`StandpointTenure`](../reference/classes/gmeow-StandpointTenure.md) idiom
for an agent adopting, holding, and revising a goal across time — bound to its
[`tenureAgent`](../reference/properties/gmeow-tenureAgent.md) and [`tenureIntention`](../reference/properties/gmeow-tenureIntention.md), revised by suppression never deletion
