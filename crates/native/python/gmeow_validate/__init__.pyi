...
def excluded_shape_files() -> list[str]: ...
...
def retag_graph(rdf_bytes: bytes, format: str, tag_map: dict[str, str]) -> bytes: ...
...
def wikidata_audit_files(paths: list[str]) -> dict[str, Any]: ...
...
def repo_static_check(project_root: str) -> dict[str, Any]: ...
def repo_static_diagnostics_report(project_root: str) -> Any: ...
