<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/a2730e28966396a8516b5904c34513eac7948b3d
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/a2730e28966396a8516b5904c34513eac7948b3d>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/outcome/295b06c5c7c1979cf96613ce24e6d56884933d7b>` `<https://blackcatinformatics.ca/logic/outcomeOfProgram>` `<https://example.org/transaction/isolation-write-skew-snapshot/conc>` *(in `<https://example.org/transaction/isolation-write-skew-snapshot/world>`)*
