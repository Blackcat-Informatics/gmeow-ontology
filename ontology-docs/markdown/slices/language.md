...
| [`gmeow:languageTag`](../reference/properties/gmeow-languageTag.md) | language tag | The internal private-use BCP-47 language tag (e.g., 'und') used for @lang annotations on string literals representing this language. |
