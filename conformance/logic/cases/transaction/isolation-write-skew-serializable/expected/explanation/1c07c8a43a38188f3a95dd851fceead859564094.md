<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/1c07c8a43a38188f3a95dd851fceead859564094
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/1c07c8a43a38188f3a95dd851fceead859564094>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/history/ddd9e8b7e5fd79c5f65389c9362f0725dceaaf23>` `<https://blackcatinformatics.ca/logic/concurrentComposedFrom>` `<https://example.org/transaction/isolation-write-skew-serializable/leftSer>` *(in `<https://example.org/transaction/isolation-write-skew-serializable/world>`)*
