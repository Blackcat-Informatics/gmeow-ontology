...
do not ride `gmeow.gts`; `make regen SYNC_OUTPUTS=docs` discovers the canonical source set,
...
1. **Generator readiness**
   ...
   - Keep documentation projections external to `gmeow.gts` and reproducible with `make regen SYNC_OUTPUTS=docs`.
