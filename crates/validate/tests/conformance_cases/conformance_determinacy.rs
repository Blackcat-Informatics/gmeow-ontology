...
//! Conformance twin migrated from tests/test_determinacy.py
//!
...
//! subject of the merged graph (`GraphStore::ontology()`), so a module-scoped cell
//! would silently narrow it — the native re-expression of the Python subject sweep.
