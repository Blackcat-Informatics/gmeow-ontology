...
//! Native alignment-direction lint (#936): inverse-direction, domain-range,
//! property-character, equivalence-collapse, and DC refinement checks.
//!
//! This module ports the input-loading and the inverse-direction / domain-range /
//! property-character / equivalence-collapse / DC refinement checks from the retired
//! Python alignment linter into `gmeow-slice`.
//!
