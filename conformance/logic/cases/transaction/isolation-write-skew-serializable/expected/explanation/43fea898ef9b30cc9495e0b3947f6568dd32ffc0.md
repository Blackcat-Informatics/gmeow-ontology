<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/43fea898ef9b30cc9495e0b3947f6568dd32ffc0
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/43fea898ef9b30cc9495e0b3947f6568dd32ffc0>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/history/ddd9e8b7e5fd79c5f65389c9362f0725dceaaf23>` `<https://blackcatinformatics.ca/logic/concurrentComposedFrom>` `<https://example.org/transaction/isolation-write-skew-serializable/rightSer>` *(in `<https://example.org/transaction/isolation-write-skew-serializable/world>`)*
