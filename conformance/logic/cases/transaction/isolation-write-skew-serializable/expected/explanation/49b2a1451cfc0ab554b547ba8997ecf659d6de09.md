<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/49b2a1451cfc0ab554b547ba8997ecf659d6de09
  ...
  https://blackcatinformatics.ca/logic/isolationInadequacyReason
...
<!-- step-skeleton
  step derivation=https://blackcatinformatics.ca/gmeow/derivation/017d40c0f612852c0596ac5f176c0876796c70bb
    ...
    term=https://blackcatinformatics.ca/logic/isolationInadequacyReason
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/49b2a1451cfc0ab554b547ba8997ecf659d6de09>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/history/ddd9e8b7e5fd79c5f65389c9362f0725dceaaf23>` `<https://blackcatinformatics.ca/logic/isolationInadequacyReason>` `"the witnessed schedule is not conflict-serializable (a write-skew or lost-update cycle), so it does not meet the declared serializable/opacity strength"` *(in `<https://example.org/transaction/isolation-write-skew-serializable/world>`)*
