<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/b6c3abdedac98f4b254880611281ea6521654664
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/b6c3abdedac98f4b254880611281ea6521654664>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/outcome/fa50c597ea21ad7e001cf7c955f071fcb1bae479>` `<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>` `<https://blackcatinformatics.ca/logic/TransactionOutcome>` *(in `<https://example.org/transaction/concurrent-non-serializable/world>`)*
