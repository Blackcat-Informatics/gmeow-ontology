<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/57c978dadb16d88c72769d342256c221de75ba19
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/57c978dadb16d88c72769d342256c221de75ba19>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://example.org/transaction/memory-triad-execute/claimInMemory>` `<https://blackcatinformatics.ca/logic/activeInState>` `<https://blackcatinformatics.ca/logic/txstate/fdfb939b78a80ba0001424fd01c8c12b30c06030>` *(in `<https://example.org/transaction/memory-triad-execute/world>`)*
