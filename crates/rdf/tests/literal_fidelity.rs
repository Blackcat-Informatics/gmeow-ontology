...
//! RDFC-1.0 [`gmeow_rdf::canonical_flat_nquads`] comparator. RDFC-1.0 is allowed to
...
fn dataset_with_literal(lexical: &str, datatype: &str) -> std::sync::Arc<gmeow_rdf::RdfDataset> {
...
fn jsonld_preserves_literal_value_space() {
    use gmeow_rdf::native_codecs::jsonld::{parse_jsonld, serialize_dataset_to_jsonld};
