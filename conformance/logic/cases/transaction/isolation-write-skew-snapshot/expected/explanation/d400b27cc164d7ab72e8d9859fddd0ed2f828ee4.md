<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/d400b27cc164d7ab72e8d9859fddd0ed2f828ee4
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/d400b27cc164d7ab72e8d9859fddd0ed2f828ee4>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/outcome/295b06c5c7c1979cf96613ce24e6d56884933d7b>` `<https://blackcatinformatics.ca/logic/transactionStart>` `<https://example.org/transaction/isolation-write-skew-snapshot/s0>` *(in `<https://example.org/transaction/isolation-write-skew-snapshot/world>`)*
