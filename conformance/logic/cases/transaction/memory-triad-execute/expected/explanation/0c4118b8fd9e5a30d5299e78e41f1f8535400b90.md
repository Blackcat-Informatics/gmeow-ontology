<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/0c4118b8fd9e5a30d5299e78e41f1f8535400b90
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/0c4118b8fd9e5a30d5299e78e41f1f8535400b90>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://example.org/transaction/memory-triad-execute/targetClaimExists>` `<https://blackcatinformatics.ca/logic/validUntilState>` `<https://blackcatinformatics.ca/logic/txstate/067dede280e6b13416a648a1d7ca1e076cd698aa>` *(in `<https://example.org/transaction/memory-triad-execute/world>`)*
