...
//! an additive `gmeow` extension block; the CSV/TSV writers cannot carry it and
...
/// pure-W3C serialization. Populated → additive `gmeow` extension in JSON/XML.
...
impl ResultProvenance {
    ...
    /// additive `gmeow` extension at all.
    #[must_use]
