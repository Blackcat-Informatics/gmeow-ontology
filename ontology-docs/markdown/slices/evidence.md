...
- The claim spine's [`EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md); evidential warrant for citations and deception analyses.
...
the **[`EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md)** anchor — the link from a claim back into the exact span of
...
the claim spine's [`EvidenceSpan`](../reference/classes/gmeow-EvidenceSpan.md), citation warrant in every sourced slice, and
