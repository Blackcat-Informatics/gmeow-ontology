<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/98c49ad151680d8852827970ffae4bd2d2e0bfce
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/98c49ad151680d8852827970ffae4bd2d2e0bfce>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/txstate/25758be5bd8534bdd31e6d351f6a0a150fa6a75d>` `<https://blackcatinformatics.ca/logic/temporallySucceeds>` `<https://example.org/teleology/serial-conjunction-split/s0>` *(in `<https://example.org/teleology/serial-conjunction-split/world>`)*
