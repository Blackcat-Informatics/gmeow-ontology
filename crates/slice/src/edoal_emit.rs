...
//! emitters: the EDOAL orchestrator lives in the slice framework. Every input is
//! discovered natively from the repo root — the
...
/// The 45 projection profiles, in stable compiler emission order (the order is
