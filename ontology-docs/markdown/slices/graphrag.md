...
### [`gmeow:Corpus`](../reference/classes/gmeow-Corpus.md) · [`gmeow:corpusMember`](../reference/properties/gmeow-corpusMember.md)
...
[`Collection`](../reference/classes/gmeow-Collection.md). [`corpusMember`](../reference/properties/gmeow-corpusMember.md) (⊑ [`hasPart`](../reference/properties/gmeow-hasPart.md)) relates a corpus to a source it collects;
non-functional, since a source may belong to many corpora.

### [`gmeow:Embedding`](../reference/classes/gmeow-Embedding.md) · [`gmeow:embeddingOf`](../reference/properties/gmeow-embeddingOf.md) · [`gmeow:embeddingModel`](../reference/properties/gmeow-embeddingModel.md) · [`gmeow:embeddingDimensions`](../reference/properties/gmeow-embeddingDimensions.md) · [`gmeow:vectorRef`](../reference/properties/gmeow-vectorRef.md)

A vector representation of an information object (usually a core [`Chunk`](../reference/classes/gmeow-Chunk.md)) — the
genuine vocabulary gap in the stack. [`embeddingOf`](../reference/properties/gmeow-embeddingOf.md) (functional) names the
represented object; [`embeddingModel`](../reference/properties/gmeow-embeddingModel.md) (functional) the producing agent, so two
models' embeddings are two individuals (P9); [`embeddingDimensions`](../reference/properties/gmeow-embeddingDimensions.md) the
dimensionality. [`vectorRef`](../reference/properties/gmeow-vectorRef.md) points to the payload, which stays OUTSIDE the graph
(P12) — the graph holds the audit trail, not the floats.

### [`gmeow:DistanceMetric`](../reference/classes/gmeow-DistanceMetric.md) · [`gmeow:distanceMetric`](../reference/properties/gmeow-distanceMetric.md)

An open value vocabulary of vector similarity/distance functions (cosine,
euclidean, dot product). [`distanceMetric`](../reference/properties/gmeow-distanceMetric.md) (functional, domain-free) carries the
...
### [`gmeow:VectorIndex`](../reference/classes/gmeow-VectorIndex.md) · [`gmeow:indexesCorpus`](../reference/properties/gmeow-indexesCorpus.md) · [`gmeow:IndexAlgorithm`](../reference/classes/gmeow-IndexAlgorithm.md) · [`gmeow:indexAlgorithm`](../reference/properties/gmeow-indexAlgorithm.md) · [`gmeow:indexParameters`](../reference/properties/gmeow-indexParameters.md)

A built retrieval structure over a corpus's embeddings — the artifact a
[`RetrievalEvent`](../reference/classes/gmeow-RetrievalEvent.md) queries. [`indexesCorpus`](../reference/properties/gmeow-indexesCorpus.md) ties it to the corpus served (non-functional,
for federated indexes); [`indexAlgorithm`](../reference/properties/gmeow-indexAlgorithm.md) (functional) carries its ANN structure from
the open [`IndexAlgorithm`](../reference/classes/gmeow-IndexAlgorithm.md) vocabulary (HNSW, IVF, flat); [`indexParameters`](../reference/properties/gmeow-indexParameters.md) records the
build parameters verbatim as a JSON string for reproducibility.

### [`gmeow:RetrievalEvent`](../reference/classes/gmeow-RetrievalEvent.md) · [`gmeow:forQuery`](../reference/properties/gmeow-forQuery.md) · [`gmeow:againstIndex`](../reference/properties/gmeow-againstIndex.md) · [`gmeow:retrievedChunk`](../reference/properties/gmeow-retrievedChunk.md) · [`gmeow:retrievalScore`](../reference/properties/gmeow-retrievalScore.md)

One retrieval against a vector index — the answer to 'why did the model see this
passage?'; an agent-memory recall is a [`RetrievalEvent`](../reference/classes/gmeow-RetrievalEvent.md) too. [`forQuery`](../reference/properties/gmeow-forQuery.md) records the
query verbatim; [`againstIndex`](../reference/properties/gmeow-againstIndex.md) (functional) the index queried; [`retrievedChunk`](../reference/properties/gmeow-retrievedChunk.md) each
chunk returned, with per-chunk relevance riding the [`retrievalScore`](../reference/properties/gmeow-retrievalScore.md) statement
annotation so competing re-ranker scores coexist attributed (P9, P3).

### [`gmeow:ExtractedEntity`](../reference/classes/gmeow-ExtractedEntity.md) · [`gmeow:ExtractedRelationship`](../reference/classes/gmeow-ExtractedRelationship.md) · [`gmeow:relationshipSource`](../reference/properties/gmeow-relationshipSource.md) · [`gmeow:relationshipTarget`](../reference/properties/gmeow-relationshipTarget.md)
...
[`owl:sameAs`](http://www.w3.org/2002/07/owl#sameAs), P5), and the extracted relationship between two such descriptions.
[`relationshipSource`](../reference/properties/gmeow-relationshipSource.md) and [`relationshipTarget`](../reference/properties/gmeow-relationshipTarget.md) (both functional) carry the edge's tail
and head.

### [`gmeow:Community`](../reference/classes/gmeow-Community.md) · [`gmeow:communityMember`](../reference/properties/gmeow-communityMember.md) · [`gmeow:communityLevel`](../reference/properties/gmeow-communityLevel.md)

A graph-clustering community (Leiden or similar) over extracted-entity descriptions,
at a [`communityLevel`](../reference/properties/gmeow-communityLevel.md) of the cluster hierarchy (0 = leaf). [`communityMember`](../reference/properties/gmeow-communityMember.md)
(⊑ [`hasPart`](../reference/properties/gmeow-hasPart.md)) names a clustered description; the clustering run is provenance via the
existing [`wasGeneratedBy`](../reference/properties/gmeow-wasGeneratedBy.md).

### [`gmeow:CommunitySummary`](../reference/classes/gmeow-CommunitySummary.md) · [`gmeow:summarizesCommunity`](../reference/properties/gmeow-summarizesCommunity.md)
...
[`summarizesCommunity`](../reference/properties/gmeow-summarizesCommunity.md) (functional) names the community condensed.
