    ...
    gmeow()
        ...
        .stdout(
            ...
            predicate::str::contains("decided-fragments 8")
                ...
                .and(predicate::str::contains("fragment number-cardinality-counting"))
                ...
                .and(predicate::str::contains("pattern arithmetic-equality-collapse"))
                ...
                .and(predicate::str::contains("boundary non-binary-property-chain"))
                .and(predicate::str::contains(
    ...
    gmeow()
        ...
        .stdout(
            predicate::str::contains("\"decided_fragments\"")
                ...
                .and(predicate::str::contains("\"id\": \"complement-refutation\""))
                .and(predicate::str::contains("\"pattern\": \"complement-clash\""))
