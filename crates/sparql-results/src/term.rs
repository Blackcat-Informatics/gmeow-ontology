...
//! Shared term-lexicalization helpers, built on the `gmeow-rdf-core` kernel
...
use gmeow_rdf_core::{emit_term, RdfLiteral, RdfTerm, RdfTriple, TermValue};
...
/// `"lex"^^<dt>`, or the RDF 1.2 triple term `<<( s p o )>>`).
