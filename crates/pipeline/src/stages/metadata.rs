...
mod tests {
    ...
    fn metadata_stats_match_committed_targets() {
        ...
        // Values confirmed against the canonical Python `metadata.py` run over
        // the CURRENT committed fold (`generated/dist/gmeow.gts`). The committed
        // metadata artifacts predate this fold and are regenerated by this PR.
        assert_eq!(stats.triples, 38151, "triples");
        assert_eq!(stats.entities, 4481, "entities");
        assert_eq!(stats.classes, 721, "classes");
        assert_eq!(stats.properties, 1547, "properties");
    }
}
