<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/eaa2b9998d1e22d36b79e6a8a6f555cbd04c44a6
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/eaa2b9998d1e22d36b79e6a8a6f555cbd04c44a6>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/outcome/4554b13314f84c1a59536908a08bec2903958975>` `<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>` `<https://blackcatinformatics.ca/logic/TransactionOutcome>` *(in `<https://example.org/transaction/concurrent-view-serializable/world>`)*
