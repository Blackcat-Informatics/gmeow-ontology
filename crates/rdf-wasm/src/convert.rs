...
//! [`MutableDataset`](gmeow_rdf::ir::MutableDataset) mutates and queries by.
//!
...
use gmeow_rdf::ir::QuadValues;
use gmeow_rdf::{BlankScope, RdfLiteral, RdfTerm, RdfTriple, TermValue};
