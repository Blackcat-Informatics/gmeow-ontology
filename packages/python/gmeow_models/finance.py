...
class CryptoWallet(FinancialAccount):
    ...
    id: str | None = Field(default=None, alias="@id")
    type_: str | list[str] | None = Field(default=None, alias="@type")
    walletScheme: list[str] | None = Field(default=None, description="The blockchain scheme of the wallet — Bitcoin, Ethereum, Solana, Monero, etc. Functional: a wallet operates on exactly one scheme (a multi-scheme container is several wallets).", alias="gmeow:walletScheme")
...
class LedgerAccount(ConfiguredBaseModel):
    ...
    ledgerAccountType: list[str] | None = Field(default=None, description="The kind of ledger account — one of the open LedgerAccountType values (asset, liability, equity, revenue, expense). Functional: a ledger account has one canonical type.", alias="gmeow:ledgerAccountType")
...
class Posting(ConfiguredBaseModel):
    ...
    postingDirection: list[str] | None = Field(default=None, description="The direction of this posting — debit or credit. Functional: a posting is exactly one direction.", alias="gmeow:postingDirection")
