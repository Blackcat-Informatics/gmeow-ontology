...
///   natively ([`GmnGlyphRegistry::bindings`](crate::gmn1_codec::GmnGlyphRegistry::bindings)),
///   its source precedence read off the operator's `lang:denotedForm` `gmeow:gmnPrecedence`
///   in `ds`; and
