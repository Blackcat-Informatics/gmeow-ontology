...
- **CURIE:** [`gmeow:levelUnresponsive`](gmeow-levelUnresponsive.md)
- **IRI:** <https://blackcatinformatics.ca/gmeow/levelUnresponsive>
- **Category:** individual
- **Defined by:** [`gmeow:slices/awareness`](../../slices/awareness.md)
- **Box roles:** [ABox role](../boxes/abox.md) ([What is this?](../../four-boxes/index.md))

No arousable response to stimuli — the lowest rung, the arousal floor of coma. Maps to the lowest Glasgow Coma Scale range by reference; the level carried by [`gmeow:modeComatose`](gmeow-modeComatose.md) and deep [`gmeow:modeAsleep`](gmeow-modeAsleep.md).
...
Use [`gmeow:levelUnresponsive`](gmeow-levelUnresponsive.md) as a controlled value typed as [`gmeow:AwarenessLevel`](../classes/gmeow-AwarenessLevel.md).
...
|---|---|---|---|---|---|
| [`gmeow:levelUnresponsive`](gmeow-levelUnresponsive.md) | equivalence | `-` | [skos:relatedMatch](http://www.w3.org/2004/02/skos/core#relatedMatch) | snomed:371632003 | `gmeow-awareness.sssom.tsv`; `gmeow:eqAwareness002`; confidence 0.3 |
...
<tbody>
<tr><td><code>relatedMatch</code></td><td><a href="http://snomed.info/id/371632003"><code>snomed:371632003</code></a></td></tr>
</tbody>
</table>
