...
| [`gmeow:IdentityFacet`](../reference/classes/gmeow-IdentityFacet.md) | Identity Facet | A reified, SELF-ASSERTED claim about an aspect of a person's identity — an observation in the universal claim stack (observation-spine bridge): gender identity... |
...
[`gufo:Relator`](../external/terms.md#gufo-relator) *and* a [`gmeow:Observation`](../reference/classes/gmeow-Observation.md) in the universal claim stack (observation-spine bridge),
