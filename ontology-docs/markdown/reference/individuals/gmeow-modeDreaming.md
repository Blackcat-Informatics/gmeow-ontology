...
- **CURIE:** [`gmeow:modeDreaming`](gmeow-modeDreaming.md)
- **IRI:** <https://blackcatinformatics.ca/gmeow/modeDreaming>
- **Category:** individual
- **Defined by:** [`gmeow:slices/awareness`](../../slices/awareness.md)
- **Box roles:** [ABox role](../boxes/abox.md) ([What is this?](../../four-boxes/index.md))

The state of experiencing a dream — endogenously generated quasi-perceptual content during sleep. The awareness-MODE value over a dreaming episode; the dreaming ACT itself is a [`gmeow:processDreaming`](gmeow-processDreaming.md) (mentation, by reference) and the dreamt content's source is a reality-monitoring matter ([`gmeow:contentOrigin`](../properties/gmeow-contentOrigin.md), imagination, by reference), never a truth bit here.
...
Use [`gmeow:modeDreaming`](gmeow-modeDreaming.md) as a controlled value typed as [`gmeow:AwarenessMode`](../classes/gmeow-AwarenessMode.md).
