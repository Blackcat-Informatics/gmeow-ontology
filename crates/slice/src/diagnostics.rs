...
//! The shared lint diagnostic carrier for the surviving `gmeow-slice` lints.
//!
...
//! oxigraph-free `gmeow-logic-compile` pass (which redeclares its own equivalent
...
/// validator's diagnostic dict (`gmeow_rdf.validate_sssom`) so the PyO3 binding packs
