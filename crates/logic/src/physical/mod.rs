...
pub use builtin_eval::{bilinear_sqdist, compare_sqdist, BilinearFormError};
mod chase;
...
pub(crate) use builtin_eval::{
    BuiltinError, BuiltinGap, BuiltinGapKind, BuiltinOutcome, CellResolver, MATH_CELL_PREDICATES,
