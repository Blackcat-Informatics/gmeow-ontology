<!-- cited-iri-skeleton
  ...
  https://blackcatinformatics.ca/gmeow/reifier/cac305c80eda79cd6546ad359aacc1bbe72057bd
...
# Explanation for `<https://blackcatinformatics.ca/gmeow/reifier/cac305c80eda79cd6546ad359aacc1bbe72057bd>`
...
**Derived** by rule `<https://blackcatinformatics.ca/logic/rule/transaction>`:
  `<https://blackcatinformatics.ca/logic/txstate/9460cb5ed7a39627eeefe2444e6f52ffbbc2e03a>` `<https://blackcatinformatics.ca/logic/temporallySucceeds>` `<https://example.org/teleology/concurrent-non-serializable/s0>` *(in `<https://example.org/teleology/concurrent-non-serializable/world>`)*
