...
//! `gmeow-rdf-core` so consumers can depend on the contract without depending on
//! oxigraph. Concrete oxigraph adapters live in the sibling `gmeow-rdf` crate.

use std::io::Write;
use std::sync::Arc;

use gmeow_rdf_events::RdfEventSink;
